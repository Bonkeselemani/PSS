...
#Region "Model"
        ...
        Public Shared Function InsertModel(ByVal model As String, ByVal tier As Integer, ByVal flat As Integer, _
                                           ...
                                           ByVal iAPCCode As Integer, ByVal iGSM As Integer, ByVal iModelType As Integer, ByVal iAccessoryCategory As Integer, ByVal strModelMotoSku As String _
            ...
            Try
                Return Buisness.ModManuf.InsertModel(model, tier, flat, manuf, prod, asc, iRptGrp, iAPCCode, iGSM, iModelType, iAccessoryCategory, _
                                                     PSS.Core.Global.ApplicationUser.IDuser, strModelMotoSku, iAltWrtyDateCode, iHasBC, _
        ...
        Public Shared Function DoUpdateModel(ByVal model_id As Integer, ByVal model As String, ByVal tier As Integer, ByVal flat As Integer, _
                                                    ...
                                                    ByVal iAPCCode As Integer, ByVal iGSM As Integer, ByVal iModelType As Integer, ByVal iAccessoryCategory As Integer _
            ...
            Buisness.ModManuf.UpdateModel(model_id, model, tier, flat, manuf, prod, asc, iRptGrp_ID, iAPCCode, iGSM, iModelType, iAccessoryCategory, _
                                          PSS.Core.Global.ApplicationUser.IDuser, iAltWrtyDateCode, iHasBC, iModel_MotoSku, iSWProcess, iKSCapable, iTriageNeeded)
        End Function
