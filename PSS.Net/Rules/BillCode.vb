...
Namespace Rules
    ...
    Public Class BillCode
        ...
        Public Shared Function UpdateBillCode(ByVal desc As String, ByVal devid As Integer, ByVal rule As Integer, ByVal type As Integer, ByVal fail As Integer, ByVal repair As Integer, ByVal id As Integer, ByVal iAggBilling As Integer) As Boolean
            Try
                Buisness.BillCode.UpdateBillCode(id, desc, devid, rule, type, fail, repair, iAggBilling)
                Return True
            Catch
                Return False
            End Try
        ...
        Public Shared Function InsertBillCode(ByVal desc As String, ByVal devid As Integer, ByVal rule As Integer, ByVal type As Integer, ByVal fail As Integer, ByVal repair As Integer, ByVal iAggBilling As Integer) As Boolean
            Try
                Buisness.BillCode.InsertBillCode(doapps(desc), devid, rule, type, fail, repair, iAggBilling)
                Return True
