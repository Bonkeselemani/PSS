...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        "{}Caption{AlignHorz:Center;BackColor:LightSteelBlue;}Style9{}Normal{Font:Microso" & _
        "ft Sans Serif, 8.25pt, style=Bold;}HighlightRow{ForeColor:HighlightText;BackColo" & _
        "r:Highlight;}Style14{}OddRow{BackColor:LightSteelBlue;}RecordSelector{AlignImage" & _
        ":Center;}Style15{}Heading{Wrap:True;AlignHorz:Center;AlignVert:Center;Border:Rai" & _
        "sed,,1, 1, 1, 1;ForeColor:White;BackColor:SteelBlue;}Style8{}Style10{AlignHorz:N" & _
        ...
        Me.btnDiscrepancyRpt.Visible = False
        '
...
#End Region
    ...
    Private Sub dbgEEInfo_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dbgEEInfo.MouseDown
        Try
    ...
    Private Sub CMenuCopySelectedData(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Misc.CopySelectedRowsData(Me.dbgEEInfo)
        Catch ex As Exception
