'******************************************************************************
'Modify:
'1) 01/17/2012 By Lan Nguyen : Customize for SYX
'******************************************************************************
...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents tbDevInfo As System.Windows.Forms.TabPage
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SyxTechBilling))
            ...
            Me.tbDevInfo = New System.Windows.Forms.TabPage()
            ...
            Me.txtSerial.Location = New System.Drawing.Point(56, 33)
            ...
            Me.lblDeviceSN.Size = New System.Drawing.Size(72, 16)
            Me.lblDeviceSN.TabIndex = 104
            Me.lblDeviceSN.Text = "PSS S/N:"
            ...
            Me.tabMain.Controls.AddRange(New System.Windows.Forms.Control() {Me.tbParts, Me.tbNeedPart, Me.tbServices, Me.tpAccessories, Me.tbNeedAccessories, Me.tbTestResults, Me.tbScrap, Me.tbRVParts, Me.tbDevInfo})
            ...
            Me.lblTechNotesUpdDate.TabIndex = 126
            ...
            Me.btnTechNotesSave.Location = New System.Drawing.Point(24, 88)
            ...
            Me.txtTechNotes.Size = New System.Drawing.Size(832, 192)
            ...
            Me.pnlTestResults.Anchor = ((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                        Or System.Windows.Forms.AnchorStyles.Right)
            Me.pnlTestResults.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblTestResult_Triage, Me._LabelTestResult_QC, Me.lblTestResult_QC, Me._LabelTestResult_Triage})
            ...
            Me.lblTestResult_Triage.Size = New System.Drawing.Size(832, 72)
            ...
            Me._LabelTestResult_QC.Location = New System.Drawing.Point(40, 118)
            ...
            Me.lblTestResult_QC.Location = New System.Drawing.Point(104, 96)
            Me.lblTestResult_QC.Name = "lblTestResult_QC"
            Me.lblTestResult_QC.Size = New System.Drawing.Size(832, 72)
            ...
            Me._LabelTestResult_Triage.Location = New System.Drawing.Point(32, 32)
            ...
            'tbDevInfo
            '
            Me.tbDevInfo.Controls.AddRange(New System.Windows.Forms.Control() {Me.dgNeed, Me.dgConsumed, Me.lblImageStatus})
            Me.tbDevInfo.Location = New System.Drawing.Point(4, 22)
            Me.tbDevInfo.Name = "tbDevInfo"
            Me.tbDevInfo.Size = New System.Drawing.Size(968, 462)
            Me.tbDevInfo.TabIndex = 11
            Me.tbDevInfo.Text = "Device Info"
            '
            'dgNeed
            '
            ...
            Me.dgNeed.Location = New System.Drawing.Point(504, 48)
            ...
            Me.dgConsumed.Location = New System.Drawing.Point(8, 48)
            ...
            'lblImageStatus
            '
            Me.lblImageStatus.Font = New System.Drawing.Font("Tahoma", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Me.lblImageStatus.ForeColor = System.Drawing.Color.Blue
            Me.lblImageStatus.Location = New System.Drawing.Point(16, 16)
            Me.lblImageStatus.Name = "lblImageStatus"
            Me.lblImageStatus.Size = New System.Drawing.Size(368, 16)
            Me.lblImageStatus.TabIndex = 144
            Me.lblImageStatus.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
            '
            'gridBilling
            '
            ...
            Me.gridBilling.Images.Add(CType(resources.GetObject("resource.Images2"), System.Drawing.Bitmap))
            ...
            Me.lblWarrantyStatus.Location = New System.Drawing.Point(200, 33)
            ...
            Me.lblScreenName.Size = New System.Drawing.Size(128, 16)
            ...
            Me.lblManufSN.Location = New System.Drawing.Point(288, 33)
            ...
            Me.lblWipLoc.Location = New System.Drawing.Point(472, 33)
            ...
            Me.lblManufModelNumber.Location = New System.Drawing.Point(472, 8)
            ...
            Me.tbDevInfo.ResumeLayout(False)
...
#End Region
        ...
        Private Function getData() As Boolean
            ...
            Try
                ...
                Else
                    ...
                    If Me._objNewTech.GetSyxImageAvailableStatus(Me.tmpModelID) > 0 Then Me.lblImageStatus.Text = "Image Available: Yes" Else Me.lblImageStatus.Text = "Image Available: No"
                End If
            ...
            Catch ex As Exception
                Throw ex
            Finally
                Buisness.Generic.DisposeDT(dt) : Buisness.Generic.DisposeDT(dtSyxData)
            End Try
        End Function
        ...
        Private Sub LoadConsumeAndNeedTransaction()
            ...
            Try
                ...
                With Me.dgConsumed
                    ...
                    .Splits(0).DisplayColumns("Action").Width = 40
                    .Splits(0).DisplayColumns("Trans Date").Width = 50
                End With

                dt = Me._objNewTech.GetPartNeedTrans(Me.tmpDeviceID)
                With Me.dgNeed
                    .DataSource = dt.DefaultView
                    .Splits(0).DisplayColumns("Seq").Width = 25
                    .Splits(0).DisplayColumns("Action").Width = 50
                    .Splits(0).DisplayColumns("Trans Date").Width = 60
                End With
                '***************************************************
            Catch ex As Exception
                Throw ex
        ...
        Private Sub billingClick(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                'If action = "add" AndAlso strAddPartNo.Trim.ToLower <> "syxtemp" AndAlso Me._device.BillableBillcodes.Select("Billcode_ID = " & sender.tag.ToString)(0)("BillType_ID") = 2 Then
                ...
                '***************************************************
                If action = "add" AndAlso (strAddPartNo.Trim.ToLower.Equals("syxtemp") = True OrElse strAddPartNo.Trim.ToLower.Equals("syxtemp_rv") = True) AndAlso Me.CollectPartAndReplaceTempPartInBOM(sender.tag.ToString.Trim, booIsRVPart) = False Then
                    Exit Sub
                End If
                '***************************************************
        ...
        Private Sub billingClick_AWAP(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                'Syx: Collect real part and repalce with temporay part
                '***************************************************
                If action = "add" AndAlso (strAddPartNo.Trim.ToLower.Equals("syxtemp") = True OrElse strAddPartNo.Trim.ToLower.Equals("syxtemp_rv") = True) AndAlso Me.CollectPartAndReplaceTempPartInBOM(sender.tag.ToString.Trim, booRVPart) = False Then
                    Exit Sub
                End If
                '***************************************************
                'Syx: Collect manuf model number
            ...
            If Trim(Me.txtSerial.Text) <> "" And Me.tmpDeviceID > 0 Then
                Try
                    If Me.tmpCustID <> 2253 AndAlso Not (Me.tmpProdID = 9 AndAlso Me._device.Parts.Select("[Billcode_ID] = 1590").Length > 0) Then
						...
						Me._objNewTech.UpdateWipOwnerID(tmpDeviceID, Me.tmpProdID, PSS.Core.ApplicationUser.IDuser, Me._iDeviceWipOwner, booUpdateTechInfo, , "Syx Tech Billing")
                    End If
                Catch ex As Exception
        ...
        Private Sub btnComplete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnComplete.Click
            ...
            Try
                ...
                ElseIf Me._device.Parts.Rows.Count = 0 AndAlso Me._dtAWAP.Rows.Count = 0 Then
                    MessageBox.Show("Can not complete without billing.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtSerial.Focus() : Exit Sub
                Else
                    Me.pnlBill.BackColor = Me.BackColor
        ...
        Private Function SetDeviceWipStation(ByRef strNextWrkStation As String) As Boolean
            ...
            Dim strStatus, strBillcodeIDs As String
            ...
            Try
                ...
                strNextWrkStation = "" : strStatus = "" : strBillcodeIDs = ""
                ...
                Else
                    If Me._dtAWAP.Rows.Count > 0 Then
                        ...
                        For Each R1 In dt.Rows
                            Dim strPartNo As String = Me._dtAWAP.Select("Billcode_ID = " & R1("Billcode_ID"))(0)("Part_Number")

                            If Me._device.Parts.Select("Billcode_ID = " & R1("Billcode_ID")).Length > 0 Then
                                R1.BeginEdit() : R1("Consumed") = 1 : R1.EndEdit()
                            ElseIf Me._device.Parts.Select("Part_Number = '" & strPartNo & "_RV'").Length > 0 OrElse Me._device.Parts.Select("Part_Number = '" & strPartNo & "'").Length > 0 Then
                                R1.BeginEdit() : R1("Consumed") = 1 : R1.EndEdit()
                            End If
                        Next R1
                ...
                Dim objSyxShip As New PSS.Data.Buisness.SyxReceivingShipping()
                If objSyxShip.IsDeviceHasCosBBillcode(tmpDeviceID) = True Then strNextWrkStation = "WAITING FQA - B"
                objSyxShip = Nothing
                ...
                End If
                strStatus = strNextWrkStation
                objSyx.UpdateSyxStatus(Me.tmpDeviceID, strStatus)
        ...
        '***************************************************************************
        Private Sub tbDevInfo_VisibleChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbDevInfo.VisibleChanged
            Try
                If Me.tbDevInfo.Visible = True Then LoadConsumeAndNeedTransaction()
            Catch ex As Exception
