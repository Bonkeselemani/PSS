...
Namespace Gui.WIKO
    Public Class frmWIKO_SpecialReceiving
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWIKO_SpecialReceiving))
            ...
            Me.btnCloseBox.Location = New System.Drawing.Point(448, 176)
            ...
            "aultRecSelWidth>17</DefaultRecSelWidth></Blob>"
            '
            'frmWIKO_SpecialReceiving
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.ClientSize = New System.Drawing.Size(680, 598)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TabControl1})
            Me.Name = "frmWIKO_SpecialReceiving"
            Me.Text = "frmWIKO_SpecialReceiving"
...
#End Region
        ...
        Private Sub frmWIKO_SpecialReceiving_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                Me._RecvWiKoDT = Me._objWIKO_SP.getWiKoRecvTableDef
        ...
        Private Sub ProcessSN()
            ...
            Dim iMaxQty As Integer = Me._objWIKO.WIKO_SPMaxQtyInBox
            ...
            Try
                ...
                Else
                    dt = Me._objWIKO_Receiving.getReceivingData(Me._iMenuCustID, Me._iMenuLocID, strSN)
                            ...
                            Else 'ok
                                ...
                                Else 'Ready to receive 
                                    ...
                                    Else 'Validate with recev data
                                        Dim strValidatedMsg As String = Me.GoValidation(Me._iMenuLocID, Me._RecvWiKoDT, strSN, strASN_IN_ITEM_SKU, iMaxQty).Trim
                                    ...
                                    bReceived = Me._objWIKO_Receiving.ReceiveDataIntoSystem(Me._iMenuLocID, iWO_ID, iModel_ID, strSN, strManufDate, _
            ...
            Try
                ...
                With Me.tdgDeviceData
                    ...
                    For Each dbgc In .Splits(0).DisplayColumns
                        ...
                        dbgc.AutoSize()
                    Next dbgc
                    If Me._iMenuCustID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
            ...
            Try
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    ...
                    If i > 0 Then
                        ...
                        'If Me._iMenuLocID = PSS.Data.Buisness.WIKO.WIKO.WIKO_Special_LOC_ID OrElse Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                        ...
                        Me._objWIKO_Receiving.PrintReceivedBoxLabel(Me._strRecvBoxName, Me._RecvWiKoDT.Rows.Count, Me._RecvWiKoDT.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                                             Me._RecvWiKoDT.Rows(0).Item("PSS_Model"), "", "", _
                    ...
                    Me._RecvWiKoDT = Me._objWIKO_Receiving.getWiKoRecvTableDef : Me.cboLocation.Enabled = True : Me.cboModel.Enabled = True : Me.txtPallett_Id.Enabled = True
