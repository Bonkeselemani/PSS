...
Namespace Gui.WIKO
    Public Class frmWiko_Report
        ...
        Private objTNRpt As New PSS.Data.Buisness.WIKO.WIKO_Report()
...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents rptName As System.Windows.Forms.Label
        Friend WithEvents cboLocation As C1.Win.C1List.C1Combo
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWiko_Report))
            ...
            Me.rptName = New System.Windows.Forms.Label()
            ...
            Me.gbReportName.Location = New System.Drawing.Point(48, 80)
            ...
            Me.gbDate.Location = New System.Drawing.Point(48, 176)
            ...
            Me.btnRunRpt.Location = New System.Drawing.Point(48, 448)
            ...
            Me.grpSN.Location = New System.Drawing.Point(48, 256)
            Me.grpSN.Name = "grpSN"
            ...
            Me.gbWorkOrder.Location = New System.Drawing.Point(48, 496)
            Me.gbWorkOrder.Name = "gbWorkOrder"
            Me.gbWorkOrder.Size = New System.Drawing.Size(400, 8)
            ...
            Me.GroupBox2.Location = New System.Drawing.Point(48, 376)
            ...
            'rptName
            '
            Me.rptName.Font = New System.Drawing.Font("Microsoft Sans Serif", 11.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Me.rptName.Location = New System.Drawing.Point(128, 8)
            Me.rptName.Name = "rptName"
            Me.rptName.Size = New System.Drawing.Size(296, 23)
            Me.rptName.TabIndex = 113
            '
            'cboLocation
            '
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.rptName, Me.GroupBox2, Me.grpSN, Me.grpImeiFile, Me.gbWorkOrder, Me.gbReportName, Me.gbDate, Me.btnRunRpt, Me.GroupBox1})
            Me.Name = "frmWiko_Report"
            Me.Text = "frmWiko_Report"
...
#End Region
        ...
        Private Sub frmWiko_Report_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                Me.rptName.Text = _strScreenName
                Dim dtLoc As DataTable
                Dim dtModel As DataTable
                Dim dtType As DataTable
                Dim iLoc_ID As Integer = 0
                dtLoc = Me._objWIKO_BoxShip.GetWiKoLocations(Me.iCust_ID, True)
        ...
        Private Sub cboReportName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboReportName.TextChanged
            ...
            Try
                If Me.cboReportName.Text <> "Select Report Name" Then
                    ...
                    ElseIf Me._strRptName = Me.ReportNames.Weekly_report.ToString Then
                        Me.gbDate.Visible = True
                        Me.gbDate.Text = "ATT WEEKLY DATE"
                        Me.GroupBox2.Visible = True
...
#Region "comnent"
        ...
        '    Dim objWikoRpt As PSS.Data.Buisness.WIKO.WIKO_Report
        ...
        '            'Generate Report
        '            '*************************************
        '            objWikoRpt = New PSS.Data.Buisness.WIKO.WIKO_Report()
        ...
        '                i = objWikoRpt.CreateInventoryReport(Me._iMenuCust, strRptNameTmp, strDateStart)
...
#End Region
        ...
        Private Sub btnRunRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunRpt.Click
            ...
            Try
                ...
                Else
                    ...
                    '*************************************
                    objWikoRpt = New PSS.Data.Buisness.WIKO.WIKO_Report()
                    objWikoRpt.colDefault = colDefault
                    ...
                    If Me._strRptName = Me.ReportNames.RA_uploaded_report.ToString Then
                        i = objWikoRpt.CreateInventoryReport(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 1, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Received_Report
                    ElseIf Me._strRptName = Me.ReportNames.Received_Report.ToString Then
                        i = objWikoRpt.CreateInventoryReport(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 2, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =part used
                    ElseIf Me._strRptName = Me.ReportNames.Part_Used.ToString Then
                        i = objWikoRpt.CreateInventoryReport(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 7, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Shipped_Report
                    ElseIf Me._strRptName = Me.ReportNames.Shipped_Report.ToString Then
                        i = objWikoRpt.CreateInventoryReport(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 3, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Status_Report
                    ElseIf Me._strRptName = Me.ReportNames.Status_Report.ToString Then
                        i = objWikoRpt.CreateInventoryReport(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 4, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Pretest_Report
                    ElseIf Me._strRptName = Me.ReportNames.Pretest_Report.ToString Then
                        i = objWikoRpt.CreatePretestRawDataRpt(Me.iCust_ID, strDateStart, strDateEnd, "", strLocation, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'WIP REPORT
                    ElseIf Me._strRptName = Me.ReportNames.wip_report.ToString Then
                        i = objWikoRpt.CreatePretestRawDataRpt(Me.iCust_ID, strDateStart, strDateEnd, "", strLocation, iOption, strImei)
                        ...
                        'WEEKLY REPORT 
                    ElseIf Me._strRptName = Me.ReportNames.Weekly_report.ToString Then
                        i = objWikoRpt.Get_Weekly_Report(Me.iCust_ID, strDateStart, strDateEnd, "", iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ...
                    ElseIf Me._strRptName = Me.ReportNames.ATT_WEX_report.ToString Then
                        ...
                        If Me.rdbOpen.Checked Then
                            iStatus = 1
                        End If
                        i = objWikoRpt.CreateWexATT(Me.iCust_ID, "WEX Open Orders", strDateStart, strDateEnd, strLocation, iStatus)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)

                    ElseIf Me._strRptName = Me.ReportNames.Invoice.ToString Then
                        Dim strloc As String = cboLocation.Text
                        If Not strloc.IndexOf("Cricket") = -1 Then
                            i = objWikoRpt.CreateInvoiceCricket(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
                        ElseIf Not strloc.IndexOf("ATT") = -1 Then
                            i = objWikoRpt.CreateInvoiceATTCTDI(Me.iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
                        Else
                            MessageBox.Show(String.Concat("The ", _strRptName, " report for ", strLocation, " has not been developed."))
                        End If
                        'If cboLocation.Text = "Cricket" Then
                        '    i = objWikoRpt.CreateInvoiceCricket(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
                        'ElseIf cboLocation.Text = "ATT_CTDI" Then
                        '    i = objWikoRpt.CreateInvoiceATTCTDI(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
        ...
        Private Sub cboReportName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboReportName.SelectedIndexChanged
            If Me.cboReportName.Text = "ATT_WEX_report" OrElse Me.cboReportName.Text = "Status_Report" Then
                Me.cboLocation.ClearItems()
                Me.cboLocation.AddItem("Cricket")
                Me.cboLocation.AddItem("ATT")
            ElseIf Me.cboReportName.Text = Me.ReportNames.Weekly_report.ToString Then
