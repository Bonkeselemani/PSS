...
Namespace Gui.WIKO
    Public Class frmWIKO_Receiving
        ...
        Private _objWiKo_Receiving As PSS.Data.Buisness.WIKO.WIKO_Receiving
        Private _objWIKO_BoxShip As PSS.Data.Buisness.WIKO.WIKO_BoxShip
        Private _RecvWiKoDT As DataTable
        Private _RecvWiKoDT_Seed As DataTable
        ...
        ' Private _iShiftID As Integer = IIf(IsNumeric(PSS.Core.Global.ApplicationUser.IDShift), Convert.ToInt32(PSS.Core.Global.ApplicationUser.IDShift), 0)
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objWiKo_Receiving = New PSS.Data.Buisness.WIKO.WIKO_Receiving()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWIKO_Receiving))
            ...
            Me.txtSN.Location = New System.Drawing.Point(120, 104)
            Me.txtSN.Name = "txtSN"
            ...
            Me.lblSN.Location = New System.Drawing.Point(40, 104)
            Me.lblSN.Name = "lblSN"
            ...
            Me.txtManufDate.Location = New System.Drawing.Point(120, 128)
            Me.txtManufDate.Name = "txtManufDate"
            Me.txtManufDate.Size = New System.Drawing.Size(168, 22)
            Me.txtManufDate.TabIndex = 162
            ...
            Me.lblManufDate.Location = New System.Drawing.Point(24, 128)
            ...
            Me.lblBoxName.Location = New System.Drawing.Point(488, 120)
            ...
            Me.txtMaxBoxQty.Location = New System.Drawing.Point(488, 16)
            ...
            Me.lblMaxBoxQty.Location = New System.Drawing.Point(368, 16)
            ...
            Me.txtReceivedQty.Location = New System.Drawing.Point(488, 56)
            ...
            Me.lblReceivedQty.Location = New System.Drawing.Point(368, 56)
            ...
            Me.btnCloseBox.Location = New System.Drawing.Point(568, 152)
            ...
            Me.GroupBox1.Location = New System.Drawing.Point(568, 200)
            ...
            Me.lblSku_Desc.Location = New System.Drawing.Point(120, 80)
            ...
            Me.lblblblSKU_Desc.Location = New System.Drawing.Point(22, 80)
            ...
            Me.cboModel.Location = New System.Drawing.Point(120, 56)
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TabControl1, Me.lblTitle})
            Me.Name = "frmWIKO_Receiving"
            Me.Text = "frmWIKO_Receiving"
...
#End Region
        ...
        Private Sub frmWIKO_Receiving_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                'Initialize dt table
                Me._RecvWiKoDT = Me._objWiKo_Receiving.getWiKoRecvTableDef
                Me._RecvWiKoDT_Seed = Me._objWiKo_Receiving.getWiKoSeedStockRecvTableDef

                'Update Item SKU for ATT FexEx POS ASn data
                Me._objWiKo_Receiving.FindUpdateAttFexExSkuPos()

                Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
                Me.rbtByPoNumber.Checked = False : Me.rbtByPoNumber.Visible = False 'Not every WiKo location has PO, so disabled it
                ...
                'Loc info
                dtLoc = Me._objWIKO_BoxShip.GetWiKoLocations(Me._iCust_ID, True)
                Misc.PopulateC1DropDownList(Me.cboLocation, dtLoc, "Loc_Name", "Loc_ID")
                Me.cboLocation.SelectedValue = 0

                'dtLoc_Seed = Me._objWIKO_BoxShip.GetWiKoLocations(Me._iCust_ID, True)
                dtLoc_Seed = _objWiKo_Receiving.GetWiKoLocations_SeedStock(Me._iCust_ID, True, _objWiKo.WIKO_Special_LOC_ID)
                Misc.PopulateC1DropDownList(Me.cboLocation_Seed, dtLoc_Seed, "Loc_Name", "Loc_ID")
                Me.cboLocation_Seed.SelectedValue = 0

                'Model info
                dtModel = Me._objWiKo.getWIKOModels(Me._iCust_ID, True)
                ...
                'Return Type
                dtDOA = Me._objWiKo_Receiving.GetWiKoCriketDOA(True)
        ...
        '            .txtSN.Visible = True
        '            .txtManufDate.Text = ""
        '            .txtManufDate.Enabled = True
        '            .txtManufDate.Visible = True
        '            .lblRecSN.Text = ""
        '            .lblRecManufDate.Text = ""
        '            .lblRecModel.Text = ""
        '            .lblRecCustLoc.Text = ""
        '            .lblAccountDOA.Text = ""
        '            ' .lblWiKoCustName.Text = ""
        ...
        Private Sub ProcessSN()
            ...
            Dim strTrayMemo As String = "Wiko Receiving"
            Dim iWrtyFlag As Integer = 0
            Dim iMaxQty As Integer = Me._objWiKo.getMaxReceivingBoxQty

            Try
                Me.Cursor = Cursors.WaitCursor

                Me.txtReceivedQty.Text = Me._RecvWiKoDT.Rows.Count
                ...
                Else
                    dt = Me._objWiKo_Receiving.getReceivingData(Me._iCust_ID, Me._iLoc_ID, strSN)
                    ...
                    If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID Then strAccountDOA = "WEX" : iWrtyFlag = 1 'All ATT CTDI devices are WEX - Warranty Exchange - 

                    Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
                    If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                        If strAccountDOA_Code.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_FexEx_WexCode Then
                            iWrtyFlag = 1
                        Else
                            iWrtyFlag = 0
                        End If
                    ...
                    ElseIf Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID AndAlso Not Me.IsValidCricketAccountDOAorEMS(strAccountDOA, strAccountDOA_Code, iWrtyFlag) Then
                        MessageBox.Show("Invalid DOA Info.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID _
                           AndAlso (dt.Rows(0).IsNull("RA_Number") OrElse Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim.Length = 0) Then
                        MessageBox.Show("No PO number.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID _
                           AndAlso (dt.Rows(0).IsNull("RA_Number") OrElse Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim.Length = 0) Then
                        MessageBox.Show("No PO number.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID AndAlso strAccountDOA_Code.Trim.Length = 0 _
                           AndAlso Not strAccountDOA_Code.Trim = PSS.Data.Buisness.WIKO.WIKO.WIKO_FexEx_WexCode.Trim.ToUpper _
                           AndAlso Not strAccountDOA_Code.Trim = PSS.Data.Buisness.WIKO.WIKO.WIKO_FexEx_PosCode.Trim.ToUpper Then
                        MessageBox.Show("No WEX or POS number or invalid.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Else '=1
                        ...
                        Else
                            ...
                            Else 'ok
                                ...
                                If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then strReturnType = strAccountDOA_Code.Trim Else strReturnType = strAccountDOA.Trim
                                strPONumber = Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim
                                If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID _
                                   AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_FexEx_PosCode.Trim.ToUpper Then
                                    strASN_IN_ITEM_SKU_Desc = Convert.ToString(dt.Rows(0).Item("Item_Desc")).Trim
                                    Me.lblblblSKU_Desc.Visible = True : Me.lblSku_Desc.Visible = True
                                    Me.lblSku_Desc.Text = strASN_IN_ITEM_SKU_Desc
                                Else
                                    strASN_IN_ITEM_SKU_Desc = ""
                                End If

                                iTray_ID = Me._objWiKo_Receiving.getTayID(Me._iUserID, Me._strUser, iWO_ID, strTrayMemo)
                                ...
                                Else 'Ready to receive 
                                    ...
                                    If Me._RecvWiKoDT.Rows.Count = 0 Then 'First device
                                    ...
                                    Else 'Validate with recev data
                                        Dim strValidatedMsg As String = Me.GoValidation(Me._iLoc_ID, Me._RecvWiKoDT, strSN, strASN_IN_ITEM_SKU, strReturnType, strPONumber, iMaxQty).Trim
                                    ...
                                    bReceived = Me._objWiKo_Receiving.ReceiveDataIntoSystem(Me._iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
                                    ...
                                    If bReceived Then
                                        ...
                                        Me._RecvWiKoDT.Rows.Add(rowNew)
                                        Me.BindReceivedData()

                                        'If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then Me.lblAccountDOA.Text = strAccountDOA Else Me.lblAccountDOA.Text = ""
                                        Me.txtReceivedQty.Text = Me._RecvWiKoDT.Rows.Count
                                        Me.txtManufDate.Text = ""
        ...
        Private Sub BindReceivedData()
            ...
            Try
                ...
                For Each row In Me._RecvWiKoDT.Rows
                    i += 1
                ...
                With Me.tdgDeviceData
                    .DataSource = Me._RecvWiKoDT.DefaultView

                    For Each dbgc In .Splits(0).DisplayColumns
                        dbgc.Locked = True
                        dbgc.AutoSize()
                    Next dbgc
                    If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
                    ...
                    ElseIf Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID OrElse Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                        .Splits(0).DisplayColumns("ASN_SKU_Desc").Width = 0
                        .Splits(0).DisplayColumns("Vendor").Width = 0
                        .Splits(0).DisplayColumns("Vendor_ID").Width = 0
                        .Splits(0).DisplayColumns("Loc_ID").Width = 0
        ...
        Private Sub BindReceivedData_Seed()
            ...
            Try
                'Update sequence RecID
                For Each row In Me._RecvWiKoDT_Seed.Rows
                    i += 1
                    row.BeginEdit() : row("RecID") = i : row.AcceptChanges()
                Next
                ...
                With Me.tdgDeviceData_Seed
                    .DataSource = Me._RecvWiKoDT_Seed.DefaultView
        ...
        Private Function GoValidation(ByVal iLoc_ID As Integer, ByVal RecvDT As DataTable, ByVal strSN As String, ByVal strSku As String, _
            ...
            Try
                ...
                If iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID OrElse iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
        ...
        Private Function IsReceivedUnshipped(ByVal iLoc_ID As Integer, ByVal strSN As String) As Boolean
            ...
            Try
                dt = Me._objWiKo_Receiving.getReceivedUnshipped(iLoc_ID, strSN)
                If dt.Rows.Count > 0 Then
                    Return True
                Else
                    Return False
        ...
        Public Function IsValidManufDateCode(ByVal strManufDate As String) As Boolean
            ...
            Try
                If regD.IsMatch(strManufDate) Then 'Check if digits
                    If strManufDate.Trim.Length = PSS.Data.Buisness.WIKO.WIKO.WIKO_DeviceManufDate_MinLength _
                                    OrElse strManufDate.Trim.Length = PSS.Data.Buisness.WIKO.WIKO.WIKO_DeviceManufDate_MaxLength Then
                        bRet = True
                    Else
                        bRet = False
                    End If
        ...
        Public Function IsValidCricketAccountDOAorEMS(ByVal strAccountDOA As String, ByVal strAccountDOA_Code As String, ByRef iWrtyFlag As Integer) As Boolean
            ...
            Try
                If strAccountDOA.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_Cricket_OEMCustomer_DOA.Trim.ToUpper _
                   AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_Cricket_OEMCustomer_DOA_AccountCode.Trim.ToUpper Then
                    iWrtyFlag = 0 'OW, DOA
                    Return True
                ElseIf strAccountDOA.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_Cricket_OEMCustomer_EMS.Trim.ToUpper _
                       AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_Cricket_OEMCustomer_EMS_AccountCode.Trim.ToUpper Then
        ...
        Private Sub cboLocation_Seed_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboLocation_Seed.SelectedValueChanged
            ...
            '    If Me.cboLocation_Seed.SelectedValue = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
        ...
        Private Sub ProcessSN_Seed()
            ...
            Dim strWorkDate As String = Generic.GetWorkDate(iShift_ID)
            Dim iTray_ID As Integer = 0
            Dim strTrayMemo As String = "Wiko Seedstock Receiving"
            Dim strRecvMsg As String = ""

            Try
                Me.Cursor = Cursors.WaitCursor

                Me.txtReceivedQty_Seed.Text = Me._RecvWiKoDT_Seed.Rows.Count
                ...
                If Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
                    strSeedSourceType = PSS.Data.Buisness.WIKO.WIKO.WIKO_SeedStockSourceType_Cricket.Trim
                ElseIf Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID _
                       OrElse Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                    strSeedSourceType = PSS.Data.Buisness.WIKO.WIKO.WIKO_SeedStockSourceType_ATT.Trim
                Else
                ...
                ElseIf Not Me.cboModel_Seed.SelectedValue > 0 Then
                    ...
                    'ElseIf iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID AndAlso Not Me.cboDOA_Seed.SelectedValue > 0 Then
                ...
                ElseIf Me.IsReceivedUnshipped(Me._iLoc_ID_Seed, strSN_Seed) Then
                    MessageBox.Show("SN has been received.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Else
                    strCustLoc = Me._objWiKo_Receiving.getCustomerLocation(Me._iCust_ID, Me._iLoc_ID_Seed)

                    'If iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
                    ...
                    dt = Me._objWiKo_Receiving.getSeedStockReceivingData(Me._iCust_ID, strSN_Seed, strSeedSourceType)
                    ...
                    Else '=1
                        ...
                        Else 'Ready to receive 
                            'Create WH box at start-------------------------------
                            If Me._RecvWiKoDT_Seed.Rows.Count = 0 Then 'First device
                                Dim objCoolPad_Recv As New PSS.Data.Buisness.CP.CoolPad_Receiving()
                            ...
                            Else 'Validate with recev seedstock data
                                Dim strValidatedMsg As String = Me.GoValidation_Seed(Me._RecvWiKoDT_Seed, strSN_Seed, strSKU, strPO, iMaxQty).Trim
                                If strValidatedMsg.Length > 0 Then
                                    MessageBox.Show(strValidatedMsg, "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            ...
                            bReceived = Me._objWiKo_Receiving.ReceiveDataIntoSystem(Me._iLoc_ID_Seed, iWO_ID, iModel_ID, strSN_Seed, strManufDate_Seed, _
                                                                                    strDateTime, strWorkDate, iEW_ID, iShift_ID, iTray_ID, _
                                                                                    iDevice_ID, Me._iWB_ID_Seed, iWrtyFlag, True)
                            If bReceived Then
                                'RecID, SN, ASN_SKU, PSS_Model, Manuf_Date, PO, CustLoc, Model_ID, Loc_ID, EW_ID, Device_ID, wb_ID
                                Dim rowNew As DataRow
                                rowNew = Me._RecvWiKoDT_Seed.NewRow
                                ...
                                Me._RecvWiKoDT_Seed.Rows.Add(rowNew)
        ...
        Private Sub btnCloseBox_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Try
                ...
                If Not Me._RecvWiKoDT.Rows.Count > 0 Then Exit Sub
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    'Close box
                    i = Me._objWiKo_Receiving.ColseWarehouseBox(Me._iWB_ID, Me._RecvWiKoDT.Rows.Count, strBoxStage)

                    If i > 0 Then
                        'Print Label
                        If Not Me._RecvWiKoDT.Rows(0).IsNull("ASN_SKU_Desc") AndAlso Convert.ToString(Me._RecvWiKoDT.Rows(0).Item("ASN_SKU_Desc")).Trim.Length > 0 Then
                            strASN_SKU_Desc = "SKU Desc: " & Convert.ToString(Me._RecvWiKoDT.Rows(0).Item("ASN_SKU_Desc")).Trim
                        End If
                        strPO = Me._RecvWiKoDT.Rows(0).Item("PO")
                        If Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID OrElse Me._iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                            strPoLocOther1 = "PO: " & strPO
                        Else
                            strPoLocOther1 = ""
                        End If

                        Me._objWiKo_Receiving.PrintReceivedBoxLabel(Me._strRecvBoxName, Me._RecvWiKoDT.Rows.Count, Me._RecvWiKoDT.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                                             Me._RecvWiKoDT.Rows(0).Item("PSS_Model"), "", Me._RecvWiKoDT.Rows(0).Item("Return_Type"), _
                                             strPO, strWHLocation, Me._RecvWiKoDT.Rows(0).Item("Loc"), strPoLocOther1)
                    Else
                        MessageBox.Show("Failed to Close the box. See IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    End If

                    'Reset
                    Me.tdgDeviceData.DataSource = Nothing : Me._RecvWiKoDT.Rows.Clear()
                    'initialoze recv datatable columns
                    Me._RecvWiKoDT = Me._objWiKo_Receiving.getWiKoRecvTableDef : Me.cboLocation.Enabled = True : Me.cboModel.Enabled = True
                    Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
        ...
        Private Sub btnCloseBox_Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCloseBox_Seed.Click
            ...
            Try
                ...
                If Not Me._RecvWiKoDT_Seed.Rows.Count > 0 Then Exit Sub
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    'Close Seedstock box
                    i = Me._objWiKo_Receiving.ColseWarehouseBox(Me._iWB_ID_Seed, Me._RecvWiKoDT_Seed.Rows.Count, strBoxStage)

                    If i > 0 Then
                        'Print Label
                        strPO = "PO: " & Me._RecvWiKoDT_Seed.Rows(0).Item("PO")
                        If Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
                            strSeedSourceType = "Seedstock Source: " & PSS.Data.Buisness.WIKO.WIKO.WIKO_SeedStockSourceType_Cricket.Trim
                        ElseIf Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID _
                               OrElse Me._iLoc_ID_Seed = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID Then
                            strSeedSourceType = "Seedstock Source: " & PSS.Data.Buisness.WIKO.WIKO.WIKO_SeedStockSourceType_ATT.Trim
                        Else
                            MessageBox.Show("Invalid Location! See IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Exit Sub
                        End If

                        Me._objWiKo_Receiving.PrintReceivedSeedstockBoxLabel(Me._strRecvBoxName_Seed, Me._RecvWiKoDT_Seed.Rows.Count, _
                                                                             Me._RecvWiKoDT_Seed.Rows(0).Item("ASN_SKU"), "", _
                                                                             Me._RecvWiKoDT_Seed.Rows(0).Item("PSS_Model"), "", _
                                                                             strSeedSourceType, strPO, strWHLocation, Me._RecvWiKoDT_Seed.Rows(0).Item("CustLoc"), _
                                                                             "")
                    Else
                    ...
                    'Reset
                    Me.tdgDeviceData_Seed.DataSource = Nothing : Me._RecvWiKoDT_Seed.Rows.Clear()
                    'initialoze recv datatable columns
                    Me._RecvWiKoDT_Seed = Me._objWiKo_Receiving.getWiKoSeedStockRecvTableDef : Me.cboLocation_Seed.Enabled = True : Me.cboModel_Seed.Enabled = True
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                If Me.rbtByBoxName.Checked Then 'BY BOX NAME -1-------------------------------------------------------------------------------------------------------------
                    ...
                    dt = Me._objWiKo_Receiving.GetWiKoReceivedData(Me._iCust_ID, strInput, 1) 'Get data for the Box
                    If dt.Rows.Count > 0 Then
                        ...
                        If iBoxQty = dt.Rows.Count Then
                            ...
                            ElseIf iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID Then
                                strPO = dt.Rows(0).Item("PO") : strASN_SKU_Desc = "" : strPoLocOther1 = "PO: " & dt.Rows(0).Item("PO")
                            ElseIf iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID _
                                   AndAlso Convert.ToString(dt.Rows(0).Item("ASN_SKU_Desc")).Trim.ToUpper = PSS.Data.Buisness.WIKO.WIKO.WIKO_FexEx_PosCode.Trim.ToUpper Then
                                strPO = dt.Rows(0).Item("PO") : strASN_SKU_Desc = Convert.ToString(dt.Rows(0).Item("ASN_SKU_Desc")).Trim : strPoLocOther1 = "PO: " & dt.Rows(0).Item("PO")
                            Else
                                strPO = dt.Rows(0).Item("PO") : strASN_SKU_Desc = "" : strPoLocOther1 = "PO: " & dt.Rows(0).Item("PO")
                            End If

                            Me._objWiKo_Receiving.PrintReceivedBoxLabel(dt.Rows(0).Item("BoxName"), iBoxQty, dt.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                ...
                ElseIf Me.rbtBySN.Checked Then 'BY SN (IMEI) -2------------------------------------------------------------------------------------------------------------
                    ...
                    dtSN = Me._objWiKo_Receiving.GetWiKoReceivedData(Me._iCust_ID, strInput, 2)   'get data for the SN
                    If dtSN.Rows.Count > 0 Then
                        ...
                        If arrLstBoxes.Count = 1 Then 'one box
                            dt = Me._objWiKo_Receiving.GetWiKoReceivedData(Me._iCust_ID, arrLstBoxes(0), 1)   'get box data  
                            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                            If iBoxQty = dt.Rows.Count Then
                                'print Label
                                If iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCricket_LOC_ID Then
                    ...
                    '    dtPO = Me._objWiKo_Receiving.GetWiKoReceivedData(Me._iCust_ID, strInput, 3) 'get data for PO
                    ...
                    '            If i < 1 OrElse i > arrLstBoxes.Count Then Throw New Exception("Invalid input.")
                    '            Dim selectedBoxName As String = arrLstBoxes(i - 1)
                    '            dt = Me._objWiKo_Receiving.GetWiKoReceivedData(Me._iCust_ID, selectedBoxName, 1)   'get box data
                    '            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                    '            If iBoxQty = dt.Rows.Count Then
                    '                'print Label
                    '                iLoc_ID = Convert.ToInt32(dt.Rows(0).Item("Loc_ID"))
        ...
        Private Sub btnReprintBoxLabel_Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel_Seed.Click
            ...
            Try
                If Me.rbtByBoxName_Seed.Checked Then 'BY BOX NAME 1-------------------------------------------------------------------------------------------------------------
                    strInput = InputBox("Enter a box name:", "Box Name").Trim
                    If strInput = "" Then Throw New Exception("Please enter a valid box name.")
                    dt = Me._objWiKo_Receiving.GetWiKoReceivedSeedstockData(Me._iCust_ID, strInput, 1) 'Get data for the Box
                    If dt.Rows.Count > 0 Then
                        iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                        If iBoxQty = dt.Rows.Count Then
                            'print Label
                            ...
                            Me._objWiKo_Receiving.PrintReceivedSeedstockBoxLabel(strInput, iBoxQty, dt.Rows(0).Item("ASN_SKU"), "", dt.Rows(0).Item("PSS_Model"), "", _
                ...
                ElseIf Me.rbtBySN_Seed.Checked Then 'BY SN (IMEI) 2------------------------------------------------------------------------------------------------------------
                    strInput = InputBox("Enter a SN (IMEI):", "SN (IMEI)").Trim
                    If strInput = "" Then Throw New Exception("Please enter a valid SN (IMEI).")
                    dtSN = Me._objWiKo_Receiving.GetWiKoReceivedSeedstockData(Me._iCust_ID, strInput, 2)   'get data for the SN
                    ...
                    If dtSN.Rows.Count > 0 Then
                        ...
                        If arrLstBoxes.Count = 1 Then 'one box
                            ...
                            dt = Me._objWiKo_Receiving.GetWiKoReceivedSeedstockData(Me._iCust_ID, selectedBoxName, 1)   'Get data for the Box
                            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
...
#End Region
        ...
        Private Sub cboModel_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboModel.TextChanged
