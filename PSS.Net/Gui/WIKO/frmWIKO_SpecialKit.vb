...
Namespace Gui.WIKO
    Public Class frmWIKO_SpecialKit
        ...
        Private _objWIKO_SPKit As PSS.Data.Buisness.WIKO.WIKO_SpecialKit
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strScreenName As String)
            ...
            Me._objWIKO_SPKit = New PSS.Data.Buisness.WIKO.WIKO_SpecialKit()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWIKO_SpecialKit))
            ...
            Me.btnDelAll.Location = New System.Drawing.Point(520, 232)
            Me.btnDelAll.Name = "btnDelAll"
            Me.btnDelAll.Size = New System.Drawing.Size(152, 32)
            Me.btnDelAll.TabIndex = 183
            ...
            Me.btnDelOne.Location = New System.Drawing.Point(520, 136)
            Me.btnDelOne.Name = "btnDelOne"
            Me.btnDelOne.Size = New System.Drawing.Size(152, 32)
            Me.btnDelOne.TabIndex = 182
            ...
            Me.lblLocation.Location = New System.Drawing.Point(392, 16)
            Me.lblLocation.Name = "lblLocation"
            Me.lblLocation.Size = New System.Drawing.Size(72, 21)
            Me.lblLocation.TabIndex = 185
            ...
            Me.cboLocation.Location = New System.Drawing.Point(472, 16)
            ...
            Me.cboCustomer.Location = New System.Drawing.Point(136, 16)
            ...
            Me.cboModel.Location = New System.Drawing.Point(136, 48)
            ...
            Me.tdgIMEI_ICCID.Images.Add(CType(resources.GetObject("resource.Images3"), System.Drawing.Bitmap))
            Me.tdgIMEI_ICCID.Location = New System.Drawing.Point(32, 136)
            ...
            Me.lblKittedQty.Location = New System.Drawing.Point(392, 116)
            Me.lblKittedQty.Name = "lblKittedQty"
            Me.lblKittedQty.Size = New System.Drawing.Size(120, 21)
            Me.lblKittedQty.TabIndex = 193
            ...
            Me.lblAccount.Location = New System.Drawing.Point(392, 48)
            Me.lblAccount.Name = "lblAccount"
            Me.lblAccount.Size = New System.Drawing.Size(72, 21)
            Me.lblAccount.TabIndex = 197
            ...
            Me.cboAccount.Images.Add(CType(resources.GetObject("resource.Images4"), System.Drawing.Bitmap))
            Me.cboAccount.ItemHeight = 15
            Me.cboAccount.Location = New System.Drawing.Point(472, 48)
            ...
            Me.btnClearEntry.Location = New System.Drawing.Point(392, 88)
            Me.btnClearEntry.Name = "btnClearEntry"
            Me.btnClearEntry.Size = New System.Drawing.Size(72, 22)
            Me.btnClearEntry.TabIndex = 198
            ...
            Me.Name = "frmWIKO_SpecialKit"
            Me.Text = "frmWIKO_SpecialKit"
...
#End Region
        ...
        Private Sub frmWIKO_SpecialKit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                'Initialize dt table
                Me._dtKitting = Me._objWIKO_SPKit.GetKitDatatableDef
                ...
                'Loc info
                dtLoc = Me._objWIKO_BoxShip.GetWiKoLocations(Me._iMenuCustID, False)
                ...
                dtAcct = _objWIKO_SP.GetWikoAccounts(iCust_ID, iLoc_ID)
                Misc.PopulateC1DropDownList(Me.cboAccount, dtAcct, "Account", "Account")
                strAccount = Me.cboAccount.SelectedValue

                'Model info
                dtModel = Me._objWIKO.getWIKOModels(Me._iMenuCustID, True)
                Misc.PopulateC1DropDownList(Me.cboModel, dtModel, "Model_Desc", "Model_ID")
                Me.cboModel.SelectedValue = 0


            Catch ex As Exception
                MessageBox.Show(ex.ToString, "frmWIKO_SpecialKit_Load", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            End Try
            ...
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtDeviceIMEI.Text.Length > 0 AndAlso Me.txtSIMCardICCID.Text.Length = 0 Then
                        If _objWIKO_SP.ValidateImeiNumber(iCust_ID, iLoc_ID, cboAccount.SelectedValue, txtDeviceIMEI.Text) = False Then
        ...
        Private Sub ProcessKit()
            ...
            Try
                ...
                dtDevice = Me._objWIKO_SPKit.GetDeviceData(Me.cboCustomer.SelectedValue, Me.cboLocation.SelectedValue, strAccount, strIMEI)

                'WI_ID, WO_ID, WR_ID, WO_CustWO, WO_Date, WO_Quantity, Device_ID, ICCID, Kitted
                dtSIMCard = Me._objWIKO_SPKit.GetSIMCardData(Me.cboCustomer.SelectedValue, Me.cboLocation.SelectedValue, strICCID)
                ...
                ElseIf dtSIMCard.Rows(0).Item("Kitted") > 0 Then
                    ...
                    Me.txtSIMCardICCID.SelectAll() : Me.txtSIMCardICCID.Focus()
                ElseIf Not Me._objWIKO_SP.IsPretestPassed(dtDevice.Rows(0).Item("Device_ID")) Then
                ...
                Else 'Ready to kit
                    ...
                    i = Me._objWIKO_SPKit.UpdateKittedItems(dtDevice.Rows(0).Item("EW_ID"), dtSIMCard.Rows(0).Item("WI_ID"), Me._strKittedSession, strKitted_DateTime, Me._iUserID)
            ...
            Try
                ...
                If Me.rbtByIMEI.Checked Then
                    ...
                    If iEW_ID > 0 AndAlso iWI_ID > 0 Then
                        k = Me._objWIKO_SPKit.UndoKittedItems(iEW_ID.ToString, iWI_ID.ToString)
                        Me.BindKittedData()
                        Me.lblKittedQty.Text = "Kitted Qty: " & Me._dtKitting.Rows.Count.ToString
        ...
        Private Sub btnDelAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelAll.Click
            ...
            Try
                ...
                k = Me._objWIKO_SPKit.UndoKittedItems(strEW_IDs, strWI_IDs)
