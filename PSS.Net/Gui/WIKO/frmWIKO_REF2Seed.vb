...
Namespace Gui.WIKO
    Public Class frmWIKO_REF2Seed
        ...
        Private _objWIKO_REF2Seed As PSS.Data.Buisness.WIKO.WIKO_REF2Seed
        Private _objWIKO_Recv As PSS.Data.Buisness.WIKO.WIKO_Receiving
        Private _objWIKO_BoxShip As PSS.Data.Buisness.WIKO.WIKO_ProduceBox
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCust_ID As Integer, ByVal strScreenName As String)
            ...
            Me._objWIKO_REF2Seed = New PSS.Data.Buisness.WIKO.WIKO_REF2Seed()
            Me._objWIKO_Recv = New PSS.Data.Buisness.WIKO.WIKO_Receiving()
            Me._objWIKO_BoxShip = New PSS.Data.Buisness.WIKO.WIKO_ProduceBox()
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    Me._objWIKO = Nothing
                    Me._objWIKO_REF2Seed = Nothing
                    Me._objWIKO_Recv = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWIKO_REF2Seed))
...
#End Region
        ...
        Private Sub frmWIKO_REF2Seed_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                ElseIf Me._iMenuCustID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
                    ...
                    dtSKU = Me._objCoolPad_Receiving.getModelData(PSS.Data.Buisness.CP.CoolPad.CoolPad_Product_ID, Me._iMenuCustID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnLoadData_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLoadData.Click
            ...
            Try
                ...
                If Me._iMenuCustID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID Then
                    Me._dt = Me._objWIKO_REF2Seed.GetREF2SeedstockData(Me._iMenuCustID, Me.cboLocation.SelectedValue, Me.cboModel.SelectedValue)
                ElseIf Me._iMenuCustID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
                    Me._dt = Me._objWIKO_REF2Seed.GetREF2SeedstockData(Me._iMenuCustID, Me.cboLocation.SelectedValue, Me.cboASN_In_Sku.SelectedValue)
                Else
                    Exit Sub
                End If
            ...
            Try
                ...
                With Me.tdgData1
                    For Each iRow In .SelectedRows
                        ...
                        Else
                            If Not Me._objWIKO_REF2Seed.IsAlreadyUnusedSeedstockDevice(Me._iMenuCustID, .Columns("SN").CellText(iRow).ToString.Trim) Then
                ...
                If strDevice_IDs.Trim.Length > 0 Then
                    'getWorkOrderID
                    iWO_ID = Me._objWIKO_REF2Seed.GetWorkOrderID(Me._iMenuCustID, iLoc_ID)

                    If Not iWO_ID > 0 Then MessageBox.Show("Invalid WO_ID.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning) : Exit Sub

                    dt = Me._objWIKO_REF2Seed.ProcessREF2Seedstock(Me._iMenuCustID, iLoc_ID, iWO_ID, strDevice_IDs, strDevice_SNs)
                    ...
                    iTray_ID = Me._objWIKO_Recv.getTayID(Me._iUserID, Me._strUser, iWO_ID, strTrayMemo)
                    ...
                    For Each row In dt.Rows
                        ...
                        strManufDate = Me._objWIKO_REF2Seed.GetManufDate(strSN, strDevice_IDs)

                        If Me._iMenuCustID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID Then
                            bReceived = Me._objWIKO_Recv.ReceiveDataIntoSystem(iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
                                                                               strDTime, strWorkDate, iEW_ID, iShift_ID, iTray_ID, _
                                                                               iDevice_ID, iWB_ID, iWrtyFlag, True)
                           
                        ElseIf Me._iMenuCustID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
                            bReceived = Me._objCoolPad_Receiving.ReceiveDataIntoSystem(iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
                                                                           strDTime, strWorkDate, iEW_ID, iShift_ID, iTray_ID, _
                                                                           iWB_ID, iWrtyFlag)
                        End If
