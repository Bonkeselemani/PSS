...
#End Region
        ...
        Private Sub txtSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSN.KeyUp
            Dim dt1, dtQuoteInfo As DataTable
            ...
            If e.KeyValue = 13 Then
                ...
                Try
                    ...
                    If dt1.Rows.Count > 0 Then
                        ...
                        If PSS.Data.Buisness.Generic.IsBillcodeExisted(Convert.ToInt32(dt1.Rows(0)("Device_ID")), "Exception Repairs") = True Then
                            Dim objTech As New PSS.Data.Buisness.NewTech()
                            dtQuoteInfo = objTech.GetExtenedWarrantyData(dt1.Rows(0)("WO_ID"))
                            If IsNothing(dtQuoteInfo) OrElse IsDBNull(dtQuoteInfo.Rows(0)("EstimatedTechHrs")) OrElse Convert.ToInt16(dtQuoteInfo.Rows(0)("EstimatedTechHrs")) = 0 Then
                                MessageBox.Show("Estimate tech hour is missing.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                                Me.txtSN.SelectAll() : Me.txtSN.Focus() : Exit Sub
                            ElseIf IsDBNull(dtQuoteInfo.Rows(0)("EstimatedPartCost")) OrElse Convert.ToInt16(dtQuoteInfo.Rows(0)("EstimatedPartCost")) = 0 Then
                                MessageBox.Show("Estimate part cost is missing.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                                Me.txtSN.SelectAll() : Me.txtSN.Focus() : Exit Sub
                            End If
                        End If
                ...
                If i > 0 Then
                    ...
                    If Me._iMenuCustID > 0 Then
                        If strNextWrkStation.Trim.Length > 0 Then
                            Buisness.Generic.SetTcelloptWorkStationForDevice(strNextWrkStation, iDevice_ID, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, , , , , , )
