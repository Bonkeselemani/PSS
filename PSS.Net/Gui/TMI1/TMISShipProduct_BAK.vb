            ...
            Try
                ...
                For Each R1 In dt.Rows
                    If Me._objTMIShip.IsDeviceHasExceptionRepairs(R1("Device_ID")) = True Then
                        i += Me._objTMIShip.UpdateExcptRepLaborAndPartCharge(R1("Device_ID"))
                    ElseIf Me._objTMIShip.IsDeviceHasPSSWrtyService(R1("Device_ID")) = True Then
                        i += Me._objTMIShip.UpdatePSSWrtyLaborAndPartCharge(R1("Device_ID"))
                    End If
                Next R1
                Return i
            Catch ex As Exception
