...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.btnLanUseOnlyBOM.Location = New System.Drawing.Point(768, 520)
            Me.btnLanUseOnlyBOM.Name = "btnLanUseOnlyBOM"
            Me.btnLanUseOnlyBOM.Size = New System.Drawing.Size(200, 23)
            Me.btnLanUseOnlyBOM.TabIndex = 216
...
#Region "DO NOT USE"
        ...
        '**************************************************************************************************
        Private Sub btnLanUseOnlyBOM_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLanUseOnlyBOM.Click
            'Dim iModelID As Integer = 2827
            'Dim iProdID As Integer = 24

            'Try
            '    Me.MapServicesPartsAndAccessories(iProdID, iModelID)
            '    MessageBox.Show("Completed.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            'Catch ex As Exception
            '    MessageBox.Show(ex.ToString, "btnLanUseOnlyBOM_Click", MessageBoxButtons.OK, MessageBoxIcon.Error)
            'End Try
        End Sub
        '**************************************************************************************************
...
#End Region
        ...
        Private Sub ProcessSN()
            ...
            Dim iR, iPssWrtyOnDeviceID As Integer
            ...
            Try
                ...
                Else
                    ...
                    If Me.txtRecPssSn.Text.Trim.Length > 0 Then Me.txtRecPssSn.Tag = Me._objProdRec.IsDeviceUnderPSSWrty_BaseOnProdShipDate(Me.txtRecPssSn.Text.Trim, PSS.Data.Buisness.TMI.LOCID, iPssWrtyOnDeviceID)
        ...
        Private Function MapServicesPartsAndAccessories(ByVal iProdID As Integer, ByVal iModelID As Integer)
            ...
            Try
                ...
                iBillcodeID = Generic.GetBillCodeID("Exception Repairs", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(1785, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                'S107-Repair & Reprofile
                iBillcodeID = Generic.GetBillCodeID("Depot Repaired", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(1786, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                '6603-S108-No Trouble Found
                iBillcodeID = Generic.GetBillCodeID("PSS Warranty No Fault Found", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(6603, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                'S107-Repair & Reprofile
                iBillcodeID = Generic.GetBillCodeID("Repaired PSS Warranty", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(1786, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0
                ...
                '5923-S26-RUR
                iBillcodeID = Generic.GetBillCodeID("Exception Repairs Quote Rejected", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(5923, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                '5923-S26-RUR
                iBillcodeID = Generic.GetBillCodeID("Scrap", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(5923, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 1, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                '17156-S13-Infestation Unit
                iBillcodeID = Generic.GetBillCodeID("Infestation Unit", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(17156, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0

                '17156-S13-Ship Back Hard Drive
                iBillcodeID = Generic.GetBillCodeID("Ship Back Hard Drive", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(17156, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0
                ...
                iBillcodeID = Generic.GetBillCodeID("Ship Back Hard Drive With Unit", iProdID)
                If iBillcodeID > 0 AndAlso Generic.IsBillcodeMapped(iModelID, iBillcodeID) = 0 Then
                    PSS.Data.Buisness.PartsMap.InsertMap(17156, iBillcodeID, iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                End If
                iBillcodeID = 0
                ...
                dtBillcodeByType = Me._objTMIRec.GetPartAccessoryBillcode(iProdID)
                For Each R1 In dtBillcodeByType.Rows
                    If R1("Billcode_ID").ToString.ToLower.StartsWith("rv_") = False AndAlso R1("Billcode_ID") > 0 AndAlso Generic.IsBillcodeMapped(iModelID, R1("Billcode_ID")) = 0 Then
                        PSS.Data.Buisness.PartsMap.InsertMap(iPSPrice_Temppart, R1("Billcode_ID"), iModelID, iProdID, 13, iLOB_ID, 0, 0, 3, PSS.Core.ApplicationUser.IDuser)
                    End If
                Next R1
        ...
        Private Sub txtRecPssSn_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtRecPssSn.KeyUp
            Dim dt As DataTable
            Dim iPssWrtyOnDeviceID As Integer = 0

            Try
                If e.KeyCode = Keys.Enter AndAlso Me.txtRecPssSn.Text.Trim.Length > 0 Then
                    Me.txtRecPssSn.Tag = Me._objProdRec.IsDeviceUnderPSSWrty_BaseOnProdShipDate(Me.txtRecPssSn.Text.Trim, PSS.Data.Buisness.TMI.LOCID, iPssWrtyOnDeviceID)
                End If
