...
#End Region
                    ...
                    Else
                        ...
                        Else
                            ...
                            ElseIf Not IsDBNull(dt.Rows(0)("Pallett_ID")) AndAlso Convert.ToInt32(dt.Rows(0)("Pallett_ID")) > 0 AndAlso Me.lblBoxName.Tag.ToString.Trim.Length > 0 AndAlso Convert.ToInt32(Me.lblBoxName.Tag) > 0 AndAlso Convert.ToInt32(Me.lblBoxName.Tag) <> dt.Rows(0)("Pallett_ID") Then
                                ...
                                Me.txtDevSN.SelectAll() : Me.txtDevSN.Focus()
                            ElseIf Me._objTMIShip.IsDeviceHasServiceBillcode(Convert.ToInt32(dt.Rows(0)("Device_ID"))) = False Then
                                ...
                                Me.txtDevSN.SelectAll() : Me.txtDevSN.Focus()
                            ElseIf Me._objTMIShip.IsDeviceHasTechCompletedRecord(Convert.ToInt32(dt.Rows(0)("Device_ID"))) = False Then
        ...
        Private Sub ComputeFreightage()
            ...
            '        iMaxWeight = _objTMIShip.GetMaxAvailableFreightBoxWeight()
            ...
            '            Me.txtWeight.SelectAll() : Me.txtWeight.Focus() : Exit Sub
            '        End If
            '        strZipCode = _objTMIShip.GetTMIZipCode(iWOID)
            ...
            '            Exit Sub
            '        End If
            '        iZone = _objTMIShip.GetTMIGroundZoneNumber(strZipCode)
            '        If iZone < 0 Then
            '            MessageBox.Show(_objTMIShip.EnumValue2NameString(iZone), "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            '            Exit Sub
            '        Else
            '            iFreightRate = _objTMIShip.getTMIGroundRate(iWeight, iZone, iCarrierID)
            '            If iFreightRate < 0 Then
            '                MessageBox.Show(_objTMIShip.EnumValue2NameString(iFreightRate), "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            '                Exit Sub
            '            End If
            ...
            'Catch ex As Exception
            '    MessageBox.Show(ex.ToString, "Sub ComputeFreitage ", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            'End Try
        End Sub
                ...
                Else
                    ...
                    Else
                        ...
                        i = Me._objTMIShip.CloseAndShipBox(CInt(Me.lblBoxName.Tag), Convert.ToInt32(Me.lblRMANo.Tag), _
                                                           ...
                                                           strNextStation, Me._objShip, Me.cboCarrier.SelectedValue, _
            ...
            Try
                ...
                Else
                    ...
                    Else
                        ...
                        'Print Repair Letter-----------------------------------------------------------------------------------
                        dt2 = Me._objTMIShip.GetDataTableForPrintRepairLetter(dtPallettInfo.Rows(0).Item("Pallett_ID"))   'CInt(Me.lblBoxName.Tag))
                        If dt2.Rows.Count = 1 Then
                            If Not IsDBNull(dt2.Rows(0).Item("TMIServiceClient")) AndAlso Trim(dt2.Rows(0).Item("TMIServiceClient")).ToUpper = "CENTURYLINK" Then
                                strRepairLetterName = "TMI Shipping Letter CTL Push.rpt"
                                Me._objTMIShip.PrintTMIRepairLetter(strRepairLetterName)
                            ElseIf Not IsDBNull(dt2.Rows(0).Item("TMIServiceClient")) AndAlso Trim(dt2.Rows(0).Item("TMIServiceClient")).ToUpper = "WINDSTREAM" Then
                                strRepairLetterName = "TMI Shipping Letter WS Push.rpt"
                                Me._objTMIShip.PrintTMIRepairLetter(strRepairLetterName)
                            Else
                                MessageBox.Show("Failed to print. TMIServiceClient is nothing or incorrect. Please see IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
        ...
        '*************************************************************************************************************
        Private Function ReCalExceptionRepairsLabor() As Integer
            ...
            Try
                ...
                For Each R1 In dt.Rows
                    Dim objDevice As New Rules.Device(R1("Device_ID"))
                    objDevice.Update()
                    i += TMISharedFunc.BillExceptionRepairs(Convert.ToInt32(R1("Device_ID")), objDevice.CustMarkUp, objDevice.Parts, True)
                Next R1
