...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            'cboSearchType
            '
            Me.cboSearchType.Items.AddRange(New Object() {"Device Codes", "Freq/Capcode", "General", "Pretest", "Pre-Bill Completed", "QC", "RF", "Repair Completed", "Refurbish Completed", "Fulfilment", "Warehouse Item"})
            ...
            'cboOptions
            '
            Me.cboOptions.Items.AddRange(New Object() {"", "Company Name", "Customer Last Name", "Customer Work Order", "PSS Work Order", "Tray Number", "Serial Number", "Ship Manifest", "Old Serial", "IMEI Number", "Pallet ID", "Liquidity Services DID", "Sonitrol RMA", "Packing #", "Syx Manufacturing Serial", "Outbound Box/Pallet Name"})
...
#End Region
            ...
            Try
                ...
                Select Case Me.cboOptions.SelectedIndex
                    ...
                    Case 2
                        ...
                        End If
                    Case 3
                        _searchType = Rules.SearchTypes.CustomerWO
                        _searchString = ""
                        '***************************************
                        'INSTEAD OF USING WO_CustWo, This will speed up respond time
                        Dim dt As DataTable : Dim R1 As DataRow
                        dt = PSS.Data.Buisness.Search.GetWorkOrderID(Me.FormatSS(Me.txtSearch.Text))
                        For Each R1 In dt.Rows
                            If _searchString.Trim.Length > 0 Then _searchString &= ", "
                            _searchString &= R1("WO_ID").ToString
                        Next R1
                        PSS.Data.Buisness.Generic.DisposeDT(dt)
                        If _searchString.Trim.Length = 0 Then
                    ...
                    Case 15
                        _searchType = Rules.SearchTypes.ShippingBoxName
                    Case Else
                        Exit Select
                End Select
		...
		Private Sub cboSearchType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboSearchType.SelectedIndexChanged
			Try
				...
				Else
					Me.pnlSearchCriteria.Visible = False
					If Me.cboSearchType.Text = "Fulfilment" Then Me.lblCriteriaValue.Text = "Order #" Else Me.lblCriteriaValue.Text = "SN/IMEI"
					Me.grpDate.Visible = False
					Me.chkUseDate.Checked = False
				End If
			Catch ex As Exception
