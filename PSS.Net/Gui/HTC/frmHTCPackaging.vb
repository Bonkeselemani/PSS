...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtDevIMEI As System.Windows.Forms.TextBox
    Friend WithEvents btnRemoveAllIMEIs As System.Windows.Forms.Button
    Friend WithEvents btnRemoveIMEI As System.Windows.Forms.Button
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmHTCPackaging))
        ...
        Me.txtDevIMEI = New System.Windows.Forms.TextBox()
        Me.Label10 = New System.Windows.Forms.Label()
        Me.btnCloseBox = New System.Windows.Forms.Button()
        Me.btnRemoveAllIMEIs = New System.Windows.Forms.Button()
        Me.btnRemoveIMEI = New System.Windows.Forms.Button()
        ...
        Me.lblScreenName.Text = "BUILD HTC CARTON BOX"
        ...
        Me.panelPallet.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtDevIMEI, Me.Label10, Me.btnCloseBox, Me.btnRemoveAllIMEIs, Me.btnRemoveIMEI, Me.lstDevices, Me.lblCount, Me.Label3, Me.lblPalletName})
        ...
        'txtDevIMEI
        '
        Me.txtDevIMEI.Location = New System.Drawing.Point(11, 56)
        Me.txtDevIMEI.Name = "txtDevIMEI"
        Me.txtDevIMEI.Size = New System.Drawing.Size(156, 20)
        Me.txtDevIMEI.TabIndex = 0
        Me.txtDevIMEI.Text = ""
        '
        'Label10
        '
        ...
        'btnRemoveAllIMEIs
        '
        Me.btnRemoveAllIMEIs.BackColor = System.Drawing.Color.Red
        Me.btnRemoveAllIMEIs.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.btnRemoveAllIMEIs.ForeColor = System.Drawing.Color.White
        Me.btnRemoveAllIMEIs.Location = New System.Drawing.Point(180, 175)
        Me.btnRemoveAllIMEIs.Name = "btnRemoveAllIMEIs"
        Me.btnRemoveAllIMEIs.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.btnRemoveAllIMEIs.Size = New System.Drawing.Size(148, 33)
        Me.btnRemoveAllIMEIs.TabIndex = 4
        Me.btnRemoveAllIMEIs.Text = "REMOVE ALL IMEIs"
        '
        'btnRemoveIMEI
        '
        Me.btnRemoveIMEI.BackColor = System.Drawing.Color.Red
        Me.btnRemoveIMEI.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.btnRemoveIMEI.ForeColor = System.Drawing.Color.White
        Me.btnRemoveIMEI.Location = New System.Drawing.Point(180, 136)
        Me.btnRemoveIMEI.Name = "btnRemoveIMEI"
        Me.btnRemoveIMEI.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.btnRemoveIMEI.Size = New System.Drawing.Size(148, 32)
        Me.btnRemoveIMEI.TabIndex = 903
        Me.btnRemoveIMEI.Text = "REMOVE IMEI"
        '
        'lstDevices
        '
        ...
        "xt;BackColor:Highlight;}Style14{}OddRow{BackColor:SteelBlue;}RecordSelector{Fore" & _
...
#End Region
    ...
    '**************************************************************************************************
    Private Sub btnRemoveIMEI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveIMEI.Click
        Dim str_IMEI As String = ""
        Dim i As Integer = 0
        ...
        Try
            ...
            '************************
            str_IMEI = InputBox("Enter IMEI.", "Box ID").Trim
            If str_IMEI = "" Then
                Throw New Exception("Please enter a IMEI if you want to remove it from the selected box.")
            End If

            For i = 0 To Me.lstDevices.Items.Count
                If Me.lstDevices.Items.Item(i)("Device_SN").ToString.Trim = str_IMEI Then
            ...
            If iDeviceID > 0 Then
                ...
                If i = 0 Then
                    Throw New Exception("IMEI entered was not removed from Pallet.")
                End If
            ...
            Else
                Throw New Exception("IMEI was not listed.")
            End If
        Catch ex As Exception
            MessageBox.Show(ex.ToString, "Clear IMEI", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
        Finally
            Me.Enabled = True
    ...
    '**************************************************************************************************
    Private Sub btnClearAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveAllIMEIs.Click
        Dim str_sn As String = ""
        Dim i As Integer = 0

        If MessageBox.Show("Are you sure you want to remove all devices from this Box?", "Clear All IMEIs", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = DialogResult.No Then
            Exit Sub
        End If
        ...
        Try
            ...
            If i = 0 Then
                Throw New Exception("No IMEIs were removed from box.")
            End If
            ...
            Me.LoadWeeklyCellProductionNumbers()
        Catch ex As Exception
            MessageBox.Show(ex.ToString, "Clear All IMEIs", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
        Finally
            Me.Enabled = True
            Cursor.Current = Cursors.Default
            Me.txtDevIMEI.Focus()
    ...
    Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
        ...
        Try
            ...
            Cursor.Current = Cursors.WaitCursor
            '************************
            i = objMisc.ClosePallet(Me._HTC_CUSTOMERID, CInt(Me.grdPallets.Columns("Pallett_id").Value), CInt(Me.grdPallets.Columns("Box Name").Value), 3)
            If i = 0 Then
                Throw New Exception("Pallet was not closed due to an error. Please contact IT.")
            End If

            Me._objHTC.PushPalletToNextWorkingStation(CInt(Me.grdPallets.Columns("Pallett_id").Value), "RF")
    ...
    Private Sub ProcessSN()
        Dim i As Integer = 0
        Dim strSN As String = Me.txtDevIMEI.Text.Trim.ToUpper
        ...
        Try
            ...
            ElseIf Me.grdPallets.Columns("Box Name").Value.ToString.Trim = "" Then
                Throw New Exception("Box Name is not selected.")
            ElseIf Trim(Me.txtDevIMEI.Text) = "" Then
                Exit Sub
            ElseIf Me.txtDevIMEI.Text.Trim.Length <> 15 And Me.txtDevIMEI.Text.Trim.Length <> 11 Then
                MsgBox("IMEI length must be either 15 or 11 digits number.", MsgBoxStyle.Information, "Information")
                Me.txtDevIMEI.SelectAll()
                Exit Sub
            ...
            dtDevice = Me._objHTC.GetHTC_TdeviceInfo_InWIP(Me.txtDevIMEI.Text.Trim)
    ...
    '**************************************************************************************************
    Private Sub txtDevIMEI_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDevIMEI.KeyUp
        Try
            If e.KeyValue = 13 Then
                If Me.txtDevIMEI.Text.Trim = "" Then
    ...
    '**************************************************************************************************
    Private Sub txtDevIMEI_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDevIMEI.KeyPress
        Try
            If Not (e.KeyChar.IsDigit(e.KeyChar) Or e.KeyChar.IsControl(e.KeyChar)) Then
                e.Handled = True
            End If
        Catch ex As Exception
            MessageBox.Show(ex.ToString, "IMEI_KeyPress", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
        ...
        Try
            str_pallet = InputBox("Enter Box Name.", "Reprint Pallet Label")
            If str_pallet = "" Then
