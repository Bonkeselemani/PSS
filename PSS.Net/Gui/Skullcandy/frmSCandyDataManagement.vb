...
Namespace Gui
    Public Class frmSCandyDataManagement
        Inherits System.Windows.Forms.Form

        Private _iMenuCustID As Integer
        Private _objSkullcandy As Skullcandy
        Private _dFolder As String = "P:\Dept\SkullCandy\InnerMasterPackExcelFiles"
        Private _strSourceFileName As String = ""
        'Private _arrInvalidRowsIdxs As New ArrayList()
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmSCandyDataManagement))
            ...
            """ me=""Style14"" /><PrintPageFooterStyle parent="""" me=""Style15"" /></Blob>"
            '
            'frmSCandyDataManagement
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.ClientSize = New System.Drawing.Size(856, 638)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TabControl1})
            Me.Name = "frmSCandyDataManagement"
            Me.Text = "frmSCandyDataManagement"
...
#End Region
        ...
        Private Sub btnGetExcelData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetExcelData.Click
            ...
            Try
                ...
                If File.Exists(strFileName) Then
                    '1. Handle data
                    _objSkullcandy2 = New PSS.Data.Buisness.Skullcandy2()
                    ' dt = _objSkullcandy2.LoadExcelData(strFileName, strErrMsg) 'slow way
                    dt = _objSkullcandy2.LoadExcelData_FastWay(strFileName, strDateTime, strErrMsg) 'fast way
        ...
        Private Function ResultDataAfterValidations(ByVal dt As DataTable) As DataTable
            ...
            Dim arrUniqueUPCs As New ArrayList()
            ...
            Try
                ...
                For Each row In dt.Rows
                    ...
                    End If
                    If Not row.IsNull("UPC") Then
                        strTemp = row("UPC")
                        row("UPC") = strTemp.Trim 'reset after trimming pre-space and tail-space
                        dt.AcceptChanges()
                    End If
                Next
                ...
                'Check unique UPC (as primary key)
                For Each row In dt.Rows 'get unique UPCs
                    If Not row.IsNull("UPC") Then
                        strTemp = row("UPC")
                        If Not arrUniqueUPCs.Contains(strTemp.Trim) Then
                            arrUniqueUPCs.Add(strTemp)
                        End If
                    End If
                Next
                ' MessageBox.Show(arrUniqueUPCs.Count.ToString)
                For i = 0 To arrUniqueUPCs.Count - 1 'Check dup UPCs
                    strTemp = arrUniqueUPCs(i)
                    filteredRows = dt.Select("UPC='" & strTemp & "'")
                ...
                If arrInvalidDeplicateRowRecIdxs.Count > 0 Then
                    For Each row In dt.Rows 'flag invalid for dup UPCs
        ...
        Private Sub btnSaveData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveData.Click
            ...
            Try
                ...
                _objSkullcandy2 = New PSS.Data.Buisness.Skullcandy2()
                dtSQLResult = _objSkullcandy2.Save_Retail_InnerMasterPackData(dt, Me.txtSourceFile.Text, iUserID, strMsg)
                ...
                For Each row In dtSQLResult.Rows
                    ...
                    For i = 0 To Me.tdgData1.RowCount - 1
                        ...
                        If iRowID = row("RowID") Then
                            ...
                            Me.tdgData1(i, 7) = row("Status") : Exit For
                        End If
                    Next
                Next
        ...
        Private Sub RefreshData()
            ...
            Try
                ...
                _objSkullcandy2 = New PSS.Data.Buisness.Skullcandy2()
                dt = _objSkullcandy2.Get_Retail_InnerMasterPackData()
        ...
        '******************************************************************
        Private Sub frmSCandyDataManagement_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
            ...
            Catch ex As Exception
                MessageBox.Show(ex.ToString, "Sub frmSCandyDataManagement_Load", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        End Sub
        ...
        Private Sub RemovedBeginAndEndSpacesAndReplaceSingleQuotation(ByRef dt As DataTable)
            ...
            Try
                For Each row In dt.Rows
                    If Not row.IsNull("UPC") Then
                        strS = row("UPC") : row("UPC") = strS.Trim.Replace("'", "")
                    End If
                    If Not row.IsNull("Sku") Then
                        strS = row("Sku") : row("Sku") = strS.Trim.Replace("'", "")
                    End If
                    If Not row.IsNull("Family") Then
                        strS = row("Family") : row("Family") = strS.Trim.Replace("'", "")
                    End If
                Next
                dt.AcceptChanges()
