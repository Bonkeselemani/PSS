...
Public Class frmSCandyRetailRpt
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnRunRpt.Location = New System.Drawing.Point(56, 256)
        ...
        Me.gbDate.Location = New System.Drawing.Point(56, 144)
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.gbReportName, Me.btnRunRpt, Me.gbDate})
        Me.Name = "frmSCandyRetailRpt"
        Me.Text = "frmSCandyRetailRpt"
...
#End Region
    ...
    '***********************************************************************************************
    Private Sub frmSCandyRetailRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub cboReportName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboReportName.TextChanged
        ...
        Try
            If Me.cboReportName.Text <> "Select Report Name" Then
              ...
              If Me._strRptName = "Retail Invoice Report" Then 'default weekly
                    Dim bDate, eDate, currDate As Date
                    currDate = Now.Date
                    If WeekdayName(Weekday(currDate)) = "Sunday" Then
                        eDate = Format(Generic.DateOfPreviousWeek(currDate, DayOfWeek.Monday, 1), "yyyy-MM-dd")
                    Else
                        bDate = Format(Generic.DateOfPreviousWeek(currDate, DayOfWeek.Monday, 0), "yyyy-MM-dd")
                    End If
                    Me.dtpStartDate.Value = bDate : Me.dtpEndDate.Value = eDate
                End If
    ...
    Private Sub btnRunRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunRpt.Click
        ...
        Try
            ...
            Else
                ...
                'Generate Report
                '*************************************
             If Me._strRptName = "Retail Invoice Report" Then
                    objScandyPrint = New PSS.Data.Buisness.SkullcandyPrint()
                    i = objScandyPrint.CreateRetailInvoiceRpt(_iMenuCustID, Me._strRptName, strDateStart, strDateEnd)
