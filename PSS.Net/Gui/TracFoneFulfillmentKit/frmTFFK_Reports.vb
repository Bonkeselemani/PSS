...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Name = "frmTFFK_Reports"
            Me.Text = "frmTFFK_Reports"
...
#End Region
        ...
        '***********************************************************************************************
        Private Sub frmTFFK_Reports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                Me.cboReportName.Items.Clear()
                Me.cboReportName.Items.Add("Select Report Name")

                'Me.cboReportName.Items.Add("Walmart Daily ASN")
                Me.cboReportName.Items.Add("Daily Shipments")
                Me.cboReportName.Items.Add("Warehouse Receipt Report")
                Me.cboReportName.Items.Add("EDI Transaction Report")
                'Me.cboReportName.Items.Add("Daily Receipt")
                Me.cboReportName.Items.Add("Returns")
                Me.cboReportName.Items.Add("Inventory Balance Report")
                'Me.cboReportName.Items.Add("Show Customers Inventory Balance")
                Me.cboReportName.Items.Add("Pending Orders")
        ...
        Private Sub cboReportName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboReportName.SelectedIndexChanged
            ...
            Try
                If Me.cboReportName.Text <> "Select Report Name" Then
                    ...
                    'If Me._strRptName = "Walmart Daily ASN" Then
                    'Me.gbDate.Visible = True
                    'Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                    'Me.dtpEndDate.Value = Now.Date
                    'ElseIf Me._strRptName = "Daily Shipments" Then
                    If Me._strRptName = "Daily Shipments" Then
                        Me.gbDate.Visible = True
                        Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        Me.dtpEndDate.Value = Now.Date
                    ElseIf Me._strRptName = "EDI Transaction Report" Then

                    ElseIf Me._strRptName = "Warehouse Receipt Report" Then ' Default Month to Date
                        Me.gbDate.Visible = True
                        Me.dtpStartDate.Value = Now.Date.AddDays(-Now.Day + 1)
                        Me.dtpEndDate.Value = Now.Date
                    ElseIf Me._strRptName = "Daily Receipt" Then
                        Me.gbDate.Visible = True
                        Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        Me.dtpEndDate.Value = Now.Date
                    ElseIf Me._strRptName = "Returns" Then
                        Me.gbDate.Visible = True
                        Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        Me.dtpEndDate.Value = Now.Date
                    ElseIf Me._strRptName = "Inventory Balance Report" Then 'It is a snapshot data
                        'Me.gbDate.Visible = True
                        'Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        'Me.dtpEndDate.Value = Now.Date
                        'ElseIf Me._strRptName = "Show Customers Inventory Balance" Then
                        'Me.gbDate.Visible = False
                        'Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        'Me.dtpEndDate.Value = Now.Date
                    ElseIf Me._strRptName = "Pending Orders" Then
                        Me.gbDate.Visible = False
                        Me.dtpStartDate.Value = Now.Date.AddDays(-30)
                        Me.dtpEndDate.Value = Now.Date
                    End If
        ...
        Private Sub btnRunRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunRpt.Click
            Dim objTFFKRpt As PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports
            ...
            Try
                ...
                Else
                    ...
                    '*************************************
                    If Me._strRptName = "Walmart Daily ASN" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateWalmartDailyASNRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "EDI Transaction Report" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()

                        objTFFKRpt.TFFK_EDITransaction()

                    ElseIf Me._strRptName = "Daily Shipments" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateDailyShipmentsRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Warehouse Receipt Report" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateWarehouseReceiptReport(Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Daily Receipt" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateDailyReceiptRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Returns" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateReturnsRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Inventory Balance Report" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateInventoryBalanceRpt(Me._strRptName)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Show Customers Inventory Balance" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreateShowCustomersInventoryBalanceRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = "Pending Orders" Then
                        objTFFKRpt = New PSS.Data.Buisness.TracFoneFulfillmentKit.TFFKReports()
                        i = objTFFKRpt.CreatePendingOrdersRpt(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Else
