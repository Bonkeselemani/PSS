...
Namespace Gui.CP
    Public Class frmCoolPad_Report
        ...
        Private _objCoolPad_Report As PSS.Data.Buisness.CP.CoolPad_Report
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objCoolPad_Report = New PSS.Data.Buisness.CP.CoolPad_Report()
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.grpSN.Location = New System.Drawing.Point(16, 312)
            Me.grpSN.Name = "grpSN"
            Me.grpSN.Size = New System.Drawing.Size(400, 56)
            Me.grpSN.TabIndex = 120
            ...
            Me.grpImeiFile.Location = New System.Drawing.Point(440, 16)
            ...
            Me.gbWorkOrder.Location = New System.Drawing.Point(16, 480)
            ...
            Me.lblTitle.Text = "Coolpad Report"
            ...
            Me.gbReportName.Location = New System.Drawing.Point(16, 80)
            ...
            Me.gbDate.Location = New System.Drawing.Point(16, 216)
            ...
            Me.btnRunRpt.Location = New System.Drawing.Point(16, 432)
            ...
            'rdbClose
            '
            Me.rdbClose.BackColor = System.Drawing.Color.LightSkyBlue
            ...
            Me.rdbClose.Text = "Closed"
            '
            'rdbOpen
            '
            Me.rdbOpen.BackColor = System.Drawing.Color.LightSkyBlue
            ...
            Me.grpRptType.Controls.AddRange(New System.Windows.Forms.Control() {Me.rdbClose, Me.rdbOpen})
            ...
            Me.grpRptType.Location = New System.Drawing.Point(16, 376)
            Me.grpRptType.Name = "grpRptType"
            Me.grpRptType.Size = New System.Drawing.Size(400, 48)
            Me.grpRptType.TabIndex = 118
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.grpSN, Me.grpImeiFile, Me.grpRptType, Me.gbWorkOrder, Me.lblTitle, Me.gbReportName, Me.gbDate, Me.btnRunRpt, Me.GroupBox1})
            Me.Name = "frmCoolPad_Report"
            Me.Text = "frmCoolPad_Report"
...
#End Region
        ...
        Private Sub frmCoolPad_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                If _iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    Me.lblTitle.Text = "WINGTECH T-MOBILE REPORT"
                ElseIf _iCust_ID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
                    Me.lblTitle.Text = "COOLPAD REPORT"
                End If
                Dim i As Integer = _objCoolPad_Report.getCustomerLocation(_iCust_ID, cboLocation)
        ...
        Private Sub btnRunRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunRpt.Click
            ...
            Try
                ...
                Else
                    ...
                    'Generate Report
                    '*************************************
                    _objCoolPad_Report = New PSS.Data.Buisness.CP.CoolPad_Report()
                    _objCoolPad_Report.colDefault = colDefault
                    ...
                    If Me._strRptName = Me.ReportNames.RA_uploaded_report.ToString Then
                        i = _objCoolPad_Report.CreateInventoryReport(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 1, iOption, strImei)
                    ...
                    ElseIf Me._strRptName = Me.ReportNames.Received_Report.ToString Then
                        i = _objCoolPad_Report.CreateInventoryReport(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 2, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =part used
                    ElseIf Me._strRptName = Me.ReportNames.Part_Used.ToString Then
                        i = _objCoolPad_Report.CreateASN(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 7, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Shipped_Report
                    ElseIf Me._strRptName = Me.ReportNames.Shipped_Report.ToString Then
                        i = _objCoolPad_Report.CreateASN(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 3, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Status_Report
                    ElseIf Me._strRptName = Me.ReportNames.Status_Report.ToString Then
                        i = _objCoolPad_Report.CreateInventoryReport(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 4, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'IF Report =Pretest_Report
                        'WEEKLY REPORT 
                    ElseIf Me._strRptName = Me.ReportNames.Weekly_Report.ToString Then
                        i = _objCoolPad_Report.Get_Weekly_Report(Me._iCust_ID, strDateStart, strDateEnd, "", strLocation, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Pretest_Report.ToString Then
                        i = _objCoolPad_Report.CreatePretestRawDataRpt(Me._iCust_ID, strDateStart, strDateEnd, "", strLocation, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Invoice.ToString Then
                        i = _objCoolPad_Report.CreateASN(Me._iCust_ID, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Orders_Status.ToString Then
                        Dim iStatus As Integer = 0
                        If Me.rdbOpen.Checked Then
                            iStatus = 1
                        End If
                        i = _objCoolPad_Report.CreateWexATT(Me._iCust_ID, "WEX Open Orders", strDateStart, strDateEnd, strLocation, iStatus)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    End If
                End If
            Catch ex As Exception
        ...
        Private Sub cboReportName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboReportName.SelectedIndexChanged
            ...
            Try
                If Me.cboReportName.Text <> "Select Report Name" Then
                    ...
                    ElseIf Me._strRptName = Me.ReportNames.Weekly_Report.ToString Then
                        Me.gbDate.Visible = True
                        Me.gbDate.Text = "WEEKLY REPORT DATE"
                    ElseIf Me._strRptName = Me.ReportNames.Invoice.ToString Then
                        Me.gbDate.Visible = True
