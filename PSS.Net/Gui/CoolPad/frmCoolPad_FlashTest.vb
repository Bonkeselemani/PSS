...
Namespace Gui.CP
    Public Class frmCoolPad_FlashTest
        Inherits System.Windows.Forms.Form

        Private _iCust_ID As Integer = 0
        Private _strScreenName As String = ""
        Private _objRfFlahTests As PSS.Data.Buisness.CP.CoolPad_RfFlashTests
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objRfFlahTests = New PSS.Data.Buisness.CP.CoolPad_RfFlashTests()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmCoolPad_FlashTest))
            ...
            Me.Name = "frmCoolPad_FlashTest"
            Me.Text = "frmCoolPad_FlashTest"
...
#End Region
        ...
        Private Sub frmCoolPad_FlashTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim i As Integer = 0
        ...
        Private Sub ProcessSN()
            ...
            Try
                ...
                If Not iLoc_id = PSS.Data.Buisness.WIKO.WIKO.WIKO_Special_LOC_ID Then
                    ' Check FQA Result FOR WIKO AND COOLPAD AND VINSMART
                    If _iCust_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID _
                    Or _iCust_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID _
 Or _iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID _
                    Or _iCust_ID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
            ...
            Try
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._objRfFlahTests.InsertRFlashWikoCoolpad(PSS.Core.Global.ApplicationUser.IDuser, strSN, _iRFResult) Then
                            Me.LoadTestHistory(Me._iDevice_ID)
                        Else
                        End If
                        Me.txtDeviceSN.SelectAll()
