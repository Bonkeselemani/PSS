...
Public Class DNURec__DeviceChange
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "DNURec_ DeviceChange.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDNURec__DeviceChange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DNURec__DeviceChange = New DNURec__DeviceChange
        rpt.Site = Me.Site
        Return rpt
    End Function
