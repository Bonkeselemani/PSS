...
Namespace Gui.Receiving
    ...
    Public Class frmMOTO_CellDeviceInfo
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Name = "frmMOTO_CellDeviceInfo"
...
#End Region
        ...
        Private Sub frmCellDeviceInfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If ManufName = "Motorola" Then
                ...
                If Len(Trim(frmMOTO_Receiving.coDeviceSN)) < 1 Or Len(Trim(ModelID)) < 1 Then
...
APCcode:
                ...
                If txtDateCodeType = "CSN" Then
                    If Len(Trim(frmMOTO_Receiving.coDeviceSN)) > 7 Then
                        txtDateCode = Mid$(Trim(frmMOTO_Receiving.coDeviceSN), 9, 3)
                        'Make hex code conversion here
                        Dim valHex As String = Mid$(Trim(frmMOTO_Receiving.coDeviceSN), 1, 8)
                        Dim vals1 As String = Mid$(Trim(frmMOTO_Receiving.coDeviceSN), 1, 2)
                        Dim vals2 As String = Mid$(Trim(frmMOTO_Receiving.coDeviceSN), 3, 6)
                ...
                ElseIf txtDateCodeType = "GSM" Then
                    If Len(Trim(frmMOTO_Receiving.coDeviceSN)) > 5 Then
                        txtDateCode = Mid$(Trim(frmMOTO_Receiving.coDeviceSN), 5, 2) & "J"
                    End If
                End If
...
DateCode:
                ...
                If Trim(UCase(woCustWO)) = "RLCPSS051004AFRU" Or Trim(UCase(woCustWO)) = "RLCPSS051004BFRU" Then
                    ...
                    cboCustomerReason.Text = "No Complaint Given"
                End If
                If Trim(UCase(woCustWO)) = "RLCPSS051704AFRU" Or Trim(UCase(woCustWO)) = "RLCPSS051704BFRU" Then
                    txtCourierTrackIN.Text = "EGL"
                    txtTransCode.Text = ""
                    txtCarrModelCode.Text = ""
                    txtMIN.Text = ""
                    ...
                    cboCustomerReason.Text = "No Complaint Given"
                End If
                If Trim(UCase(woCustWO)) = "RLCPSS051304AFRU" Then
                    txtCourierTrackIN.Text = "EGL"
                    txtTransCode.Text = ""
                    txtCarrModelCode.Text = ""
                    txtMIN.Text = ""
                ...
                If Trim(UCase(woCustWO)) = "RLCPSS051704CFRU" Or Trim(UCase(woCustWO)) = "RLCPSS051704DFRU" Then
                    txtCourierTrackIN.Text = "EGL"
                    txtTransCode.Text = ""
                    txtCarrModelCode.Text = ""
                    txtMIN.Text = ""
                    ...
                    cboCustomerReason.Text = "No Complaint Given"
                End If
                If Trim(UCase(woCustWO)) = "RLCPSS051704EFRU" Or Trim(UCase(woCustWO)) = "RLCPSS051704FFRU" Then
                    txtCourierTrackIN.Text = "EGL"
                    txtTransCode.Text = ""
                    txtCarrModelCode.Text = ""
                    txtMIN.Text = ""
            ...
            'frmMOTO_Receiving.vcCSN = txtCSN
        ...
        Private Sub txtPOP_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPOP.Leave
            ...
            If ManufFlag = "M" Then
                ...
                If txtDateCodeType = "GSM" Then
                    ...
                    txtIncomingIMEI.Text = frmMOTO_Receiving.coDeviceSN
                Else
        ...
        Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
            ...
            frmMOTO_Receiving.cellValCustomer = txtCustomerName.Text
            frmMOTO_Receiving.cellValDateCode = cboDateCode.Text
            frmMOTO_Receiving.cellValPOP = txtPOP.Text
            frmMOTO_Receiving.cellValProdCode = txtProductCode.Text
            frmMOTO_Receiving.cellValMSN = txtMSN.Text
            frmMOTO_Receiving.cellValModel = txtModel.Text

            'Unload the form and return to parent.
            'frmMOTO_Receiving.txtCell.Focus()
            frmMOTO_Receiving.waitStateVAL = 1
            Me.Close()
        ...
        Private Sub frmCellDeviceInfo_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
            ...
            If frmMOTO_Receiving.waitStateVAL = 0 Then
                frmMOTO_Receiving.waitStateVAL = 2
            End If
        ...
        Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
            ...
            For xcount = 0 To UBound(arrCarrier)
                If Trim(arrCarrier(xcount, 1)) = Trim(cboAirCarrCode.Text) Then
                    frmMOTO_Receiving.vcAirCarrCode = arrCarrier(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrTransaction)
                If Trim(arrTransaction(xcount, 1)) = Trim(cboTransCode.Text) Then
                    frmMOTO_Receiving.vcTransactionCode = arrTransaction(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrAPC)
                If Trim(arrAPC(xcount, 0)) = Trim(cboProd_APCCode.Text) Then
                    frmMOTO_Receiving.vcAPCcode = arrAPC(xcount, 3)
                    Exit For
                End If
            Next
            ...
            frmMOTO_Receiving.vcDateCode = cboDateCode.Text
            frmMOTO_Receiving.vcCourierTrackIN = txtCourierTrackIN.Text
            'frmMOTO_Receiving.vcAPCcode = txtProd_APCCode.Text
            frmMOTO_Receiving.vcTranceiverCode = txtTransCode.Text
            frmMOTO_Receiving.vcIncomingIMEI = txtIncomingIMEI.Text
            frmMOTO_Receiving.vcWrtyClaimNum = txtWarrantyClaimNum.Text

            'If Len(Trim(cboAirCarrCode.Text)) > 0 Then frmMOTO_Receiving.vcAirCarrCode = cboAirCarrCode.Text
            If Len(Trim(txtCarrModelCode.Text)) > 0 Then frmMOTO_Receiving.vcCarrModelCode = txtCarrModelCode.Text
            If Len(Trim(txtMIN.Text)) > 0 Then frmMOTO_Receiving.vcMIN = txtMIN.Text
            'If Len(Trim(cboDateCode.Text)) > 0 Then frmMOTO_Receiving.vcDateCode = cboDateCode.Text
            If vMWrty = 1 Then
                frmMOTO_Receiving.vcDateCodeVM = "1"
            Else
                frmMOTO_Receiving.vcDateCodeVM = "0"
            End If
            If Len(Trim(txtCustomerName.Text)) > 0 Then frmMOTO_Receiving.vcCustomerName = txtCustomerName.Text
            If Len(Trim(txtModel.Text)) > 0 Then frmMOTO_Receiving.vcModel = txtModel.Text
            If Len(Trim(txtPOP.Text)) > 0 Then frmMOTO_Receiving.vcPOP = txtPOP.Text
            If Len(Trim(txtMSN.Text)) > 0 Then frmMOTO_Receiving.vcMSN = txtMSN.Text
            If Len(Trim(txtProductCode.Text)) > 0 Then frmMOTO_Receiving.vcProductCode = txtProductCode.Text
            If Len(Trim(lblCustomerReasonNameString.Text)) > 0 Then frmMOTO_Receiving.vcComplaint = lblCustomerReasonNameString.Text
            ...
            '//NEW
            If txtDateCodeType = "GSM" Then
                frmMOTO_Receiving.cellValMSN = frmMOTO_Receiving.coDeviceSN
                frmMOTO_Receiving.vcMSN = frmMOTO_Receiving.coDeviceSN
            ElseIf txtDateCodeType = "CSN" Then
                frmMOTO_Receiving.vcCSN = frmMOTO_Receiving.coDeviceSN
            End If
            '//NEW
