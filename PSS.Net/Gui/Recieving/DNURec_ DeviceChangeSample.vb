...
Public Class DNURec__DeviceChangeSample
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "DNURec_ DeviceChangeSample.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDNURec__DeviceChangeSample
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DNURec__DeviceChangeSample = New DNURec__DeviceChangeSample
        rpt.Site = Me.Site
        Return rpt
    End Function
