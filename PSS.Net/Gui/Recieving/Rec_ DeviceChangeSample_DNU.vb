...
Public Class Rec__DeviceChangeSample_DNU
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rec_ DeviceChangeSample_DNU.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRec__DeviceChangeSample_DNU
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rec__DeviceChangeSample_DNU = New Rec__DeviceChangeSample_DNU
        rpt.Site = Me.Site
        Return rpt
    End Function
