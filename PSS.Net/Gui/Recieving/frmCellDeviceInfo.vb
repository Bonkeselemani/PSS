...
Namespace Gui.Receiving
    ...
    Public Class frmCellDeviceInfo
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            'cboReturnCode
            '
            Me.cboReturnCode.Location = New System.Drawing.Point(160, 296)
            Me.cboReturnCode.Name = "cboReturnCode"
            Me.cboReturnCode.Size = New System.Drawing.Size(152, 21)
            Me.cboReturnCode.TabIndex = 15
            '
            'lblReturnCode
            '
            Me.lblReturnCode.Location = New System.Drawing.Point(64, 296)
            Me.lblReturnCode.Name = "lblReturnCode"
            Me.lblReturnCode.Size = New System.Drawing.Size(100, 16)
            Me.lblReturnCode.TabIndex = 73
            Me.lblReturnCode.Text = "Return Code:"
            Me.lblReturnCode.TextAlign = System.Drawing.ContentAlignment.BottomRight
            '
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblPOPformat, Me.lblExp, Me.lblPOPexplain, Me.btnAdd, Me.txtPOP, Me.lblPOP, Me.cboDateCode, Me.lblDateCode, Me.txtCustomerName, Me.lblCustomerName, Me.grpMotorola})
            Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
            Me.Name = "frmCellDeviceInfo"
            Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
            Me.Text = "Cellular Device Information"
...
#End Region
        ...
        Private Sub frmCellDeviceInfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            'March 23, 2004
            'Craig Haney //Determine if Customer has return/special code

            Dim tmpDS As PSS.Data.Production.tcustomer
            Dim tmpRS As DataRow = tmpDS.GetRowByPK(CustIDint)
            Dim tmpDS2 As PSS.Data.Production.tdevicecodes
            Dim vCV As Integer = 0
            Dim tmpCount As Integer = 0

            If tmpRS("Cust_SpecialCodes") > 0 Then
                vCV = tmpRS("Cust_SpecialCodes")
                lblReturnCode.Visible = True
                cboReturnCode.Visible = True
                Try
                    cboReturnCode.Items.Clear()
                Catch ex As Exception
                End Try
                Dim tmpDT As DataTable = tmpDS2.GetReturnCode
                Dim tmpR As DataRow

                cboReturnCode.DataSource = tmpDT
                cboReturnCode.DisplayMember = tmpDT.Columns("DCode_LDesc").ToString
                cboReturnCode.ValueMember = tmpDT.Columns("Dcode_ID").ToString
                cboReturnCode.SelectedIndex = -1
            Else
                lblReturnCode.Visible = False
                cboReturnCode.Visible = False
            End If
            ...
            If ManufName = "Motorola" Then
                ...
                If Len(Trim(frmReceiving.coDeviceSN)) < 1 Or Len(Trim(ModelID)) < 1 Then
...
APCcode:
                ...
                If txtDateCodeType = "CSN" Then
                    If Len(Trim(frmReceiving.coDeviceSN)) > 10 Then
                        txtDateCode = Mid$(Trim(frmReceiving.coDeviceSN), 9, 3)
                        'Make hex code conversion here
                        Dim valHex As String = Mid$(Trim(frmReceiving.coDeviceSN), 1, 8)
                        Dim vals1 As String = Mid$(Trim(frmReceiving.coDeviceSN), 1, 2)
                        Dim vals2 As String = Mid$(Trim(frmReceiving.coDeviceSN), 3, 6)
                ...
                ElseIf txtDateCodeType = "GSM" Then
                    If Len(Trim(frmReceiving.coDeviceSN)) > 5 Then
                        txtDateCode = Mid$(Trim(frmReceiving.coDeviceSN), 5, 2) & "J"
                    End If
                End If
...
DateCode:
        ...
        Private Function VerifyPOP() As Boolean
            ...
            Else
                ...
                Try
                    txtPOP.Text = PSS.Gui.Receiving.General.FormatDateShort(txtPOP.Text)
                Catch ex As Exception
                End Try
        ...
        Private Sub txtPOP_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPOP.Leave
            ...
            If ManufFlag = "M" Then
                ...
                If txtDateCodeType = "GSM" Then
                    ...
                    txtIncomingIMEI.Text = frmReceiving.coDeviceSN
                Else
        ...
        Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
            ...
            frmReceiving.cellValCustomer = txtCustomerName.Text
            frmReceiving.cellValDateCode = cboDateCode.Text
            frmReceiving.cellValPOP = txtPOP.Text
            frmReceiving.cellValProdCode = txtProductCode.Text
            frmReceiving.cellValMSN = txtMSN.Text
            frmReceiving.cellValModel = txtModel.Text

            'Unload the form and return to parent.
            'frmReceiving.txtCell.Focus()
            frmReceiving.waitStateVAL = 1
            Me.Close()
        ...
        Private Sub frmCellDeviceInfo_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
            ...
            If frmReceiving.waitStateVAL = 0 Then
                frmReceiving.waitStateVAL = 2
            End If

        End Sub

        Private Sub txtCustomerName_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
            ...
            For xcount = 0 To UBound(arrCarrier)
                If Trim(arrCarrier(xcount, 1)) = Trim(cboAirCarrCode.Text) Then
                    frmReceiving.vcAirCarrCode = arrCarrier(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrTransaction)
                If Trim(arrTransaction(xcount, 1)) = Trim(cboTransCode.Text) Then
                    frmReceiving.vcTransactionCode = arrTransaction(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrAPC)
                If Trim(arrAPC(xcount, 0)) = Trim(cboProd_APCCode.Text) Then
                    frmReceiving.vcAPCcode = arrAPC(xcount, 3)
                    Exit For
                End If
            Next
            ...
            frmReceiving.vcDateCode = cboDateCode.Text
            frmReceiving.vcCourierTrackIN = txtCourierTrackIN.Text
            'frmReceiving.vcAPCcode = txtProd_APCCode.Text
            frmReceiving.vcTranceiverCode = txtTransCode.Text
            frmReceiving.vcIncomingIMEI = txtIncomingIMEI.Text
            frmReceiving.vcWrtyClaimNum = txtWarrantyClaimNum.Text

            'If Len(Trim(cboAirCarrCode.Text)) > 0 Then frmReceiving.vcAirCarrCode = cboAirCarrCode.Text
            If Len(Trim(txtCarrModelCode.Text)) > 0 Then frmReceiving.vcCarrModelCode = txtCarrModelCode.Text
            If Len(Trim(txtMIN.Text)) > 0 Then frmReceiving.vcMIN = txtMIN.Text
            'If Len(Trim(cboDateCode.Text)) > 0 Then frmReceiving.vcDateCode = cboDateCode.Text
            If vMWrty = 1 Then
                frmReceiving.vcDateCodeVM = "1"
            Else
                frmReceiving.vcDateCodeVM = "0"
            End If
            If Len(Trim(txtCustomerName.Text)) > 0 Then frmReceiving.vcCustomerName = txtCustomerName.Text
            If Len(Trim(txtModel.Text)) > 0 Then frmReceiving.vcModel = txtModel.Text
            If Len(Trim(txtPOP.Text)) > 0 Then frmReceiving.vcPOP = txtPOP.Text
            If Len(Trim(txtMSN.Text)) > 0 Then frmReceiving.vcMSN = txtMSN.Text
            If Len(Trim(txtProductCode.Text)) > 0 Then frmReceiving.vcProductCode = txtProductCode.Text
            If Len(Trim(lblCustomerReasonNameString.Text)) > 0 Then frmReceiving.vcComplaint = lblCustomerReasonNameString.Text
            'Craig Haney
            If Len(Trim(cboReturnCode.SelectedValue)) > 0 Then frmReceiving.vcReturnCode = cboReturnCode.SelectedValue
            'Craig Haney
            If Len(Trim(valCSNdecimal)) > 0 Then frmMOTO_Receiving.vcDecimal = valCSNdecimal
            ...
            '//NEW
            If txtDateCodeType = "GSM" Then
                frmReceiving.cellValMSN = frmReceiving.coDeviceSN
                frmReceiving.vcMSN = frmReceiving.coDeviceSN
            ElseIf txtDateCodeType = "CSN" Then
                frmReceiving.vcCSN = frmReceiving.coDeviceSN
            End If
            '//NEW
        ...
        Private Sub PopulateTransaction()
            ...
            dtTransaction = tblJoins.GenericSelect("SELECT lcodesdetail.* from (lcodesmaster INNER JOIN lcodesdetail ON lcodesmaster.mcode_id = lcodesdetail.mcode_id) Where lcodesmaster.mcode_desc='transaction' and lcodesdetail.manuf_id=1 and lcodesdetail.prod_id=2 AND lcodesdetail.Dcode_Inactive = 0")
            Dim r As DataRow
        ...
        Private Sub PopulateCarrier()
            ...
            dtCarrier = tblJoins.GenericSelect("SELECT lcodesdetail.* from (lcodesmaster INNER JOIN lcodesdetail ON lcodesmaster.mcode_id = lcodesdetail.mcode_id) Where lcodesmaster.mcode_desc='carrier' and lcodesdetail.manuf_id=1 and lcodesdetail.prod_id=2 AND lcodesdetail.Dcode_Inactive = 0")
            Dim r As DataRow
        ...
        Private Sub PopulateAPC()
            ...
            dtAPC = tblJoins.GenericSelect("SELECT lcodesdetail.* from (lcodesmaster INNER JOIN lcodesdetail ON lcodesmaster.mcode_id = lcodesdetail.mcode_id) Where lcodesmaster.mcode_desc='APC' and lcodesdetail.manuf_id=1 and lcodesdetail.prod_id=2 AND lcodesdetail.Dcode_Inactive = 0 order by Dcode_SDesc")
            Dim r As DataRow
        ...
        Private Sub PopulateComplaints()
            ...
            dtComplaint = tblJoins.GenericSelect("SELECT lcodesdetail.* from (lcodesmaster INNER JOIN lcodesdetail ON lcodesmaster.mcode_id = lcodesdetail.mcode_id) Where lcodesmaster.mcode_desc='complaint' and lcodesdetail.manuf_id=" & ManufIDint & " and lcodesdetail.prod_id=2 AND lcodesdetail.Dcode_Inactive = 0 ORDER BY DCode_LDesc")
            Dim r As DataRow
        ...
        Private Sub cboCustomerReason_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboCustomerReason.KeyUp
            ...
            If e.KeyValue = 13 Then
                If cboReturnCode.Visible = True Then
                    cboReturnCode.Focus()
                Else
                    btnSave.Focus()
                End If
        ...
        Private Sub cboReturnCode_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboReturnCode.KeyUp
