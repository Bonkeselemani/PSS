...
Public Class Rec__DeviceChangeSample_OLD
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rec_ DeviceChangeSample_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRec__DeviceChangeSample_OLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rec__DeviceChangeSample_OLD = New Rec__DeviceChangeSample_OLD
        rpt.Site = Me.Site
        Return rpt
    End Function
