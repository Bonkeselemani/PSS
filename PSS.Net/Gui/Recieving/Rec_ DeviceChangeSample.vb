...
Public Class Rec__DeviceChangeSample
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rec_ DeviceChangeSample.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRec__DeviceChangeSample
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rec__DeviceChangeSample = New Rec__DeviceChangeSample
        rpt.Site = Me.Site
        Return rpt
    End Function
