...
Namespace Gui.VV
    Public Class frmVivint_ProduceBox
        ...
        Private _objVivint_ProduceBox As PSS.Data.Buisness.VV.Vivint_ProduceBox
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objVivint_ProduceBox = New PSS.Data.Buisness.VV.Vivint_ProduceBox()
        End Sub
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objVivint_ProduceBox = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVivint_ProduceBox))
            ...
            Me.lbl.TabIndex = 84
            Me.lbl.Text = "Vivint PRODUCE BOX"
            ...
            Me.grdPallets.Location = New System.Drawing.Point(8, 96)
            ...
            Me.cmdReprintPalletLabel.TabIndex = 92
            Me.cmdReprintPalletLabel.Text = "REPRINT BOX LABEL"
            Me.cmdReprintPalletLabel.Visible = False
            '
            'frmVivint_ProduceBox
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.BackColor = System.Drawing.Color.SteelBlue
            Me.ClientSize = New System.Drawing.Size(1000, 622)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.cmdReprintPalletLabel, Me.grdPallets, Me.PanelList, Me.btnPrintManifestRpt, Me.GroupBox2, Me.lblGridCaption, Me.lblPallet, Me.lblCnt, Me.lbl})
            Me.Name = "frmVivint_ProduceBox"
            Me.Text = "frmVivint_ProduceBox"
...
#End Region
        ...
        Private Sub frmVivint_ProduceBox_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                _objVivint_ProduceBox = New PSS.Data.Buisness.VV.Vivint_ProduceBox()
                Dim dtPallets As DataTable = _objVivint_ProduceBox.getAllPallets()
        ...
        Private Sub LoadPallets()
            ...
            Try
                ...
                dtPallets = _objVivint_ProduceBox.getAllPallets()
        ...
        Private Sub ProcessPallet()
            ...
            Try
                ...
                dt = _objVivint_ProduceBox.getDeviceSn(iPallett_ID, iModel_ID)
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    dtAqlOba = _objVivint_ProduceBox.checkAqlObaTest(deviceId.ToString.TrimEnd(CChar(",")))
                ...
                If Not IsNothing(lstRegular) Then
                    ...
                    If strSN <> "" Then
                        For Each SN In lstRegular.Items
                            If strSN.Trim.ToUpper = SN.Trim.ToUpper Then
                                iMatch = 1
                                Exit For
                            End If
                        Next
        ...
        Private Sub cmdShip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdShip.Click
            ...
            Try
                ...
                _objBulkShip.iCust_ID = _objVivint.Vivint_CUSTOMER_ID
                _objBulkShip.strFilePath = "P:\Vivint\PackingSlip\" & iPallett_ID.ToString & "_" & String.Format("{0:yyyyMMdd_HHmmss}", DateTime.Now) & ".xls"
