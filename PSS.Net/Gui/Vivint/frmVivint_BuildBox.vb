...
Namespace Gui.VV
    Public Class frmVivint_BuildBox
        ...
        Private _objVivint_BuildBox As PSS.Data.Buisness.VV.Vivint_BuildBox
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objVivint_BuildBox = New PSS.Data.Buisness.VV.Vivint_BuildBox()
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objVivint_BuildBox = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVivint_BuildBox))
            ...
            Me.lblScreenName.TabIndex = 140
            Me.lblScreenName.Text = "VIVINT BUILD SHIP BOX"
            ...
            Me.pnlShipType.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnReset, Me.cboModel, Me.Label4, Me.cboBoxTypes, Me.Label2, Me.cboLocation, Me.Button5, Me.btnCreateBoxID, Me.Label1})
            ...
            Me.cboBoxTypes.Location = New System.Drawing.Point(120, 80)
            ...
            Me.btnCreateBoxID.Location = New System.Drawing.Point(144, 136)
            ...
            Me.panelPallet.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblOEMCustomerClass, Me.txtDevSN, Me.Label10, Me.btnCloseBox, Me.btnRemoveAllSNs, Me.btnRemoveSN, Me.lstDevices, Me.lblCount, Me.Label3, Me.lblBoxName, Me.btnFillBoxWithWHBox, Me.lblBERReason})
            ...
            Me.Name = "frmVivint_BuildBox"
            Me.Text = "frmVivint_BuildBox"
...
#End Region
        ...
        Private Sub frmVivint_BuildBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                dtLoc = Me._objVivint_BuildBox.GetVivintLocations(Me._iCust_ID, True)
                ...
                dtModel = Me._objVivint_BuildBox.GetVivintModels(Me._iCust_ID, True)
                Dim ir As Integer = dtModel.Rows.Count
                Misc.PopulateC1DropDownList(Me.cboModel, dtModel, "Model_Desc", "Model_id")
                If dtModel.Rows.Count = 2 Then
                    iModel_ID = dtModel.Rows(0).Item("Model_Desc")
                    Me.cboModel.SelectedValue = iModel_ID
                Else
                    Me.cboModel.SelectedValue = 0
                End If

                dtType = Me._objVivint_BuildBox.GetVivintShipBoxTypes(True)
        ...
        Private Sub PopulateOpenBoxs(Optional ByVal iPallettID As Integer = 0)
            ...
            Try
                ...
                Me.panelPallet.Visible = False
                Me.btnCreateBoxID.Visible = False
                dt = Me._objVivint_BuildBox.GetVivintpenPallets(Me._iCust_ID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                If IsNothing(Me.cboLocation.SelectedValue) OrElse Me.cboLocation.SelectedValue = 0 Then
                    MessageBox.Show("Please select Vivint location.", "Create Box ID", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.cboLocation.Focus()
                ...
                Else
                    ...
                    Me._iPallett_ID = Me._objVivint_BuildBox.CreateBoxID(Me.cboModel.SelectedValue, Me.cboBoxTypes.SelectedValue, _
        ...
        Private Sub btnReopenBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReopenBox.Click
            ...
            Try
                ...
                dt = Me._objVivint_BuildBox.GetVivintPallettData(strPallet, Me._iCust_ID)
                ...
                Else
                    i = Me._objVivint_BuildBox.ReopenVivintBoxByResetting(dt.Rows(0)("Pallett_ID"), strCurrentStation)
                    If i = 0 Then
        ...
        Private Sub cboModel_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboModel.SelectedValueChanged
            ...
            '    dtModel1 = Me._objVivint_BuildBox.GetVivintModels(Me._iCust_ID, True)
        ...
        Private Sub RefreshSNList()
            ...
            Try
                ...
                dt1 = Me._objVivint_BuildBox.GetAllSNsForPallet(iPallet_ID)
                ...
                If dt1.Rows.Count > 0 Then
                    strOEMCustomerClass = Me._objVivint_BuildBox.GetOEMCustomerClass(dt1.Rows(0).Item("Device_ID"), Me._iCust_ID, dt1.Rows(0).Item("Loc_ID"))
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                ...
                If Me._iCust_ID > 0 AndAlso strSN.Length > 0 Then
                    Dim objVivint As New PSS.Data.Buisness.VV.Vivint()
                    strSN = objVivint.RemovePrefixSN(strSN, Me._iCust_ID)
                    objVivint = Nothing
                End If
                ...
                If iDeviceID > 0 Then
                    ...
                    i = Me._objVivint_BuildBox.RemoveSNfromPallet(CInt(Me.dbgPallets.Columns("Pallett_id").Value), iDeviceID)
                    If i = 0 Then
        ...
        Private Sub txtDevSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDevSN.KeyUp
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtDevSN.Text.Trim.Length > 0 Then Me.ProcessVivintSN()
                End If
            Catch ex As Exception
        ...
        Private Sub ProcessVivintSN()
            Dim i As Integer = 0
            Dim strSN As String = ""
            Dim dtDevice, dtBill, dtFQA, dtRF, dtFlash, dtPretest As DataTable
            Dim dtKitting As New DataTable()
            ...
            Dim strOEMCustomerClass As String = ""
            Dim po, Model, Item_sku As String
            Dim dtImeiInfo As DataTable
            Dim bIsSeedstock
            Try

                strSN = Me.txtDevSN.Text.Trim.ToUpper
                '************************
                'Validations
                If CInt(Me.dbgPallets.Columns("Pallett_ID").Value) = 0 Then
                    Throw New Exception("Box Name is not selected.")
                ...
                If Me._iCust_ID > 0 Then
                    Dim objVivint As New PSS.Data.Buisness.VV.Vivint()
                    Me.txtDevSN.Text = objVivint.RemovePrefixSN(strSN, Me._iCust_ID)
                    strSN = Me.txtDevSN.Text.Trim
                    objVivint = Nothing
                End If
                ...
                For Each dView In Me.lstDevices.Items
                    ...
                    End If
                Next
                If Me.lstDevices.Items.Count > _objVivint.getMaxBuildBoxQty Then
                    Throw New Exception("Box can't contain more than " & _objVivint.getMaxBuildBoxQty & "  units.")
                End If
                ...
                End If
                i = 0
                dtDevice = Me._objVivint_BuildBox.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, CInt(Me.dbgPallets.Columns("Loc_ID").Value))
                ...
                ElseIf dtDevice.Rows.Count = 0 Then
                    ...
                    Exit Sub
                Else '1 row
                    Dim isBER As Boolean = False
                    Dim isSCR As Boolean = False
                    Dim isRTV As Boolean = False
                    iDevice_ID = dtDevice.Rows(0).Item("Device_ID")
                    dtBill = Me._objVivint_BuildBox.GetDeviceBillData(iDevice_ID)

                    'RTV devices don't need FQA and Kitting
                    dtPretest = Me._objVivint_BuildBox.GetDevicePretest(iDevice_ID)
                    ...
                    If Me.cboBoxTypes.SelectedValue = 1 Then
                        Dim row As DataRow, isBERBillCode As Boolean = False
                        For Each row In dtBill.Rows
                            If Convert.ToInt16(row("BillCode_ID")) = 4614 Then
                                isBER = True
                                isBERBillCode = True : Exit For
                            End If
                        Next
                        If Not isBERBillCode Then
                            ...
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        ElseIf isBERBillCode AndAlso Not dtBill.Rows.Count = 1 Then
                    ...
                    If Me.cboBoxTypes.SelectedValue = 2 Then
                        Dim row As DataRow, isRTVBillCode As Boolean = False
                        For Each row In dtBill.Rows
                            If (Me._objVivint_BuildBox.GetVivint_RTV_BILLCODEID(Convert.ToInt16(row("BillCode_ID")))) Then
                                isRTV = True
                                isRTVBillCode = True : Exit For
                            End If
                        Next
                        If Not isRTVBillCode Then
                            MessageBox.Show("The device is not RTV type.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        ElseIf isRTVBillCode AndAlso Not dtBill.Rows.Count = 1 Then
                            MessageBox.Show("The device is RTV type, but has other bill codes. See IT.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        End If
                    End If
                    ...
                    If Me.cboBoxTypes.SelectedValue = 3 Then
                        Dim row, scrapRow As DataRow, isSCRBillCode As Boolean = False
                        Dim dtScrapBillCode As DataTable = Me._objVivint_BuildBox.GetVivintScrapBillCode
                        For Each row In dtBill.Rows
                            Dim iBillcode_ID As Integer = Convert.ToInt32(row("BillCode_ID"))
                            For Each scrapRow In dtScrapBillCode.Rows
                                If Convert.ToInt32(scrapRow("BillCode_ID")) = iBillcode_ID Then
                                    isSCR = True
                                    isSCRBillCode = True : Exit For

                                End If
                            Next
                        Next
                        If Not isSCRBillCode Then
                            MessageBox.Show("The device is not SCRAP type.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        ElseIf isSCRBillCode AndAlso Not dtBill.Rows.Count = 1 Then
                            MessageBox.Show("The device is SCRAP type, but has other bill codes. See IT.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        End If
                    End If

                    If Me.cboBoxTypes.SelectedValue = 0 And (Not isSCR Or Not isBER) Then
                        Dim row, scrapRow As DataRow, isRURBillCode As Boolean = False
                        Dim isSCRBillCode As Boolean = False
                        For Each row In dtBill.Rows
                            ' added by Bonke
                            '----------------------------------------------
                            Dim dtScrapBillCode As DataTable = Me._objVivint_BuildBox.GetVivintScrapBillCode
                            ...
                            '-----------------------------------------------
                            If (Me._objVivint_BuildBox.GetVivint_RTV_BILLCODEID(Convert.ToInt16(row("BillCode_ID")))) Then
                                MessageBox.Show("he device belongs to RTV type but the pallet is REF.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                Exit Sub
                            ElseIf isSCRBillCode Then
                                MessageBox.Show("The device belongs to SCRAP type ,but the pallet is REF.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                Exit Sub
                            ElseIf Convert.ToInt16(row("BillCode_ID")) = 4614 Then
                                MessageBox.Show("he device belongs to BER type but the pallet is REF.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                Exit Sub
                            End If
                        Next


                        dtFQA = Me._objVivint_BuildBox.GetDeviceFqaData(iDevice_ID)
                        'no FQA for RTV
                        ...
                        dtRF = Me._objVivint_BuildBox.GetDeviceRfTestData(strSN)
                        ...
                        'dtFlash = Me._objVivint_BuildBox.GetDeviceFlashTestData(strSN)
                        ...
                        'End If
                    End If
                    If Me.cboBoxTypes.SelectedValue = 2 AndAlso isRTV Then
                    Else

                        'dtKitting = Me._objVivint_BuildBox.CheckKitting(Me.txtDevSN.Text.Trim, CInt(Me.dbgPallets.Columns("Loc_ID").Value))
                        'If dtKitting.Rows.Count = 0 AndAlso dtBill.Rows.Count <> 0 AndAlso dtBill.Rows(0)("BillCode_ID") <> 4630 AndAlso cboBoxTypes.Text.Trim.ToUpper <> "BER" Then
                        '    MsgBox("The device Must pass the Kitting process . Please contact your Leader.", MsgBoxStyle.Information, "Information")
                        '    Me.txtDevSN.SelectAll()
                        '    Exit Sub
                        dtKitting = Me._objVivint_BuildBox.CheckKitting(Me.txtDevSN.Text.Trim, CInt(Me.dbgPallets.Columns("Loc_ID").Value))
                        'If dtKitting.Rows.Count = 0 AndAlso dtBill.Rows.Count <> 0 AndAlso dtBill.Rows(0)("BillCode_ID") <> 4630 _
                        '    AndAlso cboBoxTypes.Text.Trim.ToUpper <> "BER" Then
                        Dim bCode As Integer = dtBill.Rows(0)("BillCode_ID")
                        If dtKitting.Rows.Count = 0 AndAlso dtBill.Rows.Count <> 0 AndAlso _
                                dtBill.Rows(0)("BillCode_ID") <> _objVivint.CoolPad_SCR_BillCode_ID And Not _
                                (dtBill.Rows(0)("BillCode_ID") = _objVivint.CoolPad_BER_BillCode_ID Or _
                                dtBill.Rows(0)("BillCode_ID") = _objVivint.CoolPad_BER_Limit_BillCode_ID) Then
                            MsgBox("The device Must pass the Kitting process . Please contact your Leader.", MsgBoxStyle.Information, "Information")
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        End If
                    End If
                    Dim a As Integer = dtDevice.Rows(0).Item("Model_ID")
                    a = Me.cboModel.SelectedValue
                    ...
                    Else
                        ...
                        Me._objVivint_BuildBox.AssignDeviceToPallet(dtDevice.Rows(0)("Device_ID"), CInt(Me.dbgPallets.Columns("Pallett_ID").Value), strDateTime)
                        '***************************************************
            ...
            Catch ex As Exception
                MessageBox.Show("ProcessVivintSN: " & ex.Message, "Device Scan", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
                Me.txtDevSN.Text = ""
                Me.txtDevSN.Focus()
            Finally
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Dim strNextWrkStation As String = PSS.Data.Buisness.VV.Vivint.Vivint_BuildBox_WorkStation
            Dim iDeviceID As Integer = 0
            ...
            Try
                ...
                ElseIf Me.lstDevices.Items.Count > _objVivint.getMaxBuildBoxQty Then
                    MessageBox.Show("Box can't contain more than " & _objVivint.getMaxBuildBoxQty & " units.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Me.txtDevSN.Focus() : Exit Sub
                ...
                i = Me._objVivint_BuildBox.CloseVivintPallet(Me._iCust_ID, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _
                ...
                '************************
                If CInt(Me.dbgPallets.Columns("Loc_ID").Value) = PSS.Data.Buisness.VV.Vivint.Vivint_VRQA_Loc_ID _
                   AndAlso Me.cboLocation.SelectedValue = PSS.Data.Buisness.VV.Vivint.Vivint_VRQA_Loc_ID Then

                    Me._objVivint_BuildBox.PrintBoxLabel(CInt(Me.dbgPallets.Columns("Pallett_id").Value))
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                ...
                strPallet = strPallet.Trim
                dtTempClosepallet = Me._objVivint_BuildBox.CheckOpenPallet(strPallet)
                If dtTempClosepallet.Rows.Count <> 0 Then
                    sPalletId = dtTempClosepallet.Rows(0)("Pallett_id")
                    Me._objVivint_BuildBox.PrintBoxLabel(CInt(sPalletId))
                Else
