...
Namespace Gui.WingTech
    Public Class frmWingTech_BuildBox
        ...
        Private _objWingTech_BoxShip As PSS.Data.Buisness.WingTech.WingTech_BoxShip
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objWingTech_BoxShip = New PSS.Data.Buisness.WingTech.WingTech_BoxShip()
        End Sub
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objWingTech_BoxShip = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTech_BuildBox))
            ...
            Me.lblScreenName.Text = "WINGTECH BUILD SHIP BOX"
            ...
            Me.Name = "frmWingTech_BuildBox"
            Me.Text = "frmWingTech_BuildBox"
...
#End Region
        ...
        Private Sub frmWingTech_BuildBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Dim iModel_Name As String
            Try
                dtLoc = Me._objWingTech_BoxShip.GetWingTechLocations(Me._iCust_ID, True)
                ...
                dtModel = Me._objWingTech_BoxShip.GetWingTechModels(Me._iCust_ID, True)
                ...
                dtType = Me._objWingTech_BoxShip.GetWingTechShipBoxTypes(True)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                If IsNothing(Me.cboLocation.SelectedValue) OrElse Me.cboLocation.SelectedValue = 0 Then
                    MessageBox.Show("Please select WingTech location.", "Create Box ID", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.cboLocation.Focus()
                ...
                Else
                    ...
                    Me._iPallett_ID = Me._objWingTech_BoxShip.CreateBoxID(Me.cboModel.SelectedValue, Me.cboBoxTypes.SelectedValue, _
        ...
        Private Sub PopulateOpenBoxs(Optional ByVal iPallettID As Integer = 0)
            ...
            Try
                ...
                Me.panelPallet.Visible = False
                Me.btnCreateBoxID.Visible = False
                dt = Me._objWingTech_BoxShip.GetWingTechOpenPallets(Me._iCust_ID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnReopenBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReopenBox.Click
            ...
            Dim dt As DataTable
            Dim strCurrentStation As String = PSS.Data.Buisness.WingTech.WingTech.WingTech_ProduceBox_WorkStation
            ...
            Try
                ...
                dt = Me._objWingTech_BoxShip.GetCoopadPallettData(strPallet, Me._iCust_ID)
                ...
                Else
                    i = Me._objWingTech_BoxShip.ReopenWingTechBoxByResetting(dt.Rows(0)("Pallett_ID"), strCurrentStation)
                    If i = 0 Then
        ...
        Private Sub cboModel_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboModel.SelectedValueChanged
            ...
            Else
                ...
                dtModel1 = Me._objWingTech_BoxShip.GetWingTechModels(Me._iCust_ID, True)
        ...
        Private Sub RefreshSNList()
            ...
            Try
                ...
                dt1 = Me._objWingTech_BoxShip.GetAllSNsForPallet(iPallet_ID)
                ...
                If dt1.Rows.Count > 0 Then
                    Dim iOrderType As Integer = _objWingTech_BoxShip.GetOrderType(dt1.Rows(0).Item("Device_SN"), _iCust_ID)
                    strOEMCustomerClass = Me._objWingTech_BoxShip.GetOEMCustomerClass(dt1.Rows(0).Item("Device_ID"), Me._iCust_ID, dt1.Rows(0).Item("Loc_ID"), iOrderType)
        ...
        Private Sub ProcessWingTechSN()
            ...
            Try
                ...
                If Me._objWingTech_BoxShip.GetSwappedStatus(strSN.Trim.ToUpper, _iCust_ID) > 0 Then
                ...
                bIsSeedstock = False
                dtSeedstock = _objWingTech_BoxShip.GettDeviceBill(strIMEITemp)
                If dtSeedstock.Rows.Count = 0 Then
                    ...
                    Me.txtDevSN.Focus()
                    Exit Sub
                ElseIf _objWingTech_BoxShip.GetOrderType(strIMEITemp, _iCust_ID) = _objWingTech.WingTech_OrderTypeSeedStock_ID AndAlso dtSeedstock.Rows.Count = 1 AndAlso dtSeedstock.Rows(0)("BillCode_Id") = _objWingTech.WingTech_Swap_BillCode_ID Then
                ...
                If lPoNumber.Text <> "" Then
                    Dim iOrderType As Integer = _objWingTech_BoxShip.GetOrderType(Trim(txtDevSN.Text), _iCust_ID) 'get the order Type of the device
                    Dim iDeviceId As Integer = _objWingTech_BoxShip.GetDeviceId(Trim(txtDevSN.Text))
                    Dim dtPO2 As DataTable = _objWingTech_BoxShip.GetPoNumberByDeviceId(Trim(iDeviceId), iOrderType)
                    If dtPO2.Rows(0)("ClaimNo") <> lPoNumber.Text Then
                ...
                If Me.lstDevices.Items.Count > _objWingTech.getMaxBuildBoxQty Then
                    Throw New Exception("Box can't contain more than " & _objWingTech.getMaxBuildBoxQty & " units.")
                End If
                ...
                End If
                i = 0
                dtDevice = Me._objWingTech_BoxShip.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, CInt(Me.dbgPallets.Columns("Loc_ID").Value))
                ...
                Else '1 row
                    ...
                    If bIsSeedstock = False Then
                        ...
                        If Me.cboLocation.SelectedValue = PSS.Data.Buisness.WingTech.WingTech.WingTech_CP1_Loc_ID Then

                            Dim iOrderType As Integer = _objWingTech_BoxShip.GetOrderType(Me.txtDevSN.Text.Trim(), _iCust_ID)
                            strOEMCustomerClass = Me._objWingTech_BoxShip.GetOEMCustomerClass(iDevice_ID, Me._iCust_ID, Me.cboLocation.SelectedValue, iOrderType)
                        ...
                        dtBill = Me._objWingTech_BoxShip.GetDeviceBillData(iDevice_ID)
                        ...
                        If Me.cboBoxTypes.SelectedValue = 1 Then
                            ...
                            For Each row In dtBill.Rows
                                If Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_BER_BillCode_ID Then
                        ...
                        If Me.cboBoxTypes.SelectedValue = 2 Then
                            ...
                            For Each row In dtBill.Rows
                                If Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID Or Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID2 Then
                        ...
                        If Me.cboBoxTypes.SelectedValue = 0 Then
                            ...
                            For Each row In dtBill.Rows
                                If Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID Or Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID2 Then
                                    ...
                                    Exit Sub
                                ElseIf Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.WingTech.WingTech.WingTech_BER_BillCode_ID Then
                            ...
                            dtFQA = Me._objWingTech_BoxShip.GetDeviceFqaData(iDevice_ID)
                            ...
                            ElseIf dtFQA.Rows(0).IsNull("QCResult_ID") OrElse Not dtFQA.Rows(0).Item("QCResult_ID") = 1 Then
                                ...
                                Exit Sub
                            End If
                            dtRF = Me._objWingTech_BoxShip.GetDeviceRfTestData(strSN)
                            ...
                            dtFlashManual = Me._objWingTech_BoxShip.GetDeviceFlashManual(strSN)
                            ...
                            dtFlash = Me._objWingTech_BoxShip.GetDeviceFlashTestData(strSN)
                            ...
                            dtSoftVersion = Me._objWingTech_BoxShip.GetSoftVersion(dtDevice.Rows(0).Item("Model_ID"), Me._iCust_ID)
                    ...
                    Dim iDeviceId As Integer = _objWingTech_BoxShip.GetDeviceId(Me.txtDevSN.Text.Trim())
                    Dim dtModel As DataTable = _objWingTech_BoxShip.GetModelSeedStock(iDeviceId)
                    ...
                    Else
                        ...
                        Me._objWingTech_BoxShip.AssignDeviceToPallet(dtDevice.Rows(0)("Device_ID"), CInt(Me.dbgPallets.Columns("Pallett_ID").Value), strDateTime)
                        '***************************************************
        ...
        Private Sub txtDevSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDevSN.KeyUp
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtDevSN.Text.Trim.Length > 0 Then Me.ProcessWingTechSN()
                End If
            Catch ex As Exception
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                ...
                If iDeviceID > 0 Then
                    ...
                    i = Me._objWingTech_BoxShip.RemoveSNfromPallet(CInt(Me.dbgPallets.Columns("Pallett_id").Value), iDeviceID)
                    If i = 0 Then
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Dim strNextWrkStation As String = PSS.Data.Buisness.WingTech.WingTech.WingTech_BuildBox_WorkStation
            Dim iDeviceID As Integer = 0
            ...
            Try
                ...
                ElseIf Me.lstDevices.Items.Count > _objWingTech.getMaxBuildBoxQty Then
                    MessageBox.Show("Box can't contain more than " & _objWingTech.getMaxBuildBoxQty & " units.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Me.txtDevSN.Focus() : Exit Sub
                ...
                i = Me._objWingTech_BoxShip.CloseWingTechPallet(Me._iCust_ID, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _
                ...
                '************************
                If CInt(Me.dbgPallets.Columns("Loc_ID").Value) = PSS.Data.Buisness.WingTech.WingTech.WingTech_CP1_Loc_ID _
                   AndAlso Me.cboLocation.SelectedValue = PSS.Data.Buisness.WingTech.WingTech.WingTech_CP1_Loc_ID Then

                    Me._objWingTech_BoxShip.PrintBoxLabel(CInt(Me.dbgPallets.Columns("Pallett_id").Value))
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                ...
                strPallet = strPallet.Trim
                dtTempClosepallet = Me._objWingTech_BoxShip.CheckOpenPallet(strPallet)
                If dtTempClosepallet.Rows.Count <> 0 Then
                    sPalletId = dtTempClosepallet.Rows(0)("Pallett_id")
                    Me._objWingTech_BoxShip.PrintBoxLabel(CInt(sPalletId))
        ...
        Private Sub DisplayPoNumber()
            ...
            For j = 0 To lstDevices.Items.Count - 1
                Dim iOrderType As Integer = _objWingTech_BoxShip.GetOrderType(Me.lstDevices.Items.Item(j)("Device_SN").ToString.Trim, _iCust_ID)
                Dim iDeviceId As Integer = _objWingTech_BoxShip.GetDeviceId(Me.lstDevices.Items.Item(j)("Device_SN").ToString.Trim)
                Dim dtPO As DataTable = _objWingTech_BoxShip.GetPoNumberByDeviceId(iDeviceId, iOrderType)
