...
Namespace Gui.WingTech
    Public Class frmWingTech_Swap
        ...
        Private _objWingTech_Swap As PSS.Data.Buisness.WingTech.WingTech_Swap
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objWingTech_Swap = New PSS.Data.Buisness.WingTech.WingTech_Swap()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTech_Swap))
            ...
            Me.Name = "frmWingTech_Swap"
            Me.Text = "frmWingTech_Swap"
...
#End Region
        ...
        Private Sub frmWingTech_Swap_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtSwappedSN.Text.Trim.Length > 0 Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeBulk_ID)
                    ElseIf Me.txtSwappedSN.Text.Trim.Length > 0 AndAlso Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeBulk_ID)
                    End If
                End If
            Catch ex As Exception
        ...
        Private Sub txtSeedStockSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSeedStockSN.KeyUp
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtSwappedSN.Text.Trim.Length > 0 AndAlso Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeSeedStock_ID)
                    ElseIf Me.txtSwappedSN.Text.Trim.Length > 0 AndAlso Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeSeedStock_ID)
                    End If
                End If
        ...
        Private Sub ProcessSN(ByVal iSN_Type As Integer)
            ...
            Try
                If iSN_Type = PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeBulk_ID Then
                    Me.txtSeedStockSN.Enabled = False
                    ...
                    Me._dtBulk = Me._objWingTech_Swap.getDeviceData(Me._iCust_ID, Me.cboLocation.SelectedValue, strSN, iSN_Type, "")
                    ...
                    Else '=1
                        ...
                        dtBill = Me._objWingTech_Swap.getDeviceBillData(iBulk_Device_ID)
                        ...
                        End If
                    End If
                ElseIf iSN_Type = PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeSeedStock_ID Then
                    strSN = Me.txtSeedStockSN.Text.Trim
                    Dim strWiKoCricketOrATT As String = ""
                    Dim iLoc_ID As Integer = 0

                    If Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                        iLoc_ID = Convert.ToInt32(Me._dtBulk.Rows(0).Item("Loc_ID"))
                        If iLoc_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_Loc_ID Then
                            strWiKoCricketOrATT = PSS.Data.Buisness.WingTech.WingTech.WingTech_DeviceSwap_WorkStation.Trim
                        Else
                            MessageBox.Show("Can't determine WINGTECH Location. See IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            Me.txtSeedStockSN.SelectAll() : Me.txtSeedStockSN.Focus() : Exit Sub
                        End If
                    End If

                    dtSeedStock = Me._objWingTech_Swap.getDeviceData(Me._iCust_ID, Me.cboLocation.SelectedValue, strSN, iSN_Type, strWiKoCricketOrATT)
                    ...
                    Else '=1
                        ...
                        If Me._objWingTech_Swap.Has_Swap_Bill_Code(iSeeStock_Device_ID, PSS.Data.Buisness.WingTech.WingTech.WingTech_Swap_BillCode_ID) Then
                        ...
                        If Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID _
                           AndAlso (Me._iModel_ID = 5312 OrElse Me._iModel_ID = 5297) _
                           AndAlso (Convert.ToInt32(dtSeedStock.Rows(0).Item("Model_ID")) = 5312 OrElse Convert.ToInt32(dtSeedStock.Rows(0).Item("Model_ID")) = 5297) Then
                        ...
                        If Me._dtBulk.Rows.Count = 1 AndAlso dtSeedStock.Rows.Count = 1 Then
                            ...
                            If Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                                iLaborLevel = PSS.Data.Buisness.WingTech.WingTech.WingTech_Swap_LabelLevel
                                iPrcGroup_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_PrcGroup_ID
                                iPsPRice_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_Swap_PSPrice_ID
                                iSwap_BillCode_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_Swap_BillCode_ID
                                strWorkStation = PSS.Data.Buisness.WingTech.WingTech.WingTech_DeviceSwap_WorkStation
                            Else
                            ...
                            If MsgBox("Do you want to swap it now?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                'get labor charge
                                dtTmp = Me._objWingTech_Swap.getLaborChargeData(iLaborLevel, iPrcGroup_ID)
                                ...
                                End If
                                'Get part number
                                dtTmp = Me._objWingTech_Swap.getPartNumberData(iPsPRice_ID)
                                If Not dtTmp.Rows.Count > 0 Then
                                ...
                                'Update
                                k = Me._objWingTech_Swap.UpdateSwappedData(iSeeStock_Device_ID, iBulk_Device_ID, iSwap_BillCode_ID, strPartNum, Me._iUserID, strDateTime, _
        ...
        Private Sub CheckSwapDevice(ByVal dt As DataTable, ByVal dtBill As DataTable, ByRef strMsg As String, ByRef bIsNormalRepairedDevice As Boolean)
            ...
            If Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then 'CoolPad ===============================================================================
                foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTech.WingTech.WingTech_BER_BillCode_ID) 'BER
                If foundRows.Length > 0 Then
                    strMsg = "" : Exit Sub
                Else
                    foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID) 'RUR Physical Abuse
                    If foundRows.Length > 0 Then
                    ...
                    Else
                        foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTech.WingTech.WingTech_RUR_BillCode_ID2) 'RUR Liquid Damage
                        If foundRows.Length > 0 Then
                    ...
                    End If
                End If
            ElseIf Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID AndAlso iLoc_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_Loc_ID Then 'Wingtech =====
                ...
                End If
            ElseIf Me._iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID AndAlso (iLoc_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_Loc_ID) Then
