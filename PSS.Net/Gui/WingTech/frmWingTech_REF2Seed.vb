...
Namespace Gui.WingTech
    Public Class frmWingTech_REF2Seed
        ...
        Private _objWingTech_REF2Seed As PSS.Data.Buisness.WingTech.WingTech_REF2Seed
        Private _objWingTech_Recv As PSS.Data.Buisness.WingTech.WingTech_Receiving
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCust_ID As Integer, ByVal strScreenName As String)
            ...
            Me._objWingTech_REF2Seed = New PSS.Data.Buisness.WingTech.WingTech_REF2Seed()
            Me._objWingTech_Recv = New PSS.Data.Buisness.WingTech.WingTech_Receiving()
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objWingTech_REF2Seed = Nothing
                    Me._objWingTech_Recv = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTech_REF2Seed))
            ...
            Me.cboCustomer.Location = New System.Drawing.Point(88, 16)
            ...
            Me.lblLocation.Location = New System.Drawing.Point(8, 40)
            ...
            Me.cboLocation.Location = New System.Drawing.Point(88, 40)
            ...
            Me.tdgData1.Location = New System.Drawing.Point(16, 144)
            ...
            Me.lblModel.Location = New System.Drawing.Point(24, 72)
            Me.lblModel.Name = "lblModel"
            Me.lblModel.Size = New System.Drawing.Size(56, 21)
            Me.lblModel.TabIndex = 179
            ...
            Me.cboModel.Location = New System.Drawing.Point(88, 72)
            ...
            Me.btnLoadData.Location = New System.Drawing.Point(16, 104)
            Me.btnLoadData.Name = "btnLoadData"
            Me.btnLoadData.Size = New System.Drawing.Size(112, 32)
            Me.btnLoadData.TabIndex = 180
            ...
            Me.cboASN_In_Sku.Images.Add(CType(resources.GetObject("resource.Images4"), System.Drawing.Bitmap))
            ...
            Me.lblRecNum.Location = New System.Drawing.Point(16, 680)
            Me.lblRecNum.Name = "lblRecNum"
            Me.lblRecNum.Size = New System.Drawing.Size(224, 24)
            Me.lblRecNum.TabIndex = 187
            Me.lblRecNum.Text = "0"
            '
            'frmWIKO_REF2Seed
            '
            ...
            Me.Name = "frmWIKO_REF2Seed"
            Me.Text = "frmWingTech_REF2Seed"
...
#End Region
        ...
        Private Sub frmWingTech_REF2Seed_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                If Me._iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    ...
                    'Loc info
                    dtLoc = Me._objWingTech_BoxShip.GetWingTechLocations(Me._iMenuCustID, True)
                    ...
                    'Model
                    dtModel = Me._objWingTech_Recv.getModelData(PSS.Data.Buisness.WingTech.WingTech.WingTech_Product_ID, Me._iMenuCustID, Me.cboLocation.SelectedValue)
                    ' dtModel = Me._objWingTech.getWIKOModels(Me._iMenuCustID, True)
                    Misc.PopulateC1DropDownList(Me.cboModel, dtModel, "Model_Desc", "Model_ID")
                    Me.cboModel.SelectedValue = 0

                    'ElseIf Me._iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    '    Me.pnlCoolPadModel.Visible = True

                    '    'Loc info Coolpad is the same LOC sql as WIKO
                    '    dtLoc = Me._objWingTech_BoxShip.GetWingTechLocations(Me._iMenuCustID, True)
                    '    Misc.PopulateC1DropDownList(Me.cboLocation, dtLoc, "Loc_Name", "Loc_ID")
                    '    If dtLoc.Rows.Count = 2 Then
                    '        iLoc_ID = dtLoc.Rows(0).Item("Loc_ID")
                    ...
                    '    dtSKU = Me._objWingTech_Recv.getModelData(PSS.Data.Buisness.WingTech.WingTech.WingTech_Product_ID, Me._iMenuCustID, Me.cboLocation.SelectedValue)

                    '    Misc.PopulateC1DropDownList(Me.cboASN_In_Sku, dtSKU, "ASN_IN_SKU", "Model_ID")
        ...
        Private Sub cboLocation_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboLocation.SelectedValueChanged
            ...
            Try
                If Me._iMenuCustID <> PSS.Data.Buisness.WingTech.WingTech.WingTech_Product_ID Then Exit Sub
        ...
        Private Sub btnLoadData_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLoadData.Click
            ...
            Try
                ...
                If Me._iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    Me._dt = Me._objWingTech_REF2Seed.GetREF2SeedstockData(Me._iMenuCustID, Me.cboLocation.SelectedValue, Me.cboModel.SelectedValue)
                Else
                    Exit Sub
                End If
        ...
        Private Sub btnMoveREF2Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMoveREF2Seed.Click
            ...
            Dim strTrayMemo As String = "Wiko REF2Seed Receiving"
            ...
            Try
                ...
                With Me.tdgData1
                    For Each iRow In .SelectedRows
                        ...
                        Else
                            If Not Me._objWingTech_REF2Seed.IsAlreadyUnusedSeedstockDevice(Me._iMenuCustID, .Columns("SN").CellText(iRow).ToString.Trim) Then
                ...
                If strDevice_IDs.Trim.Length > 0 Then
                    'getWorkOrderID
                    iWO_ID = Me._objWingTech_REF2Seed.GetWorkOrderID(Me._iMenuCustID, iLoc_ID)

                    If Not iWO_ID > 0 Then MessageBox.Show("Invalid WO_ID.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning) : Exit Sub

                    dt = Me._objWingTech_REF2Seed.ProcessREF2Seedstock(Me._iMenuCustID, iLoc_ID, iWO_ID, strDevice_IDs, strDevice_SNs)
                    ...
                    iTray_ID = Me._objWingTech_Recv.getTayID(Me._iUserID, Me._strUser, iWO_ID, strTrayMemo)
                    strRecvBoxName = Me._objWingTech_Recv.CreateWarehouseBoxName(iModel_ID, iWrtyFlag, iWB_ID, "WK")

                    For Each row In dt.Rows
                        strSN = row("SerialNo") : iEW_ID = row("EW_ID")
                        strManufDate = Me._objWingTech_REF2Seed.GetManufDate(strSN, strDevice_IDs)

                        If Me._iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                            bReceived = Me._objWingTech_Recv.ReceiveDataIntoSystem(iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
