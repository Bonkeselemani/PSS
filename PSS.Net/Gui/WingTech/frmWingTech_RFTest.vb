...
Namespace Gui.WingTech
    Public Class frmWingTech_RFTest
        Inherits System.Windows.Forms.Form

        Private _strScreenName As String = ""
        Private _iMenuCustID As Integer = 0
        Private _iTestTypeID As Integer = 0
        Private _objRF As PSS.Data.Buisness.WingTech.WingTech_RFTest
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strSreenname As String, ByVal iCustID As Integer, ByVal iTestTypeID As Integer)
            ...
            _objRF = New PSS.Data.Buisness.WingTech.WingTech_RFTest()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTech_RFTest))
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblDateCode, Me.btnFail, Me.Label3, Me.Panel2, Me.Panel3, Me.btnManuallyAddRec, Me.lblDevRepType, Me.lblWrtyStatus, Me.btnSave, Me.pnlFailCodes, Me.Panel1, Me.btnPass, Me.btnClear})
            Me.Name = "frmWingTech_RFTest"
            Me.Text = "frmWingTech_RFTest"
...
#End Region
        ...
        Private Sub frmWingTech_RFTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim i As Integer = 0
...
loadproduct:    dt = Generic.GetProductByCustID(True, Me._iMenuCustID)
        ...
        Private Sub PassTest()
            ...
            If _iMenuCustID = PSS.Data.Buisness.TracFone.BuildShipPallet.TracFone_CUSTOMER_ID Then
                SaveTestInfo()
            Else
        ...
        Private Sub ProcessSN()
            ...
            Try
                ...
                'Check FQA Result FOR WIKO AND COOLPAD and WingTech
                If _iMenuCustID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID Or _iMenuCustID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Or _iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                ...
                If dt1.Rows.Count = 1 Then
                    '******************************************
                    ' WingTech only: check current station
                    '******************************************
        ...
        Private Sub SetHistoryGridLayout(ByRef grdCtrl As C1.Win.C1TrueDBGrid.C1TrueDBGrid, _
            ...
            End With
        End Sub
        Private Sub SaveTestInfoCoolpadWiko()
            Try
                If Me.cboProduct.SelectedValue = 0 Then
                    MsgBox("Please select product.", MsgBoxStyle.Critical, "Load Pretest Codes")
                ElseIf Me._iDevice_ID = 0 Then
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._objRF.InsertRFWikoCoolpad(PSS.Core.Global.ApplicationUser.IDuser, Me.lblSN.Text, _iRFResult) Then
                            Me.LoadTestHistory(Me._iDevice_ID)
                        Else
                        End If
                        Me.txtDeviceSN.SelectAll()
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._iMenuCustID = PSS.Data.Buisness.TracFone.BuildShipPallet.TracFone_CUSTOMER_ID Then
                            ...
                            objTFMis = Nothing
                            '***********************************************
                            'Get and assign unit to workstation for wingtech
                            '***********************************************
