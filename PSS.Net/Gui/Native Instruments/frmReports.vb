...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents rbtStandard As System.Windows.Forms.RadioButton
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.gbReportName.Location = New System.Drawing.Point(72, 72)
            ...
            Me.gbDate.Location = New System.Drawing.Point(72, 128)
            ...
            Me.btnRunRpt.Location = New System.Drawing.Point(72, 280)
            Me.btnRunRpt.Name = "btnRunRpt"
            Me.btnRunRpt.Size = New System.Drawing.Size(400, 32)
            Me.btnRunRpt.TabIndex = 18
            '
            'gbWorkOrder
            '
            ...
            Me.gbWorkOrder.Location = New System.Drawing.Point(72, 224)
            Me.gbWorkOrder.Name = "gbWorkOrder"
            Me.gbWorkOrder.Size = New System.Drawing.Size(400, 48)
            Me.gbWorkOrder.TabIndex = 19
            ...
            Me.lblTitle.Size = New System.Drawing.Size(544, 32)
            Me.lblTitle.TabIndex = 21
            Me.lblTitle.Text = "Native Instruments Report"
            '
            'grpRptType
            '
            Me.grpRptType.Controls.AddRange(New System.Windows.Forms.Control() {Me.rbtSummaryDetails, Me.rbtStandard})
            ...
            Me.grpRptType.Location = New System.Drawing.Point(72, 336)
            Me.grpRptType.Name = "grpRptType"
            Me.grpRptType.Size = New System.Drawing.Size(400, 48)
            Me.grpRptType.TabIndex = 22
            ...
            'rbtStandard
            '
            Me.rbtStandard.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Me.rbtStandard.ForeColor = System.Drawing.Color.Black
            Me.rbtStandard.Location = New System.Drawing.Point(32, 16)
            Me.rbtStandard.Name = "rbtStandard"
            Me.rbtStandard.Size = New System.Drawing.Size(88, 24)
            Me.rbtStandard.TabIndex = 0
            Me.rbtStandard.Text = "Standard"
            '
            'frmReports
            '
...
#End Region
        ...
        Private Sub frmReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                ...
                Next
                'Me.cboReportName.Items.Add("EDI RMA Status")
        ...
        Private Sub cboReportName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboReportName.TextChanged
            ...
            Try
                If Me.cboReportName.Text <> "Select Report Name" Then
                    ...
                    If Me._strRptName = Me.ReportNames.EDI_RMA_Status.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.Receipt.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.Shipment.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.Production_Completed.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = "Need Part(s)" Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.Part_Reclamation.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.Pre_Test_Report.ToString Then
                        Me.gbDate.Visible = True
                    ElseIf Me._strRptName = Me.ReportNames.AQL_Report.ToString Then
                        Me.gbDate.Visible = True
                    ...
                    ElseIf Me._strRptName = Me.ReportNames.Invoice_Report.ToString Then
                        Me.gbDate.Visible = True
        ...
        Private Sub btnRunRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRunRpt.Click
            Dim objNIRpt As PSS.Data.Buisness.NIReports
            ...
            Try
                ...
                Else
                    ...
                    'Generate Report
                    '*************************************
                    objNIRpt = New PSS.Data.Buisness.NIReports()
                    If Me._strRptName = Me.ReportNames.EDI_RMA_Status.ToString Then
                        i = objNIRpt.CreateEDI_RAM_Status(_iMenuCust, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Receipt.ToString Then
                        i = objNIRpt.CreateReceiptReport(NI.LOCID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Shipment.ToString Then
                        i = objNIRpt.CreateShipmentReport(NI.CUSTOMERID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.WIP_Report.ToString Then
                        i = objNIRpt.CreateWIPReport(NI.LOCID, Me._strRptName)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Production_Completed.ToString Then
                        i = objNIRpt.CreateProdCompletedReport(NI.LOCID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Inventory.ToString Then
                        i = objNIRpt.CreateInventoryReport(NI.CUSTOMERID, Me._strRptName)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Part_Reclamation.ToString Then
                        Dim objTFRpt = New PSS.Data.Buisness.TracFone.Reports()
                        i = objTFRpt.RunPartReClaimRpt(PSS.Data.Buisness.NI.LOCID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Pre_Test_Report.ToString Then
                        i = objNIRpt.CreatePreTestReport(NI.LOCID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.AQL_Report.ToString Then
                        i = objNIRpt.CreateAQLTestReport(NI.LOCID, Me._strRptName, strDateStart, strDateEnd)
                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ElseIf Me._strRptName = Me.ReportNames.Invoice_Report.ToString Then
                        dStartDate = CDate(strDateStart)
                        If dStartDate >= Me._NewPriceStartingDate Then
                            Dim strRptName_Part1, strRptName_Part2 As String
                            If strDateStart = strDateEnd Then
                                strRptName_Part2 = strDateStart.Replace("-", "")
                            Else
                                strRptName_Part2 = strDateStart.Replace("-", "") & "-" & strDateEnd.Replace("-", "")
                            End If
                            If Me.rbtSummaryDetails.Checked Then
                                strRptName_Part1 = "NI_Invoice_(Details)_"
                                i = objNIRpt.CreateInvoiceReport(PSS.Data.Buisness.NI.CUSTOMERID, PSS.Data.Buisness.NI.LOCID, _
                                                                strRptName_Part1 & strRptName_Part2, strDateStart, strDateEnd, True)
                            ElseIf Me.rbtStandard.Checked Then
                                strRptName_Part1 = "NI_Invoice_"
                                i = objNIRpt.CreateInvoiceReport(PSS.Data.Buisness.NI.CUSTOMERID, PSS.Data.Buisness.NI.LOCID, _
                                                                 strRptName_Part1 & strRptName_Part2, strDateStart, strDateEnd, False)
                            Else
                                MessageBox.Show("Please select a report type.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                            End If
                        Else
                            MessageBox.Show("Starting date must be greater than " & (Format(Me._NewPriceStartingDate.AddDays(-1), "MM/dd/yyyy")).ToString, "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                        End If
                        Else
        ...
        '***********************************************************************
        Private Sub rbtStandard_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rbtStandard.CheckedChanged
            Try
                If Me.rbtStandard.Checked Then
                    Me.rbtStandard.ForeColor = Color.MediumBlue
                Else
                    Me.rbtStandard.ForeColor = Color.Black
                End If
            Catch ex As Exception
            End Try
