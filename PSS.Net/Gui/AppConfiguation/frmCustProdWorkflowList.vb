Public Class frmCustProdWorkflowList
...
#Region " Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.Text = "Customer Product Workflow List"
	End Sub

#End Region
#Region "METHOD OVERRIDES"
	Protected Overrides Sub GetGridData()
		Dim mobjitems As New Data.BOL.tcustomer_prod_workflowCollection()
		Dim dt As New DataTable()
		dt = mobjitems.tcustomer_prod_workflowDataTable
		dt.TableName = "tCustProdWorkflow"
		dtItems = dt
	End Sub
	...
	Protected Overrides Sub EditRecord()
		...
		Catch ex As Exception
			MessageBox.Show(ex.Message, "New Workflow", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
		End Try
	End Sub
