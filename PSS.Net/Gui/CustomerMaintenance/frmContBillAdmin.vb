...
#Region "Data acquisition for controls "
        ...
        Private Sub getCustomer()
            Dim dtCustomer As DataTable = cCellModelFactor.getDataTable("SELECT tlocation.loc_id, cust_name1 FROM tcustomer inner join tlocation on tcustomer.cust_id = tlocation.cust_id AND loc_id in ( 442, 2766, 2946, 2062, 3340 ) ORDER BY cust_name1")
