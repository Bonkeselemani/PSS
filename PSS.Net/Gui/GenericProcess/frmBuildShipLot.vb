...
Namespace Gui.GenericProcess
    Public Class frmBuildShipLot
        ...
        Private _iMenuRepTypeID As Integer = 0
        Private _iMenuLotTypeID As Integer = 0
        Private _bMenuMixModel As Boolean = False
        Private _bMenuCreateExcelManifest As Boolean = True
        Private _bAllowToRemoveUnitFromList As Boolean = True
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(Optional ByVal iProdID As Integer = 0, Optional ByVal iCustID As Integer = 0, Optional ByVal iLocID As Integer = 0, _
                       Optional ByVal iRepTypeID As Integer = 0, Optional ByVal iLotTypeID As Integer = 0, Optional ByVal bMixModel As Boolean = False, _
                       Optional ByVal bCreateManifest As Boolean = True, Optional ByVal bAllowToRemoveUnitInList As Boolean = True)
            MyBase.New()
            ...
            _iMenuLocID = iLocID
            _iMenuRepTypeID = iRepTypeID
            _iMenuLotTypeID = iLotTypeID
            _bMenuMixModel = bMixModel
            _bMenuCreateExcelManifest = bCreateManifest
            _bAllowToRemoveUnitFromList = bAllowToRemoveUnitInList
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.pnlShipType.Size = New System.Drawing.Size(455, 136)
            ...
            Me.chkMixModel.Location = New System.Drawing.Point(344, 110)
            ...
            Me.cboModels.Location = New System.Drawing.Point(104, 104)
            ...
            Me.btnCreateBoxID.Location = New System.Drawing.Point(352, 8)
            Me.btnCreateBoxID.Name = "btnCreateBoxID"
            Me.btnCreateBoxID.RightToLeft = System.Windows.Forms.RightToLeft.No
            Me.btnCreateBoxID.Size = New System.Drawing.Size(80, 56)
            ...
            Me.pnlCreateLot.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblPO, Me.txtPO, Me.cboLotTypes, Me.Label4, Me.cboRepTypes, Me.Label2, Me.btnCreateBoxID})
            Me.pnlCreateLot.Enabled = False
            Me.pnlCreateLot.Location = New System.Drawing.Point(1, 210)
            Me.pnlCreateLot.Name = "pnlCreateLot"
            Me.pnlCreateLot.Size = New System.Drawing.Size(455, 118)
            ...
            'txtPO
            '
            Me.txtPO.Location = New System.Drawing.Point(152, 72)
            Me.txtPO.Name = "txtPO"
            Me.txtPO.Size = New System.Drawing.Size(192, 20)
            Me.txtPO.TabIndex = 100
            Me.txtPO.Text = ""
            '
            'lblPO
            '
            ...
            Me.lblPO.Location = New System.Drawing.Point(8, 72)
            Me.lblPO.Name = "lblPO"
            Me.lblPO.Size = New System.Drawing.Size(136, 16)
            Me.lblPO.TabIndex = 101
            Me.lblPO.Text = "Customer PO (Optional):"
...
#End Region
        ...
        Private Sub frmBuildShipLot_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                If _iMenuCustID > 0 Then
                    ...
                    ElseIf _iMenuLocID > 0 Then
                        Me.cboLocations.SelectedValue = _iMenuLocID
                        Me.cboLocations.Enabled = False
                    Else
                ...
                Me.chkMixModel.Checked = _bMenuMixModel
                If _bMenuMixModel Then Me.chkMixModel.Enabled = False
                ...
                If _iMenuRepTypeID > 0 Then
                    Me.cboRepTypes.SelectedValue = _iMenuRepTypeID
                    Me.cboRepTypes.Enabled = False

                    Me.PopulateComboLotTypes()
                    If _iMenuLotTypeID > 0 Then
                        cboLotTypes.SelectedValue = _iMenuLotTypeID
                        Me.cboLotTypes.Enabled = False
                    Else
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    ElseIf sender.name = "cboModels" AndAlso Me.cboModels.SelectedValue > 0 Then
                        ...
                        Else
                            ...
                            If cboRepTypes.Enabled = True Then
                                Me.cboRepTypes.SelectAll()
                    ...
                    ElseIf sender.name = "cboLotTypes" AndAlso Me.cboLotTypes.SelectedValue > 0 Then
                        If Me.cboLocations.SelectedValue > 0 AndAlso Me.cboLotTypes.SelectedValue > 0 AndAlso Me._objGP.GetOpenPalletCount(Me.cboLocations.SelectedValue, Me.cboLotTypes.SelectedValue, Me.cboModels.SelectedValue) = 0 Then Me.btnCreateBoxID.Visible = True
                        If Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then Me.btnCreateBoxID.Visible = True
            ...
            Try
                ...
                Else
                    ...
                    If Me.dbgPallets.RowCount > 0 Then
                        ...
                        Me.txtPO.Text = Me.dbgPallets.Columns("Cust_PO").CellValue(Me.dbgPallets.Row)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                ElseIf Me.cboLotTypes.SelectedValue = 0 Then
                    ...
                    Me.cboLotTypes.SelectAll()
                    Me.cboLotTypes.Focus()
                ElseIf Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                       AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID _
                       AndAlso Not Me.txtPO.Text.Trim.Length > 0 _
                       AndAlso MessageBox.Show("No customer PO. Do you want to continue?", "Choose Yes/No", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No Then
                    Me.txtPO.SelectAll()
                    Me.txtPO.Focus()
                Else
                    If Me._objGP.GetOpenPalletCount(Me.cboLocations.SelectedValue, Me.cboLotTypes.SelectedValue, Me.cboModels.SelectedValue) = 0 _
                       OrElse (Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                       AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID) Then
                        Me.Enabled = False
                        Cursor.Current = Cursors.WaitCursor

                        iPalletID = Me._objGP.CreatePalletGP(Me.cboCustomers.SelectedValue, Me.cboLocations.SelectedValue, Me.cboModels.SelectedValue, Me.cboLotTypes.SelectedValue, Me.cboLotTypes.DataSource.Table.select("PalletType_ID = " & Me.cboLotTypes.SelectedValue)(0)("Pallettype_SDesc"), Me.cboLotTypes.DataSource.Table.select("PalletType_ID = " & Me.cboLotTypes.SelectedValue)(0)("BillRule_ID"), Me.txtPO.Text.Trim)

                        If iPalletID = 0 Then
                            MessageBox.Show("System has failed to create lot.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                        End If

                        If Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                           AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
        ...
        Private Function ProcessSN() As Boolean
            ...
            Dim iWingTechMaxQty As Integer = 10
            ...
            Try
                ...
                ElseIf Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                   AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID _
                   AndAlso Me.lstDevices.Items.Count >= iWingTechMaxQty Then
                    MessageBox.Show("You reach the maximum qty of devices in the lot.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtDevSN.Text = ""
                ...
                Else
                    ...
                    If dtDevice.Rows.Count > 0 Then iMaxBillRule = Generic.GetMaxBillRule(dtDevice.Rows(0)("Device_ID"))
                    ...
                    ElseIf Me.dbgPallets.Columns("Model_ID").Value > 0 AndAlso dtDevice.Rows(0)("Model_ID") <> CInt(Me.dbgPallets.Columns("Model_ID").Value) Then
                        ...
                        Me.txtDevSN.Text = ""
                    ElseIf Me.cboProduct.SelectedValue <> 18 AndAlso IsDBNull(dtDevice.Rows(0)("Device_DateBill")) Then
                        MessageBox.Show("This device has not been billed.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                        Me.txtDevSN.Text = ""
                    ElseIf Me.cboProduct.SelectedValue <> 18 AndAlso Me.dbgPallets.Columns("BillRule_ID").Value <> iMaxBillRule Then
                    ...
                    ElseIf CInt(Me.dbgPallets.Columns("WO_ID").Value) > 0 AndAlso Me.dbgPallets.Columns("WO_ID").Value.ToString.Equals(dtDevice.Rows(0)("WO_ID").ToString) = False Then
                        ...
                        '    Me.txtDevSN.Text = ""
                    ElseIf iMaxBillRule = 0 AndAlso objQC.IsRequire100PercentAQLTest(Me.cboCustomers.SelectedValue) = True AndAlso objQC.IsAQLPassed(Convert.ToInt32(dtDevice.Rows(0)("Device_ID"))) = False Then
                        '***************************************************
                        'Check if the Device pass AQL Station for Plastronics Socket Company
                        '***************************************************
                        MessageBox.Show("This device has not passed at AQL station.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                        Me.txtDevSN.SelectAll() : Me.txtDevSN.Focus()
                    Else
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Try
                ...
                Else
                    ...
                    'Peiker Acustic, Inc.
                    If Me.cboCustomers.SelectedValue = 2543 Then
                        booAddSNBarcodeColumn = True
                        booSetBorder = False
                    End If
                    '*****************************************************
                    'PLASTRONIC ONLY
                    ...
                    If Me._bMenuCreateExcelManifest AndAlso Me.cboProduct.SelectedValue <> 18 Then
                        i = Me._objGP.CreateManifest(CInt(Me.dbgPallets.Columns("Pallett_ID").Value), Me._strManifestFilePath, 0, booAddSNBarcodeColumn, booSetBorder)
                    End If
                    ...
                    If Me.cboCustomers.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                       AndAlso Me.cboLocations.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
                        Dim objWingTechATT As New PSS.Data.Buisness.WingTechATT.WingTechATT_BoxShip()
                        i = objWingTechATT.CloseWingTechATT_SP_Pallet(CInt(Me.dbgPallets.Columns("Pallett_ID").Value))
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                If _bAllowToRemoveUnitFromList = False Then Throw New Exception("Not allowed to remove unit from the list.")
                '************************
                'Validations
                ...
                End If
            Catch ex As Exception
                MessageBox.Show(ex.Message, "Clear S/N", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            Finally
                Me.Enabled = True : Cursor.Current = Cursors.Default
                Me.txtDevSN.Text = "" : Me.txtDevSN.Focus()
            End Try
        ...
        Private Sub btnRemoveAllSNs_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveAllSNs.Click
            ...
            Try
                If _bAllowToRemoveUnitFromList = False Then Throw New Exception("Not allowed to remove units from the list.")
                '************************
                'Validations
                '************************
                If Me.lstDevices.Items.Count = 0 Or Me.dbgPallets.RowCount = 0 Then
        ...
        Private Sub btnDeleteLot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteLot.Click
            ...
            Try
                ...
                Else
                    ...
                    i = PSS.Data.Production.Shipping.DeleteEmptyPallet(CInt(Me.dbgPallets.Columns("Pallett_ID").Value), PSS.Core.ApplicationUser.IDuser, bDelete)
        ...
        Private Sub btnReprintLotLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintLotLabel.Click
            ...
            Try
                ...
                Else
                    ...
                    iCust_ID = R1("Cust_ID") : iLoc_ID = R1("Loc_ID") : iPallet_ID = R1("Pallett_ID")
                    ...
                    ElseIf iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                       AndAlso iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
                        Dim objWingTechATT As New PSS.Data.Buisness.WingTechATT.WingTechATT_BoxShip()
                        i = objWingTechATT.CloseWingTechATT_SP_Pallet(iPallet_ID)
                        objWingTechATT = Nothing
                    Else
                        PSS.Data.Production.Shipping.PrintPalletLicensePlate(R1("Pallett_Name"), R1("Model_ID"), strPalletType, iPalletQty, 3)
                    End If
