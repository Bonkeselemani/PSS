...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_BuildBox
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_BuildBox))
            ...
            Me.panelPallet.Controls.AddRange(New System.Windows.Forms.Control() {Me.labelPONumber, Me.lblPO, Me.lblOEMCustomerClass, Me.txtDevSN, Me.Label10, Me.btnCloseBox, Me.btnRemoveAllSNs, Me.btnRemoveSN, Me.lstDevices, Me.lblCount, Me.Label3, Me.lblBoxName, Me.btnFillBoxWithWHBox, Me.lblBERReason})
            Me.panelPallet.Location = New System.Drawing.Point(464, 80)
            Me.panelPallet.Name = "panelPallet"
            Me.panelPallet.Size = New System.Drawing.Size(384, 504)
            ...
            Me.Panel2.Size = New System.Drawing.Size(632, 80)
            ...
            Me.PanelPalletList.Location = New System.Drawing.Point(0, 248)
            Me.PanelPalletList.Name = "PanelPalletList"
            Me.PanelPalletList.Size = New System.Drawing.Size(464, 336)
            ...
            Me.btnDeleteBox.Location = New System.Drawing.Point(240, 256)
            ...
            Me.dbgPallets.Size = New System.Drawing.Size(448, 224)
            ...
            "arent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 444, 220</ClientRect><BorderSide>" & _
            ...
            "ltRecSelWidth><ClientArea>0, 0, 444, 220</ClientArea><PrintPageHeaderStyle paren" & _
            ...
            Me.btnReprintBoxLabel.Location = New System.Drawing.Point(8, 296)
            ...
            Me.lblScreenName.Text = "Vinsmart BUILD SHIP BOX"
            ...
            Me.pnlShipType.Size = New System.Drawing.Size(464, 165)
            ...
            Me.cboModel.Location = New System.Drawing.Point(88, 38)
            ...
            Me.cboBoxTypes.Location = New System.Drawing.Point(88, 66)
            ...
            Me.DOA_POS.TabIndex = 95
            Me.DOA_POS.Text = "DOA/POS"
            '
            'frmVinsmart_BuildBox
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.ClientSize = New System.Drawing.Size(848, 582)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.panelPallet, Me.Panel2, Me.PanelPalletList, Me.lblScreenName, Me.pnlShipType})
            Me.Name = "frmVinsmart_BuildBox"
            Me.Text = "frmVinsmart_BuildBox"
...
#End Region
        ...
        Private Sub frmVinsmart_BuildBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                dtLoc = Me._objVinsmart_BoxShip.GetVinsmartLocations(Me._iMenuCustID, True)
                ...
                dtModel = Me._objVinsmart_BoxShip.GetVinsmartModels(Me._iMenuCustID, True)
                ...
                dtType = Me._objVinsmart_BoxShip.GetVinsmartShipBoxTypes(True)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                If IsNothing(Me.cboLocation.SelectedValue) OrElse Me.cboLocation.SelectedValue = 0 Then
                    MessageBox.Show("Please select Vinsmart location.", "Create Box ID", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.cboLocation.Focus()
                ...
                Else
                    If Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID _
                    Or Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID Then
                        Dim strDefault As String = Me._objVinsmart_BoxShip.GetLastSoftwareVersion(Me._iMenuCustID, Me.cboLocation.SelectedValue)
                    ...
                    Me._iPallett_ID = Me._objVinsmart_BoxShip.CreateBoxID(Me.cboModel.SelectedValue, Me.cboBoxTypes.SelectedValue, _
        ...
        Private Sub PopulateOpenBoxs(Optional ByVal iPallettID As Integer = 0)
            ...
            Try
                ...
                Dim strLoc_id As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID & "," & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID
                If rbCricket.Checked Then strLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
                dt = Me._objVinsmart_BoxShip.GetVinsmartOpenPallets(Me._iMenuCustID, strLoc_id)
                With Me.dbgPallets
        ...
        Private Sub RefreshSNList()
            ...
            Try
                ...
                If strAccount = Me._objVinsmart.Vinsmart_FexEx_PosCode OrElse strAccount = Me._objVinsmart.Vinsmart_Cricket_OEMCustomer_DOA_AccountCode Then
                ...
                dt1 = Me._objVinsmart_BoxShip.GetAllSNsForPallet(iPallet_ID)
                ...
                If dt1.Rows.Count > 0 Then
                    strOEMCustomerClass = Me._objVinsmart_BoxShip.GetOEMCustomerClass(dt1.Rows(0).Item("Device_ID"), Me._iMenuCustID, dt1.Rows(0).Item("Loc_ID"))
        ...
        Private Sub txtDevSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDevSN.KeyUp
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtDevSN.Text.Trim.Length > 0 Then Me.ProcessVinsmartSN()
                End If
            Catch ex As Exception
        ...
        Private Sub ProcessVinsmartSN()
            ...
            Try
                ...
                If lstDevices.Items.Count = 0 AndAlso Not rbCricket.Checked Then
                    strLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID & "," & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID

                    dtDevice = Me._objVinsmart_BoxShip.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, strLoc_id)
                ElseIf rbCricket.Checked Then ' lstDevices.Items.Count = 0 AndAlso rbCricket.Checked Then  THIS WAS NOT CORRECT!!!!!!
                    strLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
                    dtDevice = Me._objVinsmart_BoxShip.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, strLoc_id)
                Else
                    strLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID & "," & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID
                    dtDevice = Me._objVinsmart_BoxShip.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, strLoc_id)
                ...
                dtBill = Me._objVinsmart_BoxShip.GetDeviceBillData(iDevice_ID)
                ...
                If dtBill.Rows.Count > 0 Then
                    ...
                    For j = 0 To dtBill.Rows.Count - 1
                        If dtBill.Rows(j)("BillCode_Id") = Me._objVinsmart.Vinsmart_BER_BillCode_ID Then
                            isBER_Billcode = True
                            Exit For
                        End If
                    Next
                ...
                If Me._objVinsmart_BoxShip.GetSwappedStatus(strSN.Trim.ToUpper, _iMenuCustID) > 0 Then
                    If dtBill.Rows.Count > 1 AndAlso isBER_Billcode Then
                        ...
                        Me.txtDevSN.Focus()
                        Exit Sub
                    ElseIf Not dtBill.Rows.Count = 1 AndAlso Not dtBill.Rows(0)("BillCode_Id") = Me._objVinsmart.Vinsmart_BER_BillCode_ID Then
                ...
                If Not isBER_Billcode AndAlso Not Me.cboBoxTypes.SelectedValue = 1 Then
                    IsSeedstock = False
                    iAccount = Me._objVinsmart_BoxShip.GetAccount(strSN.Trim.ToUpper, _iMenuCustID)
                    If dtBill.Rows.Count = 0 Then
                    ...
                    ElseIf iAccount = 1 Then
                        Dim j As Integer
                        For j = 0 To dtBill.Rows.Count - 1
                            If dtBill.Rows(j)("BillCode_Id") = Me._objVinsmart.Vinsmart_Swap_BillCode_ID Then
                        ...
                        ElseIf Not isBillcodeSeedS Then
                            MsgBox(strSN.Trim.ToUpper + " Need to be used as a Seedstock", MsgBoxStyle.Information, "Device Scan")
                            Me.txtDevSN.Text = ""
                            Me.txtDevSN.Focus()
                            Exit Sub
                        Else
                ...
                Dim dtAccount = Me._objVinsmart_BoxShip.GetAccount_DOA_POS(strSN.Trim.ToUpper, _iMenuCustID)

                'for DOA AND POS devices for Vinsmart ,SKIPP THE PO VALIDATION FOR Vinsmart ATT CTDI/FEDEX   
                If Not (dtAccount.Rows(0).Item("Account") = Me._objVinsmart.Vinsmart_FexEx_PosCode OrElse dtAccount.Rows(0).Item("Account") = Me._objVinsmart.Vinsmart_Cricket_OEMCustomer_DOA_AccountCode) Then
                    ...
                    If Not Me.cboBoxTypes.SelectedValue = 1 Then
                        ...
                        If Not cboLocation.SelectedValue = Me._objVinsmart.Vinsmart_AttCricket_LOC_ID Then
                            If Trim(labelPONumber.Text) = String.Empty AndAlso lstDevices.Items.Count = 0 Then
                                GoTo Next_step
                            ElseIf Trim(labelPONumber.Text) <> "" Then
                                Dim dtPONumber As DataTable = _objVinsmart_BoxShip.GetPO(iDevice_ID, iAccount)
                    ...
                    End If
                End If
Next_step:      Dim iPallett_MaxQty As Integer = _objVinsmart_BoxShip.getPallet_MaxQty(CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _iMenuCustID)
                ...
                'dtDevice = Me._objVinsmart_BoxShip.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, me.)
                If Not cboLocation.SelectedValue = Me._objVinsmart.Vinsmart_AttCricket_LOC_ID AndAlso Not lblPO.Text = String.Empty AndAlso lstDevices.Items.Count > 0 Then
                    dtPO = Me._objVinsmart_BoxShip.GetVinsmartLocationsbyID(Me._iMenuCustID, Me.txtDevSN.Text.Trim)
                ...
                Else '1 row
                    ...
                    If rbCricket.Checked And Not IsSeedstock Then
                        strOEMCustomerClass = Me._objVinsmart_BoxShip.GetOEMCustomerClass(iDevice_ID, Me._iMenuCustID, Me.cboLocation.SelectedValue)
                    ...
                    If Me.cboBoxTypes.SelectedValue = 2 Then
                        ...
                        For Each row In dtBill.Rows
                            If Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_RUR_BillCode_ID _
                            OrElse Convert.ToInt16(row("BillCode_ID")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_RUR_BillCode_ID2 Then
                    ...
                    If Me.DOA_POS.Checked Then
                        If Not ((strpallett_Account = Me._objVinsmart.Vinsmart_FexEx_PosCode AndAlso dtAccount.Rows(0).Item("Account") = Me._objVinsmart.Vinsmart_FexEx_PosCode) _
                        OrElse (strpallett_Account = Me._objVinsmart.Vinsmart_Cricket_OEMCustomer_DOA_AccountCode AndAlso dtAccount.Rows(0).Item("Account") = Me._objVinsmart.Vinsmart_Cricket_OEMCustomer_DOA_AccountCode)) Then
                    ...
                    If Me.cboBoxTypes.SelectedValue = 0 Then
                        ...
                        dtFQA = Me._objVinsmart_BoxShip.GetDeviceFqaData(iDevice_ID)
                        ...
                        dtRF = Me._objVinsmart_BoxShip.GetDeviceRfTestData(strSN)
                        ...
                        dtFlashManual = Me._objVinsmart_BoxShip.GetDeviceFlashManual(strSN)
                        ...
                        End If
                        'End If
                        dtFlash = Me._objVinsmart_BoxShip.GetDeviceFlashTestData(strSN)
                        ...
                        dtSoftVersion = Me._objVinsmart_BoxShip.GetSoftVersion(dtDevice.Rows(0).Item("Model_ID"), Me._iMenuCustID)
                    ...
                    Else
                        ...
                        Me._objVinsmart_BoxShip.AssignDeviceToPallet(dtDevice.Rows(0)("Device_ID"), CInt(Me.dbgPallets.Columns("Pallett_ID").Value), strDateTime)
                        '***************************************************
                        ...
                        If Not rbCricket.Checked AndAlso Me.lstDevices.Items.Count = 1 Then
                            ...
                            dtLoc = Me._objVinsmart_BoxShip.GetVinsmartLocationsbyID(_iMenuCustID, Me.txtDevSN.Text.Trim)
                            If dtLoc.Rows.Count = 1 Then
                                iTempLoc_id = (dtLoc.Rows(0)("Loc_ID"))
                                Me._objVinsmart_BoxShip.UpdateVinsmartPalletLocation(iTempLoc_id, CInt(Me.dbgPallets.Columns("Pallett_ID").Value))
                            End If
                        End If
                        Me.RefreshSNList()
                        Me.Enabled = True
        ...
        Private Sub displayPOnumber()
            If labelPONumber.Text = String.Empty AndAlso lstDevices.Items.Count > 0 Then
                Dim iAccount As Integer = Me._objVinsmart_BoxShip.GetAccount(Me.lstDevices.Items.Item(0)("Device_SN").ToString.Trim, Me._iMenuCustID)
                Dim iDeviceId As Integer = Me._objVinsmart_BoxShip.GetDeviceId(Me.lstDevices.Items.Item(0)("Device_SN").ToString.Trim)
                Dim dtPO As DataTable = Me._objVinsmart_BoxShip.GetPO(iDeviceId, iAccount)
        ...
        Private Sub btnCloseBox_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Dim strNextWrkStation As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_BuildProduce_WorkStation
            ...
            Try
                ...
                '************************
                'Validations
                Dim iPallett_MaxQty As Integer = _objVinsmart_BoxShip.getPallet_MaxQty(CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _iMenuCustID)
                If CInt(Me.dbgPallets.Columns("Pallett_id").Value) = 0 Then
                    Throw New Exception("Box name is not selected.")
                ElseIf Me.dbgPallets.Columns("Box Name").Value.ToString.Trim = "" Then
                    Throw New Exception("Box name is not selected.")
                ...
                ElseIf Me.lstDevices.Items.Count > iPallett_MaxQty Then
                    MessageBox.Show("Box can't contain more than " & iPallett_MaxQty.ToString & " units.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Me.txtDevSN.Focus() : Exit Sub
                ...
                i = Me._objVinsmart_BoxShip.CloseVinsmartPallet(Me._iMenuCustID, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _
                ...
                '************************
                If CInt(Me.dbgPallets.Columns("Loc_ID").Value) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID _
                   AndAlso Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then

                    Me._objVinsmart_BoxShip.PrintBoxLabel(CInt(Me.dbgPallets.Columns("Pallett_id").Value))

                ElseIf CInt(Me.dbgPallets.Columns("Loc_ID").Value) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID _
                                      AndAlso Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID Then

                    Me._objVinsmart_BoxShip.Print_AttCTDI_BoxLabel(CInt(Me.dbgPallets.Columns("Pallett_id").Value))
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                ...
                If iDeviceID > 0 Then
                    ...
                    i = Me._objVinsmart_BoxShip.RemoveSNfromPallet(CInt(Me.dbgPallets.Columns("Pallett_id").Value), iDeviceID)
                    If i = 0 Then
        ...
        Private Sub btnReopenBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReopenBox.Click
            ...
            Dim dt As DataTable
            Dim strCurrentStation As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_FQA_WorkStation
            ...
            Try
                ...
                dt = Me._objVinsmart_BoxShip.GetVinsmartPallettData(strPallet, Me._iMenuCustID)
                ...
                Else
                    i = Me._objVinsmart_BoxShip.ReopenVinsmartBoxByResetting(dt.Rows(0)("Pallett_ID"), strCurrentStation)
                    If i = 0 Then
        ...
        Private Sub dbgPallets_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dbgPallets.MouseUp
            ...
            DOA_POS.Enabled = False
            If Me.dbgPallets.Columns("loc_id").Value() = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then
                rbCricket.Checked = True
                rbATT.Checked = False
            Else
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                ...
                strPallet = strPallet.Trim
                dtTempClosepallet = Me._objVinsmart_BoxShip.CheckOpenPallet(strPallet)
                If dtTempClosepallet.Rows.Count <> 0 Then
                    strPalletId = dtTempClosepallet.Rows(0)("Pallett_id")
                    If CInt(dtTempClosepallet.Rows(0)("Loc_id")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then

                        Me._objVinsmart_BoxShip.PrintBoxLabel(CInt(strPalletId))

                    ElseIf CInt(dtTempClosepallet.Rows(0)("Loc_id")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID _
                    OrElse CInt(dtTempClosepallet.Rows(0)("Loc_id")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID Then

                        Me._objVinsmart_BoxShip.Print_AttCTDI_BoxLabel(CInt(strPalletId))
                    Else
                        MessageBox.Show("Location ID mismatched! The pallet has been closed, but failed to print the label.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    End If
                Else
        ...
        Private Sub rbCricket_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbCricket.CheckedChanged
            If rbCricket.Checked = True Then
                Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
            Else
                Me.cboLocation.SelectedValue = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID
            End If
            Me.PopulateOpenBoxs(Me._iPallett_ID)
            'Me._objVinsmart_BoxShip.GetVinsmartOpenPallets(Me._iMenuCustID, PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID)
        End Sub
