...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_FlashTest
        Inherits System.Windows.Forms.Form

        Private _iCust_ID As Integer = 0
        Private _strScreenName As String = ""
        Private _objRfFlahTests As PSS.Data.Buisness.Vinsmart.Vinsmart_FlashTest
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objRfFlahTests = New PSS.Data.Buisness.Vinsmart.Vinsmart_FlashTest()
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_FlashTest))
            ...
            '
            'frmVinsmart_FlashTest
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.BackColor = System.Drawing.Color.SteelBlue
            Me.ClientSize = New System.Drawing.Size(800, 606)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Panel3, Me.lblDevRepType, Me.btnPass, Me.btnClear, Me.btnFail, Me.lblWrtyStatus, Me.lblDateCode, Me.Label3, Me.Panel1, Me.Panel2})
            Me.Name = "frmVinsmart_FlashTest"
            Me.Text = "frmVinsmart_FlashTest"
...
#End Region
        ...
        Private Sub frmVinsmart_FlashTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim i As Integer = 0
...
loadproduct:    dt = Generic.GetProductByCustID(True, Me._iCust_ID)
        ...
        Private Sub ProcessSN()
            ...
            Try
                ...
                End If
                If Not iLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Special_LOC_ID Then
                    ' Check FQA Result FOR Vinsmart
                    If _iCust_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then
        ...
        Private Sub SaveTestInfoVinsmart()
            Dim strSN As String
            ...
            Try
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._objRfFlahTests.InsertRFlashVinsmart(PSS.Core.Global.ApplicationUser.IDuser, strSN, _iRFResult) Then
                            Me.LoadTestHistory(Me._iDevice_ID)
                        Else
                        End If
                        Me.txtDeviceSN.SelectAll()
