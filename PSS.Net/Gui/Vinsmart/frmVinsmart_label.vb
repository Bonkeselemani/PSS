...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_label
        ...
        Private _objVinsmartLabel As PSS.Data.Buisness.Vinsmart.Vinsmart_label
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCustID As Integer, ByVal strScreenName As String)
            ...
            _objVinsmartLabel = New PSS.Data.Buisness.Vinsmart.Vinsmart_label()
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_label))
            ...
            Me.btnResetManufDateCode.Location = New System.Drawing.Point(40, 424)
            Me.btnResetManufDateCode.Name = "btnResetManufDateCode"
            Me.btnResetManufDateCode.Size = New System.Drawing.Size(184, 32)
            Me.btnResetManufDateCode.TabIndex = 23
            ...
            Me.C1Combo1.Images.Add(CType(resources.GetObject("resource.Images"), System.Drawing.Bitmap))
            Me.C1Combo1.ItemHeight = 15
            Me.C1Combo1.Location = New System.Drawing.Point(640, 320)
            ...
            Me.cmdlblprint.Location = New System.Drawing.Point(40, 368)
            Me.cmdlblprint.Name = "cmdlblprint"
            Me.cmdlblprint.Size = New System.Drawing.Size(185, 46)
            Me.cmdlblprint.TabIndex = 19
            ...
            Me.cboSJUG.Images.Add(CType(resources.GetObject("resource.Images2"), System.Drawing.Bitmap))
            ...
            Me.cboMadeIn.Images.Add(CType(resources.GetObject("resource.Images3"), System.Drawing.Bitmap))
            ...
            Me.lblTFModel.Location = New System.Drawing.Point(296, 256)
            Me.lblTFModel.Name = "lblTFModel"
            Me.lblTFModel.Size = New System.Drawing.Size(112, 24)
            Me.lblTFModel.TabIndex = 21
            Me.lblTFModel.Text = "VinsmartModel No:"
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnResetManufDateCode, Me.btnViewLabelSetUpInfo, Me.C1Combo1, Me.grbLabelSetUpInfo, Me.cmdlblprint, Me.pnlMain, Me.btnRemoveLabelInfo})
            Me.Name = "frmVinsmart_label"
            Me.Text = "frmVinsmart_label"
...
#End Region
        ...
        Private Sub frmVinsmart_label_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim dt As DataTable
            ...
            Try
                ...
                dt = _objVinsmartLabel.GetManufCountry(True)
                ...
                If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then
                    ...
                    Me.btnViewLabelSetUpInfo.Visible = False
                    ' Me.btnResetManufDateCode.Visible = True
                End If
        ...
        Private Sub FillLabelInfo_Label()
            ...
            Try
                If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then
                    dt1 = Me._objVinsmartLabel.GetVinsmartDeviceInfoForLabel(Trim(Me.txtIMEI.Text), Me._iMenuCustID)
                End If
                ...
                dt2 = Me._objVinsmartLabel.GetLabelPanel(_iModel_ID)
                ...
                If dt2.Rows(0)("Panel4") = 1 Then
                    ...
                    End If
                    If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then Me.btnResetManufDateCode.Visible = True
                End If
                ...
                If dt2.Rows(0)("Panel8") = 1 Then
                    ...
                    If Me.txtIMEI.Text.Trim.Length > 0 Then
                        strIMEI_HEX = Me._objVinsmartLabel.GetIMEI_HEX(Me.txtIMEI.Text.Trim)
                ...
                If dt2.Rows(0)("Panel10") = 1 Then
                    ...
                    If Me.txtIMEI.Text.Trim.Length > 0 Then
                        If Me._objVinsmartLabel.GetMEIDHEXDEC_IMEIAlt(Me.txtIMEI.Text.Trim, strMEIDHEX, strMEIDDEC) Then
                ...
                If CInt(dt1.Rows(0)("Manuf_ID")) = 1 Then
                    dt = _objVinsmartLabel.GetSug(True, _iModel_ID)
                ...
                Else
                    Me.cboMadeIn.SelectedValue = Me._objVinsmartLabel.GetVinsmartDeviceMadeInCountryIDForLabel(dt1.Rows(0)("model_id"))
                End If
        ...
        Private Sub cmdlblprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdlblprint.Click
            ...
            Try
                If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then Me.PrintVinsmartLabel()
                ...
                Me._objVinsmartLabel.GetMEIDHEXDEC_IMEIAlt(Me.txtIMEI.Text.Trim, , , strIMEI_Alt)
                ...
                'PRINT LABEL
                '*******************************************
                j = Me._objVinsmartLabel.PrintLabel(Trim(Me.txtModelNo.Text), (Trim(Me.txtIMEI.Text)), Trim(Me.txtFCCID.Text), _
                ...
                j = Me._objVinsmartLabel.UpdateLabelTcell(_iDevice_ID, strMSNSN, Me.cboMadeIn.SelectedValue, UCase(Trim(Me.txtProdCode.Text)), _
        ...
        '******************************************************************
        Private Sub PrintVinsmartLabel()
            Const iIMEILabelBillcode As Integer = 1624
            Dim strNextWrkStation, strSjug, strMSNSN, strESN As String
            Dim i As Integer = 0
            Dim j As Integer = 0
            ...
            Try
                ...
                '*****************************************************
                If Me.cboLabelType.SelectedIndex = 0 Then
                    strNextWrkStation = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_FQA_WorkStation
                    If strNextWrkStation.Trim.Length > 0 Then i = Generic.SetTcelloptWorkStationForDevice(strNextWrkStation, _iDevice_ID, Core.ApplicationUser.IDuser, "Label", Me.Name, , , , , , )
                    If i > 0 Then MessageBox.Show("This device now belongs to " & strNextWrkStation & " workstation.", "Information", MessageBoxButtons.OK)
                End If
                ...
                'UPDATE LABEL INFO INTO TCELLOPT TABLE
                '*******************************************
                j = Me._objVinsmartLabel.UpdateVinsmartLabelTCellOpt(_iDevice_ID, Me.txtDate.Text, Me.cboMadeIn.SelectedValue, _
        ...
        Private Sub btnRemoveLabelInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemoveLabelInfo.Click
            ...
            Try
                ...
                Dim fm As New frmVinsmart_LabelInfoRemove(strIMEI)
                fm.ShowDialog()
                fm.Dispose()
            Catch ex As Exception
