...
Namespace Gui.Vinsmart
    Public Class frmVinsmart_Report
        ...
        '            Me.GroupBox2.Location = New System.Drawing.Point(52, 343)
        ...
        '            Me.grpSN.Location = New System.Drawing.Point(52, 223)
        '            Me.grpSN.Name = "grpSN"
        '            Me.grpSN.Size = New System.Drawing.Size(400, 56)
        '            Me.grpSN.TabIndex = 121
        ...
        '            Me.grpRptType.Location = New System.Drawing.Point(52, 287)
        '            Me.grpRptType.Name = "grpRptType"
        '            Me.grpRptType.Size = New System.Drawing.Size(400, 48)
        '            Me.grpRptType.TabIndex = 119
        ...
        '            Me.gbWorkOrder.Location = New System.Drawing.Point(52, 463)
        '            Me.gbWorkOrder.Name = "gbWorkOrder"
        '            Me.gbWorkOrder.Size = New System.Drawing.Size(400, 48)
        '            Me.gbWorkOrder.TabIndex = 117
        ...
        '            Me.gbDate.Location = New System.Drawing.Point(52, 143)
        '            Me.gbDate.Name = "gbDate"
        '            Me.gbDate.Size = New System.Drawing.Size(400, 80)
        '            Me.gbDate.TabIndex = 113
        ...
        '            Me.lblTitle.Location = New System.Drawing.Point(164, 7)
        '            Me.lblTitle.Name = "lblTitle"
        '            Me.lblTitle.Size = New System.Drawing.Size(184, 32)
        '            Me.lblTitle.TabIndex = 116
        '            Me.lblTitle.Text = "Vinsmart Report"
        '            '
        '            'btnRunRpt
        '            '
        ...
        '            Me.btnRunRpt.Location = New System.Drawing.Point(52, 415)
        '            Me.btnRunRpt.Name = "btnRunRpt"
        '            Me.btnRunRpt.Size = New System.Drawing.Size(400, 32)
        '            Me.btnRunRpt.TabIndex = 114
        '            '
        '            'GroupBox1
        '            '
        ...
        '            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.GroupBox2, Me.grpSN, Me.grpRptType, Me.grpImeiFile, Me.gbWorkOrder, Me.gbDate, Me.lblTitle, Me.btnRunRpt, Me.GroupBox1, Me.gbReportName})
        '            Me.Name = "frmVinsmart_Report"
        '            Me.Text = "frmVinsmart_Report"
        ...
        '        Private Sub frmVinsmart_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '            Try
        ...
        '                Else
        '                    Me.cboLocation.Items.Clear()
        '                    Me.cboLocation.Items.Add("VinSmart Cricket")
        ...
        '        '    Dim objVinsmartRpt As PSS.Data.Buisness.Vinsmart.Vinsmart_Report
        ...
        '        '            'Generate Report
        '        '            '*************************************
        '        '            objVinsmartRpt = New PSS.Data.Buisness.Vinsmart.Vinsmart_Report()
        ...
        '        '                i = objVinsmartRpt.CreateInventoryReport(Me._iMenuCust, strRptNameTmp, strDateStart)
        ...
        '                    '*************************************
        '                    objVinsmartRpt = New PSS.Data.Buisness.Vinsmart.Vinsmart_Report()
        '                    objVinsmartRpt.colDefault = colDefault
        ...
        '                    If Me._strRptName = Me.ReportNames.RA_uploaded_report.ToString Then
        '                        i = objVinsmartRpt.CreateInventoryReport(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 1, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '                        'IF Report =Received_Report
        '                    ElseIf Me._strRptName = Me.ReportNames.Received_Report.ToString Then
        '                        i = objVinsmartRpt.CreateInventoryReport(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 2, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '                        'IF Report =part used
        '                    ElseIf Me._strRptName = Me.ReportNames.Part_Used.ToString Then
        '                        i = objVinsmartRpt.CreateInventoryReport(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 7, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '                        'IF Report =Shipped_Report
        '                    ElseIf Me._strRptName = Me.ReportNames.Shipped_Report.ToString Then
        '                        i = objVinsmartRpt.CreateInventoryReport(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 3, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '                        'IF Report =Status_Report
        '                    ElseIf Me._strRptName = Me.ReportNames.Status_Report.ToString Then
        '                        i = objVinsmartRpt.CreateInventoryReport(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 4, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '                        'IF Report =Pretest_Report
        '                    ElseIf Me._strRptName = Me.ReportNames.Pretest_Report.ToString Then
        '                        i = objVinsmartRpt.CreatePretestRawDataRpt(strDateStart, strDateEnd, "", strLocation, iOption, strImei)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        '                            iStatus = 1
        '                        End If
        '                        i = objVinsmartRpt.CreateWexATT(Me.Cust_Id, "WEX Open Orders", strDateStart, strDateEnd, strLocation, iStatus)
        '                        If i = 0 Then MessageBox.Show("No data for " & _strRptName & " Report.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)

        '                    ElseIf Me._strRptName = Me.ReportNames.Invoice.ToString Then
        '                        'If cboLocation.Text = "Cricket" Then
        '                        '    i = objVinsmartRpt.CreateInvoiceCricket(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
        '                        'ElseIf cboLocation.Text = "ATT_CTDI" Then
        '                        '    i = objVinsmartRpt.CreateInvoiceATTCTDI(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)

        '                        'End If
        '                        Select Case cboLocation.Text.Trim.ToUpper
        '                            Case Is = "Cricket".Trim.ToUpper
        '                                i = objVinsmartRpt.CreateInvoiceCricket(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
        '                            Case Is = "ATT_CTDI".Trim.ToUpper, "ATT_FedEx".Trim.ToUpper
        '                                i = objVinsmartRpt.CreateInvoiceATTCTDI(Me.Cust_Id, _strRptName & strTempname, strDateStart, strDateEnd, strLocation, 6, iOption, strImei)
        '                            Case Else
        ...
        '            Else
        '                Me.cboLocation.Items.Clear()
        '                Me.cboLocation.Items.Add("Cricket")
        '                Me.cboLocation.Items.Add("ATT")
        '            End If
        '        End Sub
    End Class
