...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_SPecialBuildBox
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_SPecialBuildBox))
            ...
            Me.lblScreenName.Text = "Vinsmart SPECIAL BUILD SHIP BOX"
            ...
            Me.cboProject.MaxDropDownItems = CType(5, Short)
            ...
            Me.Name = "frmVinsmart_SPecialBuildBox"
            Me.Text = "frmVinsmart_SPecialBuildBox"
...
#End Region
        ...
        Private Sub frmVinsmart_SPecialBuildBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                dtLoc = Me._objVinsmart_SP.GetVinsmartLocations(Me._iMenuCustID, True)

                Misc.PopulateC1DropDownList(Me.cboLocation, dtLoc, "Loc_Name", "Loc_ID")
                Me.cboLocation.SelectedValue = Me._objVinsmart.Vinsmart_Special_LOC_ID
                Me.cboLocation.Enabled = True

                dtModel = Me._objVinsmart_SP.GetVinsmartModels(Me._iMenuCustID, True)
                Misc.PopulateC1DropDownList(Me.cboModel, dtModel, "Model_Desc", "Model_ID")
                Me.cboModel.SelectedValue = Me._objVinsmart.Vinsmart_SpecialProjType2_MODEL_ID
                ...
                dtPrjType = Me._objVinsmart_SP.GetVinsmartProjectTypes(Me._iMenuCustID, Me._iMenuLocID, True)
                Misc.PopulateC1DropDownList(Me.cboProject, dtPrjType, "PrjType_Desc", "PrjType_Name")
                Me.cboProject.SelectedValue = Me._objVinsmart.Vinsmart_SpecialProj_Type2
                Me.cboProject.Enabled = True
                cboProject.Focus()

                dtType = Me._objVinsmart_SP.GetVinsmartShipBoxTypes(True)
        ...
        Private Sub PopulateOpenBoxs(Optional ByVal iPallettID As Integer = 0)
            ...
            Try
                ...
                Me.panelPallet.Visible = False
                'Me.btnCreateBoxID.Visible = False
                dt = Me._objVinsmart_SP.GetVinsmartOpenPallets(Me._iMenuCustID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                'If cboProject.SelectedValue = Me._objVinsmart.Vinsmart_SpecialProj_Type2 Then
                ...
                Else
                    ...
                    Me._iPallett_ID = Me._objVinsmart_SP.CreateBoxID(Me.cboModel.SelectedValue, Me.cboBoxTypes.SelectedValue, _
                                                                      Me.txtPOnum.Text, _
        ...
        Private Sub SetGridOpenBoxProperties(Optional ByVal iPallet_ID As Integer = 0)
            ...
            With Me.dbgPallets
                ...
                .Splits(0).DisplayColumns("Project").Width = 100
        ...
        Private Sub ProcessVinsmartSN()
            ...
            Dim dtDevice, dtPretest, dtFlashManual, dtFQA, dtCntryOrgn As DataTable
            ...
            Try
                ...
                '***************************************************
                If Me.lstDevices.Items.Count >= PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SPMaxQtyInBox Then
                    Throw New Exception("Box can't contain more than " & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SPMaxQtyInBox & " units.")
                End If
                ...
                End If
                i = 0
                dtDevice = Me._objVinsmart_SP.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, _iMenuLocID)
                ...
                Else '1 row
                    ...
                    dtCntryOrgn = Me._objVinsmart_SP.GetCountryAndAccount(Me.txtDevSN.Text.Trim, _iMenuCustID, _iMenuLocID)
                    ...
                    Else
                        ...
                        Else
                            ...
                            dtdtCntryOrgnList = Me._objVinsmart_SP.GetCountryAndAccount(strIMEI, _iMenuCustID, _iMenuLocID)
                    ...
                    If cboBoxTypes.Text = "REF" Then
                        iDevice_ID = dtDevice.Rows(0).Item("Device_ID")
                        Dim isPrestPass As Boolean = False
                        dtPretest = Me._objVinsmart_SP.GetDevicePretest(iDevice_ID)
                        ...
                        Else
                            ...
                            For Each row In dtPretest.Rows
                                If Convert.ToInt16(row("Pttf")) = 2515 Then
                                    isPrestPass = True : Exit For
                                End If
                            Next
                            If Not isPrestPass = True Then
                            ...
                            End If
                        End If
                        'SKIPP FQA FOR V350U Rexford 08202021 Reflash Rework ASN.xlsx DEVICES 
                        Dim dtReworkFilename As DataTable = Me._objVinsmart_SP.GetSourceFile(Me.txtDevSN.Text.Trim, _iMenuCustID, _iMenuLocID)
                        strFilename = dtReworkFilename.Rows(0).Item("SourceFile")
                        If Not strFilename = Me._objVinsmart.strDefSourceFile Then
                            dtFQA = Me._objVinsmart_SP.GetDeviceFQAData(iDevice_ID)
                            If Not dtFQA.Rows.Count > 0 Then
                                MessageBox.Show("The device has no FQA Info. Can't ship it.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                Me.txtDevSN.SelectAll()
                                Exit Sub
                            ElseIf Not dtFQA.Rows.Count > 0 OrElse dtFQA.Rows(0).IsNull("QCResult_ID") OrElse Not dtFQA.Rows(0).Item("QCResult_ID") = 1 Then
                                MessageBox.Show("The device has failed the FQA. Can't ship it.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                Me.txtDevSN.SelectAll()
                                Exit Sub
                            End If
                        End If
                        'If Convert.ToString(dtAccount.Rows(0)("Account")).Trim.ToUpper = Me._objVinsmart.Vinsmart_SpecialProj_Type3.Trim.ToUpper Then
                        dtFlash = Me._objVinsmart_BoxShip.GetDeviceFlashTestData(strSN)
                        If Not dtFlash.Rows.Count > 0 Then
                            dtFlash = Me._objVinsmart_BoxShip.GetDeviceFlashManual(strSN)
                            If Not dtFlash.Rows.Count > 0 Then
                    ...
                    If cboBoxTypes.Text = "RUR" Then
                        ...
                        Else
                            ...
                            For Each row In dtPretest.Rows
                                ...
                                End If
                            Next
                            If isPrestPass = True Then ' Check if the device has the pass result (Pretest and FQA)
                                dtFQA = Me._objVinsmart_SP.GetDeviceFQAData(iDevice_ID)
                                If dtFQA.Rows.Count = 0 Then
                                    MessageBox.Show("The device has no FQA Info. Can't ship it.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                    Me.txtDevSN.SelectAll()
                                    Exit Sub
                                ElseIf dtFQA.Rows.Count > 0 AndAlso Not dtFQA.Rows(0).IsNull("QCResult_ID") AndAlso dtFQA.Rows(0).Item("QCResult_ID") = 1 Then
                                    MessageBox.Show("The device has passed the pretest and FQA. Wrong Box.", Me._strScreenName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                    Me.txtDevSN.SelectAll()
                                    Exit Sub
                                End If
                            End If
                    ...
                    Else
                        ...
                        Me._objVinsmart_SP.AssignDeviceToPallet(dtDevice.Rows(0)("Device_ID"), CInt(Me.dbgPallets.Columns("Pallett_ID").Value), strDateTime)
                        '***************************************************
        ...
        Private Sub RefreshSNList()
            ...
            Try
                ...
                dt1 = Me._objVinsmart_SP.GetAllSNsForPallet(iPallet_ID)
        ...
        Private Sub btnReopenBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReopenBox.Click
            ...
            Try
                ...
                dt = Me._objVinsmart_SP.GetVinsmartPallettData(strPallet, Me._iMenuCustID)
                ...
                Else
                    i = Me._objVinsmart_SP.ReopenVinsmartBoxByResetting(dt.Rows(0)("Pallett_ID"), strCurrentStation)
                    If i = 0 Then
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                ...
                If iDeviceID > 0 Then
                    ...
                    i = Me._objVinsmart_SP.RemoveSNfromPallet(CInt(Me.dbgPallets.Columns("Pallett_id").Value), iDeviceID)
                    If i = 0 Then
        ...
        Private Sub txt_SNs_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Dim strNextWrkStation As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AQL_OBA_WorkStation
            Dim iDeviceID As Integer = 0
            ...
            Try
                ...
                ElseIf Me.lstDevices.Items.Count > Me._objVinsmart.Vinsmart_SPMaxQtyInBox Then
                    MessageBox.Show("Box can't contain more than " & Me._objVinsmart.Vinsmart_SPMaxQtyInBox.ToString & " units.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Me.txtDevSN.Focus() : Exit Sub
                ...
                i = Me._objVinsmart_SP.CloseVinsmartPallet(Me._iMenuCustID, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _
                ...
                Try
                    ...
                    '************************
                    If CInt(Me.dbgPallets.Columns("Loc_ID").Value) = Me._objVinsmart.Vinsmart_Special_LOC_ID _
                       AndAlso Me.cboLocation.SelectedValue = Me._objVinsmart.Vinsmart_Special_LOC_ID Then
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                ...
                strPallet = strPallet.Trim
                dtTempClosepallet = Me._objVinsmart_SP.CheckOpenPallet(strPallet)
                If dtTempClosepallet.Rows.Count <> 0 Then
                    strPalletId = dtTempClosepallet.Rows(0)("Pallett_id")
                    If CInt(dtTempClosepallet.Rows(0)("Loc_id")) = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Special_LOC_ID Then
        ...
        Private Sub cboProject_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboProject.TextChanged
            'If cboProject.SelectedValue = Me._objVinsmart.Vinsmart_SpecialProj_Type1 Then
        ...
        Private Sub Printlabel(ByVal strPallet_ID As String)
            ...
            Dim strPDF417_Data2 As String = ""
            Dim strSep As String = "@"
            dtPallet_Info = Me._objVinsmart_SP.GetPallet_SN(CInt(strPallet_ID))
            dtLabel = Me._objVinsmart_SP.getLabelTemplate()
            Dim i As Integer
            Dim FontEncoder As New IDAutomation.NetAssembly.FontEncoder()
            ...
            For i = 0 To dtPallet_Info.Rows.Count - 1
                If i = 0 Then
                    ...
                    rowNew("Pallet") = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = FontEncoder.Code128a(strS.Trim)
                    rowNew("PalletCode") = strS
                    strS = dtPallet_Info.Rows(i).Item("Partnumber")
                    rowNew("Partnumber") = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = FontEncoder.Code128a(strS.Trim)
                    rowNew("PartnumberCode") = strS

                    strS = dtPallet_Info.Rows(i).Item("cntry_name")
                    rowNew("CountryOfOrigine") = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = FontEncoder.Code128b(strS.Trim)
                    rowNew("CountryOfOrigineCode") = Me._objVinsmart_SP.ReplaceChar(strS)

                    'rowNew = dtLabel.NewRow
                    strS = dtPallet_Info.Rows(i).Item("PO")
                    rowNew("PO") = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = FontEncoder.Code128a(strS.Trim)
                    rowNew("POCode") = strS
                    strS = dtPallet_Info.Rows(0).Item("Model")
                    rowNew("Model") = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = FontEncoder.Code128a(strS.Trim)
                    ...
                    rowNew("Qty") = iVal
                    'strS = iVal.ToString
                    strS = FontEncoder.Code128a(iVal.ToString.Trim)
                    rowNew("QtyCode") = strS
                ...
                rowNew(strCol) = Me._objVinsmart_SP.ReplaceChar(strS.Trim)
                If strS.Trim.Length > 0 Then strS = FontEncoder.Code128a(strS.Trim)
            ...
            Next
            Dim strReportName1 As String = "Vinsmart_Pallet_SP_Label_25_1.rpt"
            Dim strReportName2 As String = "Vinsmart_Pallet_SP_Label_25_2.rpt"
            'Print Vinsmart_Pallet_Cricket_Label_20
            If dtLabel.Rows.Count > 0 Then
                If dtPallet_Info.Rows.Count < 5 Then
