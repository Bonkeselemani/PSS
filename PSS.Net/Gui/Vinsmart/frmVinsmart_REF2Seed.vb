...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_REF2Seed
        ...
        Private _objVinsmart_REF2Seed As PSS.Data.Buisness.Vinsmart.Vinsmart_REF2Seed
        Private _objVinsmart_Recv As PSS.Data.Buisness.Vinsmart.Vinsmart_Receiving
        'Private _objVinsmart_BoxShip As PSS.Data.Buisness.Vinsmart.Vinsmart_ProduceBox
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCust_ID As Integer, ByVal strScreenName As String)
            ...
            Me._objVinsmart_REF2Seed = New PSS.Data.Buisness.Vinsmart.Vinsmart_REF2Seed()
            Me._objVinsmart_Recv = New PSS.Data.Buisness.Vinsmart.Vinsmart_Receiving()
            'Me._objWIKO_BoxShip = New PSS.Data.Buisness.Vinsmart.Vinsmart_ProduceBox()
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objVinsmart_REF2Seed = Nothing
                    Me._objVinsmart_Recv = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_REF2Seed))
            ...
            Me.lblRecNum.Text = "0"
            '
            'frmVinsmart_REF2Seed
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.BackColor = System.Drawing.Color.LightSteelBlue
            Me.ClientSize = New System.Drawing.Size(888, 718)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.pnlCoolPadModel, Me.btnMoveREF2Seed, Me.lblModel, Me.btnLoadData, Me.cboModel, Me.tdgData1, Me.lblCustomer, Me.cboCustomer, Me.lblLocation, Me.cboLocation, Me.lblRecNum})
            Me.Name = "frmVinsmart_REF2Seed"
            Me.Text = "frmVinsmart_REF2Seed"
...
#End Region
        ...
        Private Sub frmVinsmart_REF2Seed_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub cboLocation_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboLocation.SelectedValueChanged
            ...
            Try
                ...
                If Me.cboLocation.SelectedValue > 0 Then
                    dtModel = Me._objVinsmart_Recv.getModelData(PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Product_ID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnLoadData_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLoadData.Click
            ...
            Try
                ...
                If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then
                    Me._dt = Me._objVinsmart_REF2Seed.GetREF2SeedstockData(Me._iMenuCustID, Me.cboLocation.SelectedValue, Me.cboModel.SelectedValue)
                Else
                    Exit Sub
                End If
        ...
        Private Sub btnMoveREF2Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMoveREF2Seed.Click
            ...
            Dim strTrayMemo As String = "Vinsamrt REF2Seed Receiving"
            ...
            Try
                ...
                With Me.tdgData1
                    For Each iRow In .SelectedRows
                        ...
                        Else
                            If Not Me._objVinsmart_REF2Seed.IsAlreadyUnusedSeedstockDevice(Me._iMenuCustID, .Columns("SN").CellText(iRow).ToString.Trim) Then
                ...
                If strDevice_IDs.Trim.Length > 0 Then
                    'getWorkOrderID
                    iWO_ID = Me._objVinsmart_REF2Seed.GetWorkOrderID(Me._iMenuCustID, iLoc_ID)

                    If Not iWO_ID > 0 Then MessageBox.Show("Invalid WO_ID.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning) : Exit Sub

                    dt = Me._objVinsmart_REF2Seed.ProcessREF2Seedstock(Me._iMenuCustID, iLoc_ID, iWO_ID, strDevice_IDs, strDevice_SNs)
                    ...
                    iTray_ID = Me._objVinsmart_Recv.getTayID(Me._iUserID, Me._strUser, iWO_ID, strTrayMemo)
                    ...
                    For Each row In dt.Rows
                        ...
                        strManufDate = Me._objVinsmart_REF2Seed.GetManufDate(strSN, strDevice_IDs)

                        If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID Then
                            bReceived = Me._objVinsmart_Recv.ReceiveDataIntoSystem(iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
