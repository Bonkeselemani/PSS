...
Namespace Gui.Vinsmart
    ...
    Public Class frmVinsmart_SpecialReceiving
        ...
        Private bcArrayList As ArrayList
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_SpecialReceiving))
            ...
            'Button3
            '
            Me.Button3.Location = New System.Drawing.Point(848, 112)
            ...
            'Button2
            '
            Me.Button2.Location = New System.Drawing.Point(848, 56)
            ...
            'rtIMEI
            '
            Me.rtIMEI.Location = New System.Drawing.Point(680, 56)
            ...
            'listDevices
            '
            Me.listDevices.Location = New System.Drawing.Point(1048, 64)
            ...
            'rd2Dbarcode
            '
            Me.rd2Dbarcode.Location = New System.Drawing.Point(480, 80)
            ...
            Me.rd1dBarcode.Location = New System.Drawing.Point(368, 80)
            ...
            Me.txtListSN.Location = New System.Drawing.Point(688, 16)
            ...
            Me.lblBoxName.Location = New System.Drawing.Point(360, 112)
            ...
            Me.txtMaxBoxQty.Location = New System.Drawing.Point(496, 48)
            ...
            Me.lblMaxBoxQty.Location = New System.Drawing.Point(368, 56)
            ...
            Me.txtReceivedQty.Location = New System.Drawing.Point(496, 15)
            ...
            Me.lblReceivedQty.Location = New System.Drawing.Point(368, 24)
            ...
            Me.tdgDeviceData.Location = New System.Drawing.Point(8, 168)
            ...
            Me.tdgDeviceData.Size = New System.Drawing.Size(424, 384)
            ...
            "=""17"" VerticalScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>382</Height><Cap" & _
            ...
            "><Style parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 422, 382</ClientRect><Bo" & _
            ...
            "17</DefaultRecSelWidth><ClientArea>0, 0, 422, 382</ClientArea><PrintPageHeaderSt" & _
            ...
            Me.btnCloseBox.Location = New System.Drawing.Point(448, 168)
            ...
            Me.GroupBox1.Location = New System.Drawing.Point(448, 408)
            ...
            Me.cboModel.Location = New System.Drawing.Point(120, 53)
            ...
            Me.lblSN.Location = New System.Drawing.Point(8, 114)
            Me.lblSN.Name = "lblSN"
            ...
            Me.lblLocation.Location = New System.Drawing.Point(8, 24)
            ...
            Me.lblBcCount.Location = New System.Drawing.Point(120, 144)
            Me.lblBcCount.Name = "lblBcCount"
            Me.lblBcCount.Size = New System.Drawing.Size(216, 16)
            Me.lblBcCount.TabIndex = 202
            Me.lblBcCount.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
            '
            'frmVinsmart_SpecialReceiving
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.ClientSize = New System.Drawing.Size(680, 598)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TabControl1})
            Me.Name = "frmVinsmart_SpecialReceiving"
            Me.Text = "frmVinsmart_SpecialReceiving"
...
#End Region
        ...
        Private Sub frmVinsmart_SpecialReceiving_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                Me._RecvVinsmartDT = Me._objVinsmart_SP.getVinsmartRecvTableDef
        ...
        End Sub
        Private Sub ProcessSN(ByVal strImeiNbr As String)
            Dim strSN As String = ""
            ...
            Dim iMaxQty As Integer = Me._objVinsmart.Vinsmart_SPMaxQtyInBox
            ...
            Try
                ...
                strSN = strImeiNbr
                strPallett_name = Me.txtPallett_Id.Text.Trim
                ...
                Else
                    dt = Me._objVinsmart_Receiving.getReceivingData(Me._iMenuCustID, Me._iMenuLocID, strSN)
                    If dt.Rows.Count = 0 Then
                        MessageBox.Show(String.Concat("Can't find the SN.", vbCrLf, strImeiNbr), "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            ...
                            Else 'ok
                                ...
                                Else 'Ready to receive 
                                    ...
                                    Else 'Validate with recev data
                                        Dim strValidatedMsg As String = Me.GoValidation(Me._iMenuLocID, Me._RecvVinsmartDT, strSN, strASN_IN_ITEM_SKU, iMaxQty).Trim
                                    ...
                                    bReceived = Me._objVinsmart_Receiving.ReceiveDataIntoSystem(Me._iMenuLocID, iWO_ID, iModel_ID, strSN, strManufDate, _
            ...
            Try
                ...
                With Me.tdgDeviceData
                    ...
                    For Each dbgc In .Splits(0).DisplayColumns
                        ...
                        dbgc.AutoSize()
                    Next dbgc
                    If Me._iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then
            ...
            Try
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    ...
                    If i > 0 Then
                        ...
                        'If Me._iMenuLocID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Special_LOC_ID OrElse Me._iLoc_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID Then
                        ...
                        Me._objVinsmart_Receiving.PrintReceivedBoxLabel(Me._strRecvBoxName, Me._RecvVinsmartDT.Rows.Count, Me._RecvVinsmartDT.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                                             Me._RecvVinsmartDT.Rows(0).Item("PSS_Model"), "", "", _
                    ...
                    Me._RecvVinsmartDT = Me._objVinsmart_Receiving.getVinsmartRecvTableDef : Me.cboLocation.Enabled = True : Me.cboModel.Enabled = True : Me.txtPallett_Id.Enabled = True
            ...
            Try
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    If Me.txtSN.Text.Trim.Length > 0 And txtPallett_Id.Text.Trim.Length > 0 Then
                        bcCount = PopulateBarcodeArray()
                        Select Case bcCount
                            Case Is = 1
                                lblBcCount.Text = String.Concat(bcCount, "  IMEI number scanned")
                            Case Else
                                lblBcCount.Text = String.Concat(bcCount, "  IMEI numbers scanned")
                        End Select

                        If bcCount > 0 Then
                            For i = 0 To bcArrayList.Count - 1 Step 1
                                ProcessSN(bcArrayList.Item(i))
                            Next
                        End If
        ...
        Private Function PopulateBarcodeArray() As Int32
            'Split the input string into an array using a comma (,) delimiter
            ...
            Try
                ...
                strSN = txtSN.Text.Split(",")
                If strSN.Length > 0 Then
                    For i = 0 To strSN.Length - 1 Step 1
                        ImeiOrIccidCheck(strSN(i))
                    Next
                End If
                Return bcArrayList.Count
        ...
        Private Sub ImeiOrIccidCheck(ByVal strNbr As String)
            'Determine if the number is IMEI or ICCID.  If IMEI, add to the array list
            Try
                If strNbr.Length < 20 And strNbr.Length > 10 And IsNumeric(strNbr) Then
                    bcArrayList.Add(strNbr)
                End If
            Catch ex As Exception
                MessageBox.Show(ex.ToString)
            End Try
        ...
        Private Sub txtPallett_Id_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtPallett_Id.KeyUp
            If e.KeyCode = Keys.Enter Then
                SendKeys.Send("{TAB}")
            End If
        End Sub
        ...
        Private Sub txtSN_GotFocus(ByVal sender As Object, ByVal e As EventArgs) Handles txtSN.GotFocus
            txtSN.BackColor = Color.Yellow
        End Sub

        Private Sub txtPallett_ID_GotFocus(ByVal sender As Object, ByVal e As EventArgs) Handles txtPallett_Id.GotFocus
            txtPallett_Id.BackColor = Color.Yellow
        End Sub

        Private Sub txtSN_LostFocus(ByVal sender As Object, ByVal e As EventArgs) Handles txtSN.LostFocus
            txtSN.BackColor = Color.White
        End Sub

        Private Sub txtPallett_ID_LostFocus(ByVal sender As Object, ByVal e As EventArgs) Handles txtPallett_Id.LostFocus
            txtPallett_Id.BackColor = Color.White
        End Sub
