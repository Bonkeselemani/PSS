...
Namespace Gui.Vinsmart
    Public Class frmVinsmart_RFTest
        ...
        Private _objRF As PSS.Data.Buisness.Vinsmart.Vinsmart_RFTest
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strSreenname As String, ByVal iCustID As Integer, ByVal iTestTypeID As Integer)
            ...
            _objRF = New PSS.Data.Buisness.Vinsmart.Vinsmart_RFTest()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVinsmart_RFTest))
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnManuallyAddRec, Me.btnSave, Me.btnFail, Me.Label3, Me.btnClear, Me.lblWrtyStatus, Me.btnPass, Me.lblDevRepType, Me.lblDateCode, Me.Panel1, Me.Panel2, Me.pnlFailCodes, Me.Panel3})
            Me.Name = "frmVinsmart_RFTest"
            Me.Text = "frmVinsmart_RFTest"
...
#End Region
        ...
        Private Sub frmVinsmart_RFTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim i As Integer = 0
            ...
            Try
                ...
                ElseIf Generic.GetCustIDByMachine() = _iMenuCustID Then
                    GoTo loadproduct
                Else
                    MessageBox.Show("Please select RF Test submenu from " & _strGroup.ToUpper & "  Menu ", "Check " & _strGroup.ToUpper & "Menu", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                    Me.Enabled = False
                    Exit Sub
                End If
            ...
            Try
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._objRF.InsertRFVinsmart(PSS.Core.Global.ApplicationUser.IDuser, Me.lblSN.Text, _iRFResult) Then
                            Me.LoadTestHistory(Me._iDevice_ID)
                        Else
                        End If
                        Me.txtDeviceSN.SelectAll()
