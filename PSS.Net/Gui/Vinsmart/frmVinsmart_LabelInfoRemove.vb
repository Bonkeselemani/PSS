...
Namespace Gui.Vinsmart
    Public Class frmVinsmart_LabelInfoRemove
...
#Region " Windows Form Designer generated code "
        Public Sub New(ByVal strIMEI As String)
            ...
            Me._objVinsmartLabel = New PSS.Data.Buisness.Vinsmart.Vinsmart_label()
            Me._strIMEI = strIMEI
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Name = "frmVinsmart_LabelInfoRemove"
            Me.Text = "frmVinsmart_LabelInfoRemove"
...
#End Region
        ...
        Private Sub frmVinsmart_LabelInfoRemove_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                Me.CenterToParent()
        ...
        Private Sub txtIMEI_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtIMEI.KeyUp
            ...
            Try
                If e.KeyCode = Keys.Enter AndAlso Me.txtIMEI.Text.Trim.Length > 0 Then
                    ...
                    dt = Me._objVinsmartLabel.getUnshippedDeviceData(strIMEI)
                    ...
                    Else '=1
                        ...
                        Me._objVinsmartLabel.RemoveLabelInfo(iDevice_ID)
                        Me.txtIMEI.Text = ""
                        Me.txtIMEI.SelectAll() : Me.txtIMEI.Focus()
                    End If
                End If
