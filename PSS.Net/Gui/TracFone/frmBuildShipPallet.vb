...
Namespace Gui.TracFone
    Public Class frmBuildShipPallet
        ...
        Private _bIsNTF_TriageBilled As Boolean = False
...
#End Region
        ...
        Private Sub frmTracFone_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                '******************************************
                dt = Me._objTFBuildShipPallet.GetModelsWithMotoSku(False)
        ...
        Private Sub ProcessTracFoneSN()
            ...
            Dim dtDevice, dtNTF, dtNTF_Bill As DataTable
            ...
            Try
                ...
                Else '1 row
                    'Check NTF, NTF Bill=======================================================================================
                    Me._bIsNTF = False
                    dtNTF = PSS.Data.Buisness.TracFone.clsMisc.GetNTFDeviceID(dtDevice.Rows(0)("Device_ID"), Me._iMenuCustID)
                    If dtNTF.Rows.Count > 0 Then 'NTF device
                        Me._bIsNTF = True
                        dtNTF_Bill = Me._objTFBuildShipPallet.GetDeviceAdditionalBillData(dtDevice.Rows(0)("Device_ID"))
                        If dtNTF_Bill.Rows.Count >= 2 Then
                            Me._bIsNTF_TriageBilled = True
                        Else
                            MsgBox("This device is NTF, but has no valid triage bill data (either receiving or triaged billing).", MsgBoxStyle.Information, "Information")
                            Me.txtDevSN.SelectAll()
                            Exit Sub
                        End If
                        dtNTF_Bill = Nothing
                    ...
                    ElseIf dtDevice.Rows(0)("Model_Desc") <> Me.dbgPallets.Columns("Model_Desc").Value Then
                        ...
                        Me.txtDevSN.Text = ""
                    ElseIf Me._bIsNTF = False AndAlso CInt(Me.dbgPallets.Columns("Pallet_ShipType").Value) = 0 AndAlso IsDBNull(dtDevice.Rows(0)("Device_DateBill")) Then
                        MsgBox("This device has not been billed.", MsgBoxStyle.Information, "Information")
                        Me.txtDevSN.Text = ""
                    ElseIf Me._bIsNTF = False AndAlso Me._objTFBuildShipPallet.CheckDeviceShipType(CInt(Me.dbgPallets.Columns("Pallet_ShipType").Value), dtDevice.Rows(0)("Device_ID"), booFailUnitHasPart) = False Then
                        Me.txtDevSN.SelectAll()
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Try
                ...
                If Me._iMenuCustID > 0 Then
                    ...
                    If strNextWrkStation.Trim.Length > 0 Then Generic.SetTcelloptWorkStationForPallet(strNextWrkStation, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name)
                End If
