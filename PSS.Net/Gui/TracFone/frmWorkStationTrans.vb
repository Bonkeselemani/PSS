...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents btnCompleteWHForWklyShipment As System.Windows.Forms.Button
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.btnCompleteWHForWklyShipment = New System.Windows.Forms.Button()
            ...
            'grbTransfer
            '
            Me.grbTransfer.Controls.AddRange(New System.Windows.Forms.Control() {Me.rbtnBoxID, Me.pnlTransfToLoc, Me.Panel2, Me.btnCancel, Me.btnTransfer, Me.txtBoxID, Me.Panel1, Me.rbtnSN, Me.btnCompleteWHForWklyShipment})
            ...
            Me.grbTransfer.Size = New System.Drawing.Size(784, 256)
            ...
            Me.rbtnSN.Text = "IMEI"
            '
            'btnCompleteWHForWklyShipment
            '
            Me.btnCompleteWHForWklyShipment.BackColor = System.Drawing.Color.Blue
            Me.btnCompleteWHForWklyShipment.Location = New System.Drawing.Point(424, 200)
            Me.btnCompleteWHForWklyShipment.Name = "btnCompleteWHForWklyShipment"
            Me.btnCompleteWHForWklyShipment.Size = New System.Drawing.Size(312, 40)
            Me.btnCompleteWHForWklyShipment.TabIndex = 3
            Me.btnCompleteWHForWklyShipment.Text = "Complete This Week Shipment"
            '
            'grbSearch
            '
            ...
            Me.grbSearch.Size = New System.Drawing.Size(784, 248)
            ...
            Me.dbgData.Size = New System.Drawing.Size(768, 158)
            ...
            " 0, 764, 154</ClientRect><BorderSide>0</BorderSide><BorderStyle>Sunken</BorderSt" & _
            ...
            "/Layout><DefaultRecSelWidth>17</DefaultRecSelWidth><ClientArea>0, 0, 764, 154</C" & _
...
#End Region
        ...
        Private Sub frmWorkStationTrans_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                If Me._strScreenName = "To Staging" OrElse Me._strScreenName = "To Pretest" _
                   OrElse Me._strScreenName = "To Prebill" OrElse Me._strScreenName = "To RF1" _
                   OrElse Me._strScreenName = "To WH-RB" OrElse Me._strScreenName = "To WH-WIP" _
                   OrElse Me._strScreenName = "To Teardown" OrElse Me._strScreenName = "To BER" _
                   OrElse Me._strScreenName = "To BER Complete" OrElse Me._strScreenName = "To BER Screen" _
                   OrElse Me._strScreenName = "To Obsolete" OrElse Me._strScreenName = "To Production Hold" _
                   OrElse Me._strScreenName = "To QUARANTINE" Then
                ...
                Else
                    ...
                    Me.Panel1.Visible = False
                    Me.Panel2.Visible = True
                    Me.rbtnSN.Checked = True : Me.rbtnBoxID.Checked = False
                ...
                If _strScreenName = "To WH-RB" Then Me.btnCompleteWHForWklyShipment.Visible = True Else Me.btnCompleteWHForWklyShipment.Visible = False
        ...
        Private Function ProcessBox_Staging_Pretest_Prebill_Obsolete_ProdHold()
            ...
            Try
                ...
                ElseIf dt.Rows(0)("Closed").ToString = "0" Then
                    ...
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
                ElseIf Me._strScreenName = "To Obsolete" AndAlso Not IsDBNull(dt.Compute("Sum(PartCharge)", "")) AndAlso dt.Compute("Sum(PartCharge)", "") > 0 Then
                    MessageBox.Show("Box contains units with parts assigned. Please remove all parts.", "ProcessBox", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
            ...
            Try
                ...
                Else
                    If Me._strScreenName.Trim.StartsWith("To Functional Fail") = True Then
                        ...
                        i = Generic.SetTcelloptWorkStationForDevice(Mid(Me._strScreenName.ToUpper, 4), dt.Rows(0)("Device_ID"), Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, , , , , , )
                        If i > 0 Then Me._objTFMisc.RemoveWarehouseBox(dt.Rows(0)("Device_ID"))
                    ElseIf Me._strScreenName.Trim.StartsWith("To QUARANTINE") = True Then
                        i = Generic.SetTcelloptWorkStationForDevice(Mid(Me._strScreenName.ToUpper, 4), dt.Rows(0)("Device_ID"), Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, , , , , , )
                        If i > 0 Then Me._objTFMisc.RemoveWarehouseBox(dt.Rows(0)("Device_ID"))
                    Else
                        i = Generic.SetTcelloptWorkStationForDevice(Mid(Me._strScreenName.ToUpper, 4), dt.Rows(0)("Device_ID"), Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, 6, , , , , )
                        If i > 0 Then Me._objTFMisc.RemoveWarehouseBox(dt.Rows(0)("Device_ID"))
                    End If
        ...
        Private Function ProcessBox_WHWIP() As String
            ...
            Try
                ...
                If dt.Rows.Count = 0 Then
                    MessageBox.Show("This Box ID does not exist.", "ProcessBox", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
                ElseIf dt.Select("WorkStation = 'PRODUCTION STAGING'").Length > 0 AndAlso dt.Rows.Count > 1 Then
                    MessageBox.Show("This Box has multiple workstation.", "ProcessBox", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
                ElseIf dt.Rows(0)("WorkStation").ToString.Trim.Length = 0 Then
                    MessageBox.Show("This Box does not belong to any workstation.", "ProcessBox", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
                ElseIf Misc.Triaged_Device(txtBoxID.Text) = False Then
                    MessageBox.Show("This screen does not accept any unit from NTF.", "ProcessBox", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtBoxID.Text = "" : Me.txtBoxID.Focus()
            ...
            Try
                ...
                Else
                    ...
                    Else
                        ...
                        i = Generic.SetTcelloptWorkStationForDevice(Me.cboTranfToLoc.Text, iDeviceID, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, , , , , , )
                        If i > 0 Then Me._objTFMisc.RemoveWarehouseBox(dt.Rows(0)("Device_ID"))
        ...
        Private Function ProcessTo_Quantine_AWAP_Engineering()
            ...
            Try
                ...
                Else
                    ...
                    i = Generic.SetTcelloptWorkStationForDevice(strNextStation, iDeviceID, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name, iWipOwner, , , , , )
                    If i > 0 Then Me._objTFMisc.RemoveWarehouseBox(dt.Rows(0)("Device_ID"))
                    ...
                    If Me._strScreenName = "To Staging" Or Me._strScreenName = "To Pretest" Or Me._strScreenName = "To Prebill" Or Me._strScreenName = "To RF1" _
                       Or Me._strScreenName = "To Obsolete" Or Me._strScreenName = "To Production Hold" Then
                        ...
                        If Me._booValidBoxData = True Then
                            ...
                            Else
                                i = Me._objTFMisc.PushWBBoxToWorkArea(Me.txtBoxID.Text.Trim, strNextStation, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name)
                                If i > 0 Then
                    ...
                    ElseIf Me._strScreenName = "To WH-RB" Then
                        ...
                        If Me._booValidBoxData = True AndAlso Me._iPalletID > 0 Then
                            ...
                            If strNextStation.Trim.Length = 0 Then
                                MessageBox.Show("Workstation is missing in work flow. Please contact IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Else
                                i = Me._objTFMisc.PushShipBoxToNextStation(Me._iPalletID, strNextStation, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name)
                                If i > 0 Then
                                    MessageBox.Show("Completed.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                    Me.ResetVariablesAndCtrls()
                                    Me.txtBoxID.Focus()
                    ...
                    ElseIf Me._strScreenName = "To WH-WIP" Then
                        ...
                        If Me._booValidBoxData = True Then
                            ...
                            If strNextStation.Trim.Length = 0 Then
                                MessageBox.Show("Workstation is missing in work flow. Please contact IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                            Else
                                i = Me._objTFMisc.PushWBBoxToWHWIP(Me.txtBoxID.Text.Trim, strNextStation, strAcceptedStation, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name)
                                If i > 0 Then
                                    MessageBox.Show("Completed.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                                    Me.ResetVariablesAndCtrls()
                                    Me.txtBoxID.Focus()
        ...
        Private Sub btnCompleteWHForWklyShipment_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCompleteWHForWklyShipment.Click
            Dim dt As DataTable
            Dim strToday, strDateStart, strDateEnd As String
            Dim i As Integer = 0
            Try
                strToday = Generic.MySQLServerDateTime(1)
                If Convert.ToDateTime(strToday).DayOfWeek() = DayOfWeek.Monday Then
                    strDateStart = Convert.ToDateTime(strToday).ToString("yyyy-MM-dd")
                Else
                    strDateStart = DateAdd(DateInterval.Day, (Convert.ToDateTime(strToday).DayOfWeek() - 1) * -1, Convert.ToDateTime(strToday)).ToString("yyyy-MM-dd")
                End If

                strDateEnd = DateAdd(DateInterval.Day, 6, (Convert.ToDateTime(strToday))).ToString("yyyy-MM-dd")
                dt = Me._objTFMisc.GetPlannedShipment(strDateStart, strDateEnd)

                If (dt.Rows.Count > 0) AndAlso _
                        MessageBox.Show(dt.Rows(0)("User_FullName") & " has completed this week shipment" & ". Do you want to send another report?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No Then
                    Exit Sub
                ElseIf dt.Rows.Count = 0 AndAlso _
                        MessageBox.Show("Are you sure you have completed this week shipment?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No Then
                    Exit Sub
                Else
                    i = Me._objTFMisc.CreatePlannedShipment(Core.ApplicationUser.IDuser)
                    MessageBox.Show("System will create and email report within 10 minutes.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                End If
            Catch ex As Exception
                MessageBox.Show(ex.ToString, "WH-RB Completion", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        End Sub
