...
#End Region
        ...
        Private Sub txtBoxID_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtBoxID.KeyUp
            Try
                ...
                End If
            Catch ex As Exception
                MessageBox.Show(ex.Message, "txtBoxID_KeyUp", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            End Try
        End Sub
        ...
        Private Function ProcessBox(ByVal strWHBoxID As String) As Boolean
            ...
            Try
                ...
                Else
                    ...
                    If Me._iModelID = 0 Then Throw New Exception("Model ID is missing.")
            ...
            Try
                ...
                If Me.txtBoxID.Text.Trim.Length > 0 Then
                    If ProcessBox(Me.txtBoxID.Text.Trim) = True Then
                        ...
                        Else
                            Dim i As Integer = Me._objTFMisc.CompletedBERScreenBox(Me.txtBoxID.Text.Trim, Me._iOrderID, Me._iModelID, Core.ApplicationUser.IDuser, Me._strScreenName, Me.Name)
                            If i > 0 Then
                ...
                End If
            Catch ex As Exception
                MessageBox.Show(ex.Message, "btnTransfer_Click", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            Finally
