...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnManuallyAddRec, Me.lblDevRepType, Me.lblDateCode, Me.lblWrtyStatus, Me.Panel3, Me.btnSave, Me.pnlFailCodes, Me.Panel1, Me.btnFail, Me.btnPass, Me.Label3, Me.Panel2, Me.btnClear})
            Me.Name = "frmTFRF"
            Me.Text = "frmTFRF"
...
loadproduct:    dt = Generic.GetProductByCustID(True, Me._iMenuCustID)
        ...
        Private Sub ProcessSN()
            ...
            Try
                ...
                ' Check FQA Result FOR WIKO AND COOLPAD VINSMART
                If _iMenuCustID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID _
                    Or _iMenuCustID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID _
 Or _iMenuCustID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID _
                    Or _iMenuCustID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
