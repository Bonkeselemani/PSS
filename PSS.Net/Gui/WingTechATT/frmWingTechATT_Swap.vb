...
Namespace Gui.WingTechATT
    Public Class frmWingTechATT_Swap
        ...
        Private _objWingTechATT_Swap As PSS.Data.Buisness.WingTechATT.WingTechATT_Swap
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objWingTechATT_Swap = New PSS.Data.Buisness.WingTechATT.WingTechATT_Swap()
        ...
        Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
            If disposing Then
                Try
                    ...
                    Me._objWingTechATT_Swap = Nothing
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_Swap))
            ...
            Me.Name = "frmWingTechATT_Swap"
            Me.Text = "frmWingTechATT_Swap"
...
#End Region
        ...
        Private Sub frmWingTechATT_Swap_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub btnSwap_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            '    dbgSource.DataSource = _objWingTechATT_Swap.updatedbg(lSeedstock, SN)
            'End If
        End Sub
            ...
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtSwappedSN.Text.Trim.Length > 0 Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_OrderTypeBulk_ID)
        ...
        Private Sub txtSeedStockSN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSeedStockSN.KeyUp
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtSwappedSN.Text.Trim.Length > 0 AndAlso Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
                        Me.ProcessSN(PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_OrderTypeSeedStock_ID)
                    End If
                End If
            Catch ex As Exception
        ...
        Private Sub ProcessSN(ByVal iSN_Type As Integer)
            ...
            Try
                If iSN_Type = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_OrderTypeBulk_ID Then
                    Me.txtSeedStockSN.Enabled = False
                    ...
                    Me._dtBulk = Me._objWingTechATT_Swap.getDeviceData(Me._iCust_ID, Me.cboLocation.SelectedValue, strSN, iSN_Type, "")
                    ...
                    Else '=1
                        ...
                        dtBill = Me._objWingTechATT_Swap.getDeviceBillData(iBulk_Device_ID)
                        ...
                        End If
                    End If
                ElseIf iSN_Type = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_OrderTypeSeedStock_ID Then
                    strSN = Me.txtSeedStockSN.Text.Trim
                    Dim strWingTechATTCricketOrATT As String = ""
                    Dim iLoc_ID As Integer = 0

                    If Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
                        ...
                        If iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                            strWingTechATTCricketOrATT = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_Cricket.Trim
                        ElseIf iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID OrElse iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                            strWingTechATTCricketOrATT = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_ATT.Trim
                        Else
                            MessageBox.Show("Can't determine WingTechATT Location. See IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            Me.txtSeedStockSN.SelectAll() : Me.txtSeedStockSN.Focus() : Exit Sub
                        End If
                    End If

                    dtSeedStock = Me._objWingTechATT_Swap.getDeviceData(Me._iCust_ID, Me.cboLocation.SelectedValue, strSN, iSN_Type, strWingTechATTCricketOrATT)
                    ...
                    Else '=1
                        ...
                        If Me._objWingTechATT_Swap.Has_Swap_Bill_Code(iSeeStock_Device_ID, PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_BillCode_ID) Then
                            ...
                            Me.txtSeedStockSN.SelectAll() : Me.txtSeedStockSN.Focus() : Exit Sub
                        End If
                        'dtBill = Me._objWingTechATT_Swap.getDeviceBillData(iSeeStock_Device_ID)
                        ...
                        If Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID _
                           AndAlso (Me._iModel_ID = 5251 OrElse Me._iModel_ID = 5252) _
                           AndAlso (Convert.ToInt32(dtSeedStock.Rows(0).Item("Model_ID")) = 5251 OrElse Convert.ToInt32(dtSeedStock.Rows(0).Item("Model_ID")) = 5252) Then
                        ...
                        If Me._dtBulk.Rows.Count = 1 AndAlso dtSeedStock.Rows.Count = 1 Then
                            ...
                            Dim iLaborLevel As Integer = 0 ' PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_LabelLevel
                            Dim iPrcGroup_ID As Integer = 0 'PSS.Data.Buisness.CPWingTechATT.WingTechATT.WingTechATT_PrcGroup_ID
                            Dim iPsPRice_ID As Integer = 0 'PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_PSPrice_ID
                            Dim iSwap_BillCode_ID As Integer = 0 'PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_BillCode_ID
                            Dim strWorkStation As String = "" 'PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_DeviceSwap_WorkStation
                            ...
                            If Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
                                iLaborLevel = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_LabelLevel
                                iPrcGroup_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_PrcGroup_ID
                                iPsPRice_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_PSPrice_ID
                                iSwap_BillCode_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Swap_BillCode_ID
                                strWorkStation = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_DeviceSwap_WorkStation
                            ...
                            If MsgBox("Do you want to swap it now?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                'get labor charge
                                dtTmp = Me._objWingTechATT_Swap.getLaborChargeData(iLaborLevel, iPrcGroup_ID)
                                ...
                                End If
                                'Get part number
                                dtTmp = Me._objWingTechATT_Swap.getPartNumberData(iPsPRice_ID)
                                If Not dtTmp.Rows.Count > 0 Then
                                ...
                                'Update
                                k = Me._objWingTechATT_Swap.UpdateSwappedData(iSeeStock_Device_ID, iBulk_Device_ID, iSwap_BillCode_ID, strPartNum, Me._iUserID, strDateTime, _
                                                                        dLaborCharge, dPartCharge, iLaborLevel, strWorkStation, iLoc_ID)
        ...
        Private Sub CheckSwapDevice(ByVal dt As DataTable, ByVal dtBill As DataTable, ByRef strMsg As String, ByRef bIsNormalRepairedDevice As Boolean)
            ...
            If Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then 'WingTechATT ===============================================================================
                foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_BER_BillCode_ID) 'BER
                If foundRows.Length > 0 Then
                    strMsg = "" : Exit Sub
                Else
                    foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_RUR_BillCode_ID) 'RUR Physical Abuse
                    If foundRows.Length > 0 Then
                    ...
                    Else
                        foundRows = dtBill.Select("BillCode_ID=" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_RUR_BillCode_ID2) 'RUR Liquid Damage
                        If foundRows.Length > 0 Then
                    ...
                    End If
                End If
            ElseIf Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then  'WingTechATT Cricket =====
                ...
                End If
            ElseIf Me._iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID AndAlso (iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID _
                   OrElse iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID) Then 'WingTechATT ATT CTDI and FedEx ======================================================
                If Not dt.Rows(0).IsNull("VendorID") Then strATT_WexPos = Convert.ToString(dt.Rows(0).Item("VendorID"))
                If strATT_WexPos.Trim.ToUpper = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_PosCode.Trim.ToUpper Then strMsg = "Device is POS. We are holding this and it is not eligible for swap now." : Exit Sub
