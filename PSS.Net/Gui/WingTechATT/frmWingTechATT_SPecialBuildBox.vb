...
Namespace Gui.WingTechATT
    ...
    Public Class frmWingTechATT_SPecialBuildBox
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_SPecialBuildBox))
            ...
            Me.lblScreenName.Text = "WingTechATT SPECIAL BUILD SHIP BOX"
            ...
            '
            'frmWingTechATT_SPecialBuildBox
            '
            ...
            Me.Name = "frmWingTechATT_SPecialBuildBox"
            Me.Text = "frmWingTechATT_SPecialBuildBox"
...
#End Region
        ...
        Private Sub frmWingTechATT_SPecialBuildBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                Me.cboModel.SelectedValue = Me._objWingTechATT.WingTechATT_SpecialProjType2_MODEL_ID
                ...
                dtPrjType = Me._objWingTechATT_SP.GetWingTechATTProjectTypes(Me._iMenuCustID, Me._iMenuLocID, True)
                Misc.PopulateC1DropDownList(Me.cboProject, dtPrjType, "PrjType_Desc", "PrjType_Name")
                Me.cboProject.SelectedValue = Me._objWingTechATT.WingTechATT_SpecialProj_Type2
                Me.cboProject.Enabled = True
                cboProject.Focus()

                dtType = Me._objWingTechATT_SP.GetWingTechATTShipBoxTypes(True)
        ...
        Private Sub PopulateOpenBoxs(Optional ByVal iPallettID As Integer = 0)
            ...
            Try
                ...
                Me.panelPallet.Visible = False
                'Me.btnCreateBoxID.Visible = False
                dt = Me._objWingTechATT_SP.GetWingTechATTOpenPallets(Me._iMenuCustID, Me.cboLocation.SelectedValue)
        ...
        Private Sub btnCreateBoxID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateBoxID.Click
            ...
            Try
                ...
                If cboProject.SelectedValue = Me._objWingTechATT.WingTechATT_SpecialProj_Type2 Then
                ...
                Else
                    ...
                    If cboProject.SelectedValue = Me._objWingTechATT.WingTechATT_SpecialProj_Type1 Then
                    ...
                    Me._iPallett_ID = Me._objWingTechATT_SP.CreateBoxID(Me.cboModel.SelectedValue, Me.cboBoxTypes.SelectedValue, _
                                                                      Me.txtPOnum.Text, _
        ...
        Private Sub ProcessWingTechATTSN()
            ...
            Try
                ...
                '***************************************************
                If Me.lstDevices.Items.Count >= PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SPMaxQtyInBox Then
                ...
                End If
                i = 0
                dtDevice = Me._objWingTechATT_SP.GetDeviceInfoInWIP(Me.txtDevSN.Text.Trim, _iMenuLocID)
                ...
                Else '1 row
                    ...
                    dtCntryOrgn = Me._objWingTechATT_SP.GetCountryAndAccount(Me.txtDevSN.Text.Trim, _iMenuCustID, _iMenuLocID)
                    ...
                    Else
                        ...
                        Else
                            ...
                            dtdtCntryOrgnList = Me._objWingTechATT_SP.GetCountryAndAccount(strIMEI, _iMenuCustID, _iMenuLocID)
                    ...
                    dtPretest = Me._objWingTechATT_SP.GetDevicePretest(iDevice_ID)
                    ...
                    dtAccount = Me._objWingTechATT_SP.GetDeviceAccount(iDevice_ID)
                    ...
                    ElseIf Convert.ToString(dtAccount.Rows(0)("Account")).Trim.ToUpper = Me._objWingTechATT.WingTechATT_SpecialProj_Type3.Trim.ToUpper Or _
                        Convert.ToString(dtAccount.Rows(0)("Account")).Trim.ToUpper = Me._objWingTechATT.WingTechATT_SpecialProj_Type4.Trim.ToUpper Then

                        dtSIMCardMariage = Me._objWingTechATT_SP.GetDeviceSIMcard(iDevice_ID, Convert.ToString(dtAccount.Rows(0)("Account")).Trim.ToUpper)
                    ...
                    dtAQL = Me._objWingTechATT_SP.GetDeviceAQLData(iDevice_ID)
                    ...
                    If Convert.ToString(dtAccount.Rows(0)("Account")).Trim.ToUpper = Me._objWingTechATT.WingTechATT_SpecialProj_Type3.Trim.ToUpper Then
                        dtFlash = Me._objWingTechATT_BoxShip.GetDeviceFlashTestData(strSN)
                        If Not dtFlash.Rows.Count > 0 Then
                            dtFlash = Me._objWingTechATT_BoxShip.GetDeviceFlashManual(strSN)
                            If Not dtFlash.Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        Me._objWingTechATT_SP.AssignDeviceToPallet(dtDevice.Rows(0)("Device_ID"), CInt(Me.dbgPallets.Columns("Pallett_ID").Value), strDateTime)
                        '***************************************************
        ...
        Private Sub RefreshSNList()
            ...
            Try
                ...
                dt1 = Me._objWingTechATT_SP.GetAllSNsForPallet(iPallet_ID)
        ...
        Private Sub btnReopenBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReopenBox.Click
            ...
            Try
                ...
                dt = Me._objWingTechATT_SP.GetWingTechATTPallettData(strPallet, Me._iMenuCustID)
                ...
                Else
                    i = Me._objWingTechATT_SP.ReopenWingTechATTBoxByResetting(dt.Rows(0)("Pallett_ID"), strCurrentStation)
                    If i = 0 Then
        ...
        Private Sub btnRemoveSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveSN.Click
            ...
            Try
                ...
                If iDeviceID > 0 Then
                    ...
                    i = Me._objWingTechATT_SP.RemoveSNfromPallet(CInt(Me.dbgPallets.Columns("Pallett_id").Value), iDeviceID)
                    If i = 0 Then
        ...
        Private Sub btnCloseBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseBox.Click
            ...
            Try
                ...
                ElseIf Me.lstDevices.Items.Count > Me._objWingTechATT.WingTechATT_SPMaxQtyInBox Then
                    MessageBox.Show("Box can't contain more than " & Me._objWingTechATT.WingTechATT_SPMaxQtyInBox.ToString & " units.", "Close Box", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Me.txtDevSN.Focus() : Exit Sub
                ...
                i = Me._objWingTechATT_SP.CloseWingTechATTPallet(Me._iMenuCustID, CInt(Me.dbgPallets.Columns("Pallett_ID").Value), _
                ...
                Try
                    ...
                    '************************
                    If CInt(Me.dbgPallets.Columns("Loc_ID").Value) = Me._objWingTechATT.WingTechATT_Special_LOC_ID _
                       AndAlso Me.cboLocation.SelectedValue = Me._objWingTechATT.WingTechATT_Special_LOC_ID Then
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                ...
                strPallet = strPallet.Trim
                dtTempClosepallet = Me._objWingTechATT_SP.CheckOpenPallet(strPallet)
                If dtTempClosepallet.Rows.Count <> 0 Then
                    strPalletId = dtTempClosepallet.Rows(0)("Pallett_id")
                    If CInt(dtTempClosepallet.Rows(0)("Loc_id")) = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
        ...
        Private Sub Printlabel(ByVal strPallet_ID As String)
            ...
            Dim strPDF417_Data2 As String = ""
            Dim strSep As String = "@"
            dtPallet_Info = Me._objWingTechATT_SP.GetPallet_SN(CInt(strPallet_ID))
            dtLabel = Me._objWingTechATT_SP.getLabelTemplate()
            Dim i As Integer
            Dim FontEncoder As New IDAutomation.NetAssembly.FontEncoder()
            ...
            For i = 0 To dtPallet_Info.Rows.Count - 1
                If i = 0 Then
                    ...
                    rowNew("Pallet") = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                    ...
                    rowNew("Partnumber") = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                    rowNew("PartnumberCode") = strS

                    strS = dtPallet_Info.Rows(i).Item("cntry_name")
                    rowNew("CountryOfOrigine") = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                    'rowNew = dtLabel.NewRow
                    strS = dtPallet_Info.Rows(i).Item("PO")
                    rowNew("PO") = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                    rowNew("POCode") = strS
                    strS = dtPallet_Info.Rows(0).Item("Model")
                    rowNew("Model") = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                    If strS.Trim.Length > 0 Then strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                    ...
                    rowNew("Qty") = iVal
                    strS = iVal.ToString
                    strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                    rowNew("QtyCode") = strS
                ...
                rowNew(strCol) = Me._objWingTechATT_SP.ReplaceChar(strS.Trim)
                If strS.Trim.Length > 0 Then strS = Me._objWingTechATT_SP.ReplaceChar(FontEncoder.Code128a(strS.Trim))
                ...
                End If
            Next
            Dim strReportName1 As String = "WingTechATT_Pallet_SP_Label_25_1.rpt"
            Dim strReportName2 As String = "WingTechATT_Pallet_SP_Label_25_2.rpt"
            'Print WingTechATT_Pallet_Cricket_Label_20
