...
Namespace Gui.WingTechATT
    Public Class frmWingTechATT_FlashTest
        Inherits System.Windows.Forms.Form


        Private _iCust_ID As Integer = 0
        Private _strScreenName As String = ""
        Private _objRfFlahTests As PSS.Data.Buisness.WingTechATT.WingTechATT_FlashTest
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal strScreenName As String, ByVal iCust_ID As Integer)
            ...
            Me._objRfFlahTests = New PSS.Data.Buisness.WingTechATT.WingTechATT_FlashTest()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_FlashTest))
            ...
            Me.btnClear.Location = New System.Drawing.Point(689, 75)
            ...
            Me.btnPass.Location = New System.Drawing.Point(337, 75)
            Me.btnPass.Name = "btnPass"
            Me.btnPass.Size = New System.Drawing.Size(152, 63)
            Me.btnPass.TabIndex = 148
            Me.btnPass.Tag = "2515"
            ...
            Me.Panel2.Location = New System.Drawing.Point(153, -5)
            ...
            Me.btnFail.Location = New System.Drawing.Point(505, 75)
            Me.btnFail.Name = "btnFail"
            Me.btnFail.Size = New System.Drawing.Size(168, 63)
            Me.btnFail.TabIndex = 149
            ...
            Me.Panel3.Location = New System.Drawing.Point(1, 179)
            ...
            Me.grdHistory.Images.Add(CType(resources.GetObject("resource.Images2"), System.Drawing.Bitmap))
            ...
            Me.lblDateCode.Location = New System.Drawing.Point(689, 147)
            Me.lblDateCode.Name = "lblDateCode"
            Me.lblDateCode.Size = New System.Drawing.Size(104, 32)
            Me.lblDateCode.TabIndex = 155
            ...
            Me.lblDevRepType.Location = New System.Drawing.Point(337, 147)
            Me.lblDevRepType.Name = "lblDevRepType"
            Me.lblDevRepType.Size = New System.Drawing.Size(152, 32)
            Me.lblDevRepType.TabIndex = 156
            ...
            Me.lblWrtyStatus.Location = New System.Drawing.Point(505, 147)
            Me.lblWrtyStatus.Name = "lblWrtyStatus"
            Me.lblWrtyStatus.Size = New System.Drawing.Size(168, 32)
            Me.lblWrtyStatus.TabIndex = 154
            Me.lblWrtyStatus.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
            Me.lblWrtyStatus.Visible = False
            '
            'frmWingTechATT_FlashTest
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.BackColor = System.Drawing.Color.SteelBlue
            Me.ClientSize = New System.Drawing.Size(800, 606)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Panel1, Me.Label3, Me.btnClear, Me.btnPass, Me.Panel2, Me.btnFail, Me.Panel3, Me.lblDateCode, Me.lblDevRepType, Me.lblWrtyStatus})
            Me.Name = "frmWingTechATT_FlashTest"
            Me.Text = "frmWingTechATT_FlashTest"
...
#End Region
        ...
        Private Sub frmWingTechATT_FlashTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim i As Integer = 0
            ...
            Try
                ...
                ElseIf Generic.GetCustIDByMachine() = _iCust_ID Then
                    GoTo loadproduct
                Else
                    MessageBox.Show("Please select Flash Test submenu from " & _strGroup.ToUpper & "  Menu ", "Check " & _strGroup.ToUpper & "Menu", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                    Me.Enabled = False
                    Exit Sub
                End If
loadproduct:    dt = Generic.GetProductByCustID(True, Me._iCust_ID)
        ...
        Private Sub ProcessSN()
            ...
            Try
                ...
                End If
                If Not iLoc_id = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
                    ' Check FQA Result FOR WingTechATT
                    If _iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
            ...
            Try
                ...
                Else
                    ...
                    If Me._iRFResult <> 0 Then
                        If Me._objRfFlahTests.InsertRFlashWingTechATT(PSS.Core.Global.ApplicationUser.IDuser, strSN, _iRFResult) Then
                            Me.LoadTestHistory(Me._iDevice_ID)
                        Else
                        End If
                        Me.txtDeviceSN.SelectAll()
