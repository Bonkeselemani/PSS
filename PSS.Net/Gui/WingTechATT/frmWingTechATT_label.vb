...
Namespace Gui.WingTechATT
    Public Class frmWingTechATT_label
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCustID As Integer, ByVal strScreenName As String)
            ...
            _objWingTechATTLabel = New PSS.Data.Buisness.WingTechATT.WingTechATT_Label()
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_label))
            ...
            Me.lblTFModel.Text = "WATTModel No:"
            ...
            '
            'frmWingTechATT_label
            '
            Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
            Me.BackColor = System.Drawing.Color.SteelBlue
            Me.ClientSize = New System.Drawing.Size(864, 509)
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.grbLabelSetUpInfo, Me.cmdlblprint, Me.btnResetManufDateCode, Me.btnRemoveLabelInfo, Me.C1Combo1, Me.pnlMain, Me.btnViewLabelSetUpInfo})
            Me.Name = "frmWingTechATT_label"
            Me.Text = "frmWingTechATT_label"
...
#End Region
        ...
        Private Sub frmWingTechATT_label_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Dim dt As DataTable
            ...
            Try
                ...
                dt = _objWingTechATTLabel.GetManufCountry(True)
        ...
        Private Sub FillLabelInfo_Label()
            ...
            Try
                If Me._iMenuCustID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
                    dt1 = Me._objWingTechATTLabel.GetWingTechATTDeviceInfoForLabel(Trim(Me.txtIMEI.Text), Me._iMenuCustID)
                                End If
                ...
                dt2 = Me._objWingTechATTLabel.GetLabelPanel(_iModel_ID)
                ...
                If dt2.Rows(0)("Panel4") = 1 Then
                    ...
                    End If
                    If Me._iMenuCustID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then Me.btnResetManufDateCode.Visible = True
                End If
                ...
                If dt2.Rows(0)("Panel8") = 1 Then
                    ...
                    If Me.txtIMEI.Text.Trim.Length > 0 Then
                        strIMEI_HEX = Me._objWingTechATTLabel.GetIMEI_HEX(Me.txtIMEI.Text.Trim)
                ...
                If dt2.Rows(0)("Panel10") = 1 Then
                    ...
                    If Me.txtIMEI.Text.Trim.Length > 0 Then
                        If Me._objWingTechATTLabel.GetMEIDHEXDEC_IMEIAlt(Me.txtIMEI.Text.Trim, strMEIDHEX, strMEIDDEC) Then
                ...
                If CInt(dt1.Rows(0)("Manuf_ID")) = 1 Then
                    dt = _objWingTechATTLabel.GetSug(True, _iModel_ID)
                ...
                Else
                    Me.cboMadeIn.SelectedValue = Me._objWingTechATTLabel.GetTracDeviceMadeInCountryIDForLabel(dt1.Rows(0)("model_id"))
                End If
        ...
        Private Sub cmdlblprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdlblprint.Click
            ...
            Try
                If Me._iMenuCustID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then Me.PrintWingTechATTLabel()
                ...
                _objWingTechATTLabel.GetMEIDHEXDEC_IMEIAlt(Me.txtIMEI.Text.Trim, , , strIMEI_Alt)
                ...
                'PRINT LABEL
                '*******************************************
                j = Me._objWingTechATTLabel.PrintLabel(Trim(Me.txtModelNo.Text), (Trim(Me.txtIMEI.Text)), Trim(Me.txtFCCID.Text), _
                ...
                j = Me._objWingTechATTLabel.UpdateLabelTcell(_iDevice_ID, strMSNSN, Me.cboMadeIn.SelectedValue, UCase(Trim(Me.txtProdCode.Text)), _
        ...
        '******************************************************************
        Private Sub PrintWingTechATTLabel()
            Const iIMEILabelBillcode As Integer = 1624
            Dim strNextWrkStation, strSjug, strMSNSN, strESN As String
            Dim i As Integer = 0
            Dim j As Integer = 0
            ...
            Try
                ...
                Me._objWingTechATTLabel.GetMEIDHEXDEC_IMEIAlt(Me.txtIMEI.Text.Trim, , , strIMEI_Alt)
                ...
                '*****************************************************
                If Me.cboLabelType.SelectedIndex = 0 Then
                    strNextWrkStation = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_FQA_WorkStation
                    If strNextWrkStation.Trim.Length > 0 Then i = Generic.SetTcelloptWorkStationForDevice(strNextWrkStation, _iDevice_ID, Core.ApplicationUser.IDuser, "Label", Me.Name, , , , , , )
                    If i > 0 Then MessageBox.Show("This device now belongs to " & strNextWrkStation & " workstation.", "Information", MessageBoxButtons.OK)
                End If
                ...
                'UPDATE LABEL INFO INTO TCELLOPT TABLE
                '*******************************************
                j = Me._objWingTechATTLabel.UpdateWingTechATTLabelTCellOpt(_iDevice_ID, Me.txtDate.Text, Me.cboMadeIn.SelectedValue, _
        ...
        Private Sub btnRemoveLabelInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemoveLabelInfo.Click
            ...
            Try
                ...
                Dim fm As New frmWingTechATT_LabelInfoRemove(strIMEI)
                fm.ShowDialog()
                fm.Dispose()
            Catch ex As Exception
