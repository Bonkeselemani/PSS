...
Namespace Gui.WingTechATT
    Public Class frmWingTechATT_Receiving
        ...
        Private _RecvWingTechATTDT_Seed As DataTable
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_Receiving))
            ...
            Me.Name = "frmWingTechATT_Receiving"
            Me.Text = "frmWingTechATT_Receiving"
...
#End Region
        ...
        Private Sub frmWingTechATT_Receiving_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                'Initialize dt table
                Me._RecvWingTechATTDT = Me._objWingTechATT_Receiving.getWingTechATTRecvTableDef
                Me._RecvWingTechATTDT_Seed = Me._objWingTechATT_Receiving.getWingTechATTSeedStockRecvTableDef

                'Update Item SKU for ATT FexEx POS ASn data
                Me._objWingTechATT_Receiving.FindUpdateAttFexExSkuPos()

                Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
                Me.rbtByPoNumber.Checked = False : Me.rbtByPoNumber.Visible = False 'Not every WingTechATT location has PO, so disabled it
                ...
                'Loc info
                dtLoc = Me._objWingTechATT_BoxShip.GetWingTechATTLocations(Me._iCust_ID, True)
                Misc.PopulateC1DropDownList(Me.cboLocation, dtLoc, "Loc_Name", "Loc_ID")
                Me.cboLocation.SelectedValue = 0

                dtLoc_Seed = Me._objWingTechATT_BoxShip.GetWingTechATTLocations(Me._iCust_ID, True)
                Misc.PopulateC1DropDownList(Me.cboLocation_Seed, dtLoc_Seed, "Loc_Name", "Loc_ID")
                Me.cboLocation_Seed.SelectedValue = 0

                'Model info
                dtModel = Me._objWingTechATT.getWingTechATTModels(Me._iCust_ID, True)
                ...
                'Return Type
                dtDOA = Me._objWingTechATT_Receiving.GetWingTechATTCriketDOA(True)
            ...
            Try
                ...
                With Me.tdgDeviceData
                    ...
                    For Each dbgc In .Splits(0).DisplayColumns
                        ...
                        dbgc.AutoSize()
                    Next dbgc
                    If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                    ...
                    ElseIf Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID OrElse Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                        .Splits(0).DisplayColumns("ASN_SKU_Desc").Width = 0
                        .Splits(0).DisplayColumns("Vendor").Width = 0
                        .Splits(0).DisplayColumns("Vendor_ID").Width = 0
                        .Splits(0).DisplayColumns("Loc_ID").Width = 0
        ...
        Private Sub BindReceivedData_Seed()
            ...
            Try
                'Update sequence RecID
                For Each row In Me._RecvWingTechATTDT_Seed.Rows
                    i += 1
                    row.BeginEdit() : row("RecID") = i : row.AcceptChanges()
                Next
                ...
                With Me.tdgDeviceData_Seed
                    .DataSource = Me._RecvWingTechATTDT_Seed.DefaultView
        ...
        Private Function GoValidation(ByVal iLoc_ID As Integer, ByVal RecvDT As DataTable, ByVal strSN As String, ByVal strSku As String, _
            ...
            Try
                ...
                If iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID OrElse iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
        ...
        Public Function IsValidCricketAccountDOAorEMS(ByVal strAccountDOA As String, ByVal strAccountDOA_Code As String, ByRef iWrtyFlag As Integer) As Boolean
            ...
            Try
                If strAccountDOA.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_DOA.Trim.ToUpper _
                   AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_DOA_AccountCode.Trim.ToUpper Then
                    iWrtyFlag = 0 'OW, DOA
                    Return True
                ElseIf strAccountDOA.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_EMS.Trim.ToUpper _
                       AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_EMS_AccountCode.Trim.ToUpper Then
        ...
        Private Sub cboLocation_Seed_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboLocation_Seed.SelectedValueChanged
            ...
            '    If Me.cboLocation_Seed.SelectedValue = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
        ...
        Private Sub ProcessSN_Seed()
            ...
            Dim strPO As String = ""
            Dim iMaxQty As Integer = Me._objWingTechATT.getMaxReceivingBoxQty
            ...
            Dim strTrayMemo As String = "WingTechATT Seedstock Receiving"
            Dim strRecvMsg As String = ""

            Try
                Me.Cursor = Cursors.WaitCursor

                Me.txtReceivedQty_Seed.Text = Me._RecvWingTechATTDT_Seed.Rows.Count
                ...
                If Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                    strSeedSourceType = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_Cricket.Trim
                ElseIf Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID _
                       OrElse Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                    strSeedSourceType = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_ATT.Trim
                Else
                ...
                ElseIf Not Me.cboModel_Seed.SelectedValue > 0 Then
                    ...
                    'ElseIf iLoc_ID_Seed = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID AndAlso Not Me.cboDOA_Seed.SelectedValue > 0 Then
                ...
                Else
                    strCustLoc = Me._objWingTechATT_Receiving.getCustomerLocation(Me._iCust_ID, Me._iLoc_ID_Seed)

                    'If iLoc_ID_Seed = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                    ...
                    dt = Me._objWingTechATT_Receiving.getSeedStockReceivingData(Me._iCust_ID, _iLoc_ID_Seed, strSN_Seed, strSeedSourceType)
                    ...
                    Else '=1
                        ...
                        Else 'Ready to receive 
                            ...
                            If Me._RecvWingTechATTDT_Seed.Rows.Count = 0 Then 'First device
                            ...
                            Else 'Validate with recev seedstock data
                                Dim strValidatedMsg As String = Me.GoValidation_Seed(Me._RecvWingTechATTDT_Seed, strSN_Seed, strSKU, strPO, iMaxQty).Trim
                            ...
                            bReceived = Me._objWingTechATT_Receiving.ReceiveDataIntoSystem(Me._iLoc_ID_Seed, iWO_ID, iModel_ID, strSN_Seed, strManufDate_Seed, _
                                                                                    strDateTime, strWorkDate, iEW_ID, iShift_ID, iTray_ID, _
                                                                                    iDevice_ID, Me._iWB_ID_Seed, iWrtyFlag, True)
                            If bReceived Then
                                'RecID, SN, ASN_SKU, PSS_Model, Manuf_Date, PO, CustLoc, Model_ID, Loc_ID, EW_ID, Device_ID, wb_ID
                                Dim rowNew As DataRow
                                rowNew = Me._RecvWingTechATTDT_Seed.NewRow
                                ...
                                Me._RecvWingTechATTDT_Seed.Rows.Add(rowNew)
            ...
            Try
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    ...
                    If i > 0 Then
                        ...
                        If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID OrElse Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                        ...
                        Try
                            ...
                            Me._objWingTechATT_Receiving.PrintReceivedBoxLabel(Me._strRecvBoxName, Me._RecvWingTechATTDT.Rows.Count, Me._RecvWingTechATTDT.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                                                 Me._RecvWingTechATTDT.Rows(0).Item("PSS_Model"), "", Me._RecvWingTechATTDT.Rows(0).Item("Return_Type"), _
                                                 strPO, strWHLocation, Me._RecvWingTechATTDT.Rows(0).Item("Loc"), strPoLocOther1)
                        Catch ex As Exception
                            MessageBox.Show("The label for this box failed to print.", "Print Failure", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End Try
                    Else
                    ...
                    Me._RecvWingTechATTDT = Me._objWingTechATT_Receiving.getWingTechATTRecvTableDef : Me.cboLocation.Enabled = True : Me.cboModel.Enabled = True
                    Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
        ...
        Private Sub btnCloseBox_Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCloseBox_Seed.Click
            ...
            Try
                ...
                If Not Me._RecvWingTechATTDT_Seed.Rows.Count > 0 Then Exit Sub
                ...
                ElseIf MsgBox("Do you want to close the box?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    'Close Seedstock box
                    i = Me._objWingTechATT_Receiving.ColseWarehouseBox(Me._iWB_ID_Seed, Me._RecvWingTechATTDT_Seed.Rows.Count, strBoxStage)

                    If i > 0 Then
                        'Print Label
                        strPO = "PO: " & Me._RecvWingTechATTDT_Seed.Rows(0).Item("PO")
                        If Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                            strSeedSourceType = "Seedstock Source: " & PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_Cricket.Trim
                        ElseIf Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID _
                               OrElse Me._iLoc_ID_Seed = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                            strSeedSourceType = "Seedstock Source: " & PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_ATT.Trim
                        Else
                            MessageBox.Show("Invalid Location! See IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Exit Sub
                        End If

                        Me._objWingTechATT_Receiving.PrintReceivedSeedstockBoxLabel(Me._strRecvBoxName_Seed, Me._RecvWingTechATTDT_Seed.Rows.Count, _
                                                                             Me._RecvWingTechATTDT_Seed.Rows(0).Item("ASN_SKU"), "", _
                                                                             Me._RecvWingTechATTDT_Seed.Rows(0).Item("PSS_Model"), "", _
                                                                             strSeedSourceType, strPO, strWHLocation, Me._RecvWingTechATTDT_Seed.Rows(0).Item("CustLoc"), _
                                                                             "")
                    Else
                    ...
                    'Reset
                    Me.tdgDeviceData_Seed.DataSource = Nothing : Me._RecvWingTechATTDT_Seed.Rows.Clear()
                    'initialoze recv datatable columns
                    Me._RecvWingTechATTDT_Seed = Me._objWingTechATT_Receiving.getWingTechATTSeedStockRecvTableDef : Me.cboLocation_Seed.Enabled = True : Me.cboModel_Seed.Enabled = True
        ...
        Private Sub btnReprintBoxLabel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel.Click
            ...
            Try
                If Me.rbtByBoxName.Checked Then 'BY BOX NAME -1-------------------------------------------------------------------------------------------------------------
                    ...
                    dt = Me._objWingTechATT_Receiving.GetWingTechATTReceivedData(Me._iCust_ID, strInput, 1) 'Get data for the Box
                    If dt.Rows.Count > 0 Then
                        ...
                        If iBoxQty = dt.Rows.Count Then
                            ...
                            ElseIf iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID Then
                                strPO = dt.Rows(0).Item("PO") : strASN_SKU_Desc = "" : strPoLocOther1 = "PO: " & dt.Rows(0).Item("PO")
                            ElseIf iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID _
                                   AndAlso Convert.ToString(dt.Rows(0).Item("ASN_SKU_Desc")).Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_PosCode.Trim.ToUpper Then
                            ...
                            Me._objWingTechATT_Receiving.PrintReceivedBoxLabel(dt.Rows(0).Item("BoxName"), iBoxQty, dt.Rows(0).Item("ASN_SKU"), strASN_SKU_Desc, _
                ...
                ElseIf Me.rbtBySN.Checked Then 'BY SN (IMEI) -2------------------------------------------------------------------------------------------------------------
                    ...
                    dtSN = Me._objWingTechATT_Receiving.GetWingTechATTReceivedData(Me._iCust_ID, strInput, 2)   'get data for the SN
                    If dtSN.Rows.Count > 0 Then
                        ...
                        If arrLstBoxes.Count = 1 Then 'one box
                            dt = Me._objWingTechATT_Receiving.GetWingTechATTReceivedData(Me._iCust_ID, arrLstBoxes(0), 1)   'get box data  
                            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                            If iBoxQty = dt.Rows.Count Then
                                'print Label
                                If iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                    ...
                    '    dtPO = Me._objWingTechATT_Receiving.GetWiingTechATTReceivedData(Me._iCust_ID, strInput, 3) 'get data for PO
                    ...
                    '            If i < 1 OrElse i > arrLstBoxes.Count Then Throw New Exception("Invalid input.")
                    '            Dim selectedBoxName As String = arrLstBoxes(i - 1)
                    '            dt = Me._objWingTechATT_Receiving.GetWingTechATTReceivedData(Me._iCust_ID, selectedBoxName, 1)   'get box data
                    '            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                    '            If iBoxQty = dt.Rows.Count Then
                    '                'print Label
                    '                iLoc_ID = Convert.ToInt32(dt.Rows(0).Item("Loc_ID"))
        ...
        Private Sub btnReprintBoxLabel_Seed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReprintBoxLabel_Seed.Click
            ...
            Try
                If Me.rbtByBoxName_Seed.Checked Then 'BY BOX NAME 1-------------------------------------------------------------------------------------------------------------
                    strInput = InputBox("Enter a box name:", "Box Name").Trim
                    If strInput = "" Then Throw New Exception("Please enter a valid box name.")
                    dt = Me._objWingTechATT_Receiving.GetWingTechATTReceivedSeedstockData(Me._iCust_ID, strInput, 1) 'Get data for the Box
                    If dt.Rows.Count > 0 Then
                        iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                        If iBoxQty = dt.Rows.Count Then
                            'print Label
                            ...
                            Me._objWingTechATT_Receiving.PrintReceivedSeedstockBoxLabel(strInput, iBoxQty, dt.Rows(0).Item("ASN_SKU"), "", dt.Rows(0).Item("PSS_Model"), "", _
                ...
                ElseIf Me.rbtBySN_Seed.Checked Then 'BY SN (IMEI) 2------------------------------------------------------------------------------------------------------------
                    ...
                    strInput = InputBox("Enter a SN (IMEI):", "SN (IMEI)").Trim
                    If strInput = "" Then Throw New Exception("Please enter a valid SN (IMEI).")
                    dtSN = Me._objWingTechATT_Receiving.GetWingTechATTReceivedSeedstockData(Me._iCust_ID, strInput, 2)   'get data for the SN

                    If dtSN.Rows.Count > 0 Then
                        For Each row In dtSN.Rows
                            If Not arrLstBoxes.Contains(row("BoxName")) Then
                                strBoxName = row("BoxName")
                                arrLstBoxes.Add(row("BoxName")) : arrlstRecvDates.Add(row("Device_DateRec"))
                            End If
                        Next
                        If arrLstBoxes.Count = 1 Then 'one box
                            Dim selectedBoxName As String = arrLstBoxes(0)
                            dt = Me._objWingTechATT_Receiving.GetWingTechATTReceivedSeedstockData(Me._iCust_ID, selectedBoxName, 1)   'Get data for the Box
                            iBoxQty = Convert.ToInt32(dt.Rows(0).Item("Recv_Qty"))
                            ...
                            If iBoxQty = dt.Rows.Count Then
                                ...
                                Me._objWingTechATT_Receiving.PrintReceivedSeedstockBoxLabel(strBoxName, iBoxQty, dt.Rows(0).Item("ASN_SKU"), "", dt.Rows(0).Item("PSS_Model"), "", _
                                                                                     strSeedSourceType, strPO, strWHLocation, dt.Rows(0).Item("Customer"), "")
                            Else
                                MessageBox.Show("Box received qty and device qty are not the same.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            End If
...
#End Region
        ...
        Private Sub ClearValues_Seed()
            Try
                With Me
                    ...
                    '.lblWingTechATTCustName_Seed.Text = ""
                    Me.pnlReceived_Seed.Visible = False
                End With
        ...
        Private Sub ProcessSN()
            ...
            Dim iProd_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_Product_ID
            Dim strCustLoc As String = ""
            ' Dim strWiingTechATTCustName As String = ""
            Dim strAccountDOA As String = ""
            Dim strAccountDOA_Code As String = ""
            ...
            Try
                ...
                ElseIf Me.IsReceivedUnshipped(Me._iLoc_ID, strSN) Then
                    MessageBox.Show("SN has been received.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Else
                    dt = Me._objWingTechATT_Receiving.getReceivingData(Me._iCust_ID, Me._iLoc_ID, strSN)
                    ...
                    If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID Then strAccountDOA = "WEX" : iWrtyFlag = 1 'All ATT CTDI devices are WEX - Warranty Exchange - 

                    Me.lblblblSKU_Desc.Visible = False : Me.lblSku_Desc.Visible = False
                    If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then
                        If strAccountDOA_Code.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_WexCode Then
                            iWrtyFlag = 1
                        Else
                            iWrtyFlag = 0
                        End If
                    ...
                    ElseIf Not Convert.ToString(dt.Rows(0).Item("Item_SKU")).Trim.ToUpper = Convert.ToString(Me.cboModel.DataSource.Table.Select("Model_ID = " & Me.cboModel.SelectedValue)(0)("Model_Desc")).Trim.ToUpper Then
                        MessageBox.Show("Not the same SKU. This device has SKU '" & Convert.ToString(dt.Rows(0).Item("Item_SKU")).Trim & "'.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID AndAlso Not Me.IsValidCricketAccountDOAorEMS(strAccountDOA, strAccountDOA_Code, iWrtyFlag) Then
                        MessageBox.Show("Invalid DOA Info.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID _
                           AndAlso (dt.Rows(0).IsNull("RA_Number") OrElse Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim.Length = 0) Then
                        MessageBox.Show("No PO number.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID _
                           AndAlso (dt.Rows(0).IsNull("RA_Number") OrElse Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim.Length = 0) Then
                        MessageBox.Show("No PO number.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    ElseIf Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID AndAlso strAccountDOA_Code.Trim.Length = 0 _
                           AndAlso Not strAccountDOA_Code.Trim = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_WexCode.Trim.ToUpper _
                           AndAlso Not strAccountDOA_Code.Trim = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_PosCode.Trim.ToUpper Then
                    ...
                    Else '=1
                        ...
                        Else
                            ...
                            Else 'ok
                                ...
                                If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID Then strReturnType = strAccountDOA_Code.Trim Else strReturnType = strAccountDOA.Trim
                                strPONumber = Convert.ToString(dt.Rows(0).Item("RA_Number")).Trim
                                If Me._iLoc_ID = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID _
                                   AndAlso strAccountDOA_Code.Trim.ToUpper = PSS.Data.buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_PosCode.Trim.ToUpper Then
                                ...
                                Else 'Ready to receive 
                                    ...
                                    Else 'Validate with recev data
                                        Dim strValidatedMsg As String = Me.GoValidation(Me._iLoc_ID, Me._RecvWingTechATTDT, strSN, strASN_IN_ITEM_SKU, strReturnType, strPONumber, iMaxQty).Trim
                                        If strValidatedMsg.Length > 0 Then
                                            MessageBox.Show(strValidatedMsg, "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                                    ...
                                    bReceived = Me._objWingTechATT_Receiving.ReceiveDataIntoSystem(Me._iLoc_ID, iWO_ID, iModel_ID, strSN, strManufDate, _
                                                                                            strDateTime, strWorkDate, iEW_ID, iShift_ID, iTray_ID, _
