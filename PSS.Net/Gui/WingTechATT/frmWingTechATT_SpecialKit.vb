...
Namespace Gui.WingTechATT
    Public Class frmWingTechATT_SpecialKit
        ...
        Private _objWingTechATT_SPKit As PSS.Data.Buisness.WingTechATT.WingTechATT_SpecialKit
...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strScreenName As String)
            ...
            Me._objWingTechATT_SPKit = New PSS.Data.Buisness.WingTechATT.WingTechATT_SpecialKit()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmWingTechATT_SpecialKit))
            ...
            Me.Name = "WingTechATT_SpecialKit"
            Me.Text = "WingTechATT_SpecialKit"
...
#End Region
        ...
        Private Sub frmWingTechATT_SpecialKit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                'Initialize dt table
                Me._dtKitting = Me._objWingTechATT_SPKit.GetKitDatatableDef
                ...
                'Loc info
                dtLoc = Me._objWingTechATT_BoxShip.GetWingTechATTLocations(Me._iMenuCustID, False)
                ...
                dtAcct = _objWingTechATT_SP.GetWingTechATTAccounts(iCust_ID, iLoc_ID)
            ...
            Catch ex As Exception
                MessageBox.Show(ex.ToString, "frmWingTechATT_SpecialKit_Load", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            End Try
        End Sub
            ...
            Try
                If e.KeyCode = Keys.Enter Then
                    If Me.txtDeviceIMEI.Text.Length > 0 AndAlso Me.txtSIMCardICCID.Text.Length = 0 Then
                        If _objWingTechATT_SP.ValidateImeiNumber(iCust_ID, iLoc_ID, cboAccount.SelectedValue, txtDeviceIMEI.Text) = False Then
        ...
        Private Sub ProcessKit()
            ...
            Try
                ...
                dtDevice = Me._objWingTechATT_SPKit.GetDeviceData(Me.cboCustomer.SelectedValue, Me.cboLocation.SelectedValue, strAccount, strIMEI)

                'WI_ID, WO_ID, WR_ID, WO_CustWO, WO_Date, WO_Quantity, Device_ID, ICCID, Kitted
                dtSIMCard = Me._objWingTechATT_SPKit.GetSIMCardData(Me.cboCustomer.SelectedValue, Me.cboLocation.SelectedValue, strICCID)
                ...
                ElseIf dtSIMCard.Rows(0).Item("Kitted") > 0 Then
                    ...
                    Me.txtSIMCardICCID.SelectAll() : Me.txtSIMCardICCID.Focus()
                ElseIf Not Me._objWingTechATT_SP.IsPretestPassed(dtDevice.Rows(0).Item("Device_ID")) Then
                ...
                Else 'Ready to kit
                    ...
                    i = Me._objWingTechATT_SPKit.UpdateKittedItems(dtDevice.Rows(0).Item("EW_ID"), dtSIMCard.Rows(0).Item("WI_ID"), Me._strKittedSession, strKitted_DateTime, Me._iUserID)
            ...
            Try
                ...
                If Me.rbtByIMEI.Checked Then
                    ...
                    If iEW_ID > 0 AndAlso iWI_ID > 0 Then
                        k = Me._objWingTechATT_SPKit.UndoKittedItems(iEW_ID.ToString, iWI_ID.ToString)
                        Me.BindKittedData()
                        Me.lblKittedQty.Text = "Kitted Qty: " & Me._dtKitting.Rows.Count.ToString
        ...
        Private Sub btnDelAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelAll.Click
            ...
            Try
                ...
                k = Me._objWingTechATT_SPKit.UndoKittedItems(strEW_IDs, strWI_IDs)
