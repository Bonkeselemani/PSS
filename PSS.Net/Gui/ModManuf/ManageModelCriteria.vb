...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.gbAddModel.Location = New System.Drawing.Point(448, 48)
            Me.gbAddModel.Name = "gbAddModel"
            Me.gbAddModel.Size = New System.Drawing.Size(560, 496)
            ...
            Me.btnAddModel.Location = New System.Drawing.Point(384, 40)
            Me.btnAddModel.Name = "btnAddModel"
            Me.btnAddModel.Size = New System.Drawing.Size(168, 40)
            ...
            Me.dbgNewModel.Size = New System.Drawing.Size(544, 336)
            ...
            "/><ClientRect>0, 0, 540, 332</ClientRect><BorderSide>0</BorderSide><BorderStyle>" & _
            ...
            ", 0, 540, 332</ClientArea><PrintPageHeaderStyle parent="""" me=""Style20"" /><PrintP" & _
            ...
            Me.dbgModelCriteria.Size = New System.Drawing.Size(416, 400)
            ...
            """ me=""Style6"" /><Style parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 412, 396<" & _
            ...
            "ultRecSelWidth>17</DefaultRecSelWidth><ClientArea>0, 0, 412, 396</ClientArea><Pr" & _
            ...
            Me.gbUpdate.Size = New System.Drawing.Size(416, 72)
...
#End Region
        ...
        Private Sub LoadModelCriteria(ByVal iCustID As Integer, ByVal iProdID As Integer, ByVal iManufID As Integer)
            ...
            Try
                dt = _objModManuf.GetModelCriteriaList(iCustID, iManufID, iProdID)
        ...
        Private Sub LoadNewModelList(ByVal iCustID As Integer, ByVal iProdID As Integer, ByVal iManufID As Integer)
            ...
            Try
                dt = _objModManuf.GetMissingModelCriteria(Me._iMenuCustID, iManufID, iProdID)
                With Me.dbgNewModel
                    .DataSource = dt.DefaultView
                    .Splits(0).DisplayColumns("Model_ID").Visible = False
                    .Splits(0).DisplayColumns("Prod_ID").Visible = False
        ...
        Private Sub btnAddModel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddModel.Click
            ...
            Try
                If Me.dbgNewModel.SelectedRows.Count > 0 Then
                    ...
                    ElseIf Me.rbtnEOLYes.Checked = False AndAlso Me.rbtnEOLNo.Checked = False Then
        ...
        Private Sub btnRefreshList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRefreshList.Click
            Try
                If Me.cboCustomers.SelectedValue = 0 Then
                    MessageBox.Show("Please select customer.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                ElseIf Me.cboManuf.SelectedValue = 0 Then
                ...
                Else
                    LoadModelCriteria(Me.cboCustomers.SelectedValue, cboProducts.SelectedValue, cboManuf.SelectedValue)
                End If
            Catch ex As Exception
                MessageBox.Show(ex.ToString, "btnRefreshList_Click", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        End Sub
