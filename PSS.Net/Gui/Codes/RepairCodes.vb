...
Namespace Gui.codes
    ...
    Public Class RepairCodes
        Inherits System.Windows.Forms.Form

        Private xCount As Integer
        Private dtRepairCodes, dtManufacturer, dtProduct, dtDisplay As DataTable
...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents cboRepairCodes As System.Windows.Forms.ComboBox
        Friend WithEvents lblRepairCodess As System.Windows.Forms.Label
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RepairCodes))
            Dim GridLines1 As C1.Win.C1TrueDBGrid.Util.GridLines = New C1.Win.C1TrueDBGrid.Util.GridLines()
            Me.displayGrid = New C1.Win.C1TrueDBGrid.C1TrueDBGrid()
            Me.cboRepairCodes = New System.Windows.Forms.ComboBox()
            Me.lblRepairCodess = New System.Windows.Forms.Label()
            ...
            Me.displayGrid.Location = New System.Drawing.Point(304, 16)
            ...
            Me.displayGrid.Size = New System.Drawing.Size(312, 376)
            Me.displayGrid.TabIndex = 0
            Me.displayGrid.TabStop = False
            ...
            "rollGroup=""1""><ClientRect>0, 0, 308, 372</ClientRect><BorderSide>0</BorderSide><" & _
            ...
            "elWidth><ClientArea>0, 0, 308, 372</ClientArea></Blob>"
            '
            'cboRepairCodes
            '
            Me.cboRepairCodes.Location = New System.Drawing.Point(8, 40)
            Me.cboRepairCodes.Name = "cboRepairCodes"
            Me.cboRepairCodes.Size = New System.Drawing.Size(288, 21)
            Me.cboRepairCodes.TabIndex = 1
            '
            'lblRepairCodess
            '
            Me.lblRepairCodess.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Me.lblRepairCodess.Location = New System.Drawing.Point(8, 16)
            Me.lblRepairCodess.Name = "lblRepairCodess"
            Me.lblRepairCodess.Size = New System.Drawing.Size(100, 16)
            Me.lblRepairCodess.TabIndex = 0
            Me.lblRepairCodess.Text = "REPAIR CODES:"
            '
            'btnCancelRecord
            '
            ...
            Me.grpRecord.Location = New System.Drawing.Point(16, 128)
            Me.grpRecord.Name = "grpRecord"
            Me.grpRecord.Size = New System.Drawing.Size(280, 264)
            Me.grpRecord.TabIndex = 6
            ...
            'btnNew
            '
            Me.btnNew.Location = New System.Drawing.Point(208, 72)
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnNew, Me.grpRecord, Me.lblRepairCodess, Me.cboRepairCodes, Me.displayGrid})
            Me.Name = "RepairCodes"
...
#End Region
        ...
        Private Sub RepairCodes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Private Sub getMCodeID()
            ...
            Dim dtMCode As DataTable = dtMC.GetMCodeID("Repair")
            Dim r As DataRow
        ...
        Private Sub getRepairCodeDisplay()

            Dim ctlRepairCodesDisplay As New PSS.Data.Production.Joins()
            dtDisplay = ctlRepairCodesDisplay.RepairCodeDisplay(intMCodeID)
            ctlRepairCodesDisplay = Nothing
        ...
        Private Sub getRepairCodes()

            Dim ctlRepairCodes As New PSS.Data.Production.lrepaircodes()
            dtRepairCodes = ctlRepairCodes.RepairCodeList
            ctlRepairCodes = Nothing
        ...
        Private Sub populateRepairCodes()
            ...
            For xCount = 0 To dtRepairCodes.Rows.Count - 1
                '//add items to combobox
                r = dtRepairCodes.Rows(xCount)
                Me.cboRepairCodes.Items.Add(r("repair_LDesc"))
            Next
        ...
        Private Sub clearFields()
            ...
            'Me.cboProd.Text = ""
            Me.txtID.Text = ""
            Me.cboRepairCodes.Text = ""

        End Sub

        Private Sub cboRepairCodes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboRepairCodes.SelectedIndexChanged
        ...
        Private Sub getRecordForEditing()
            ...
            For xCount = 0 To dtRepairCodes.Rows.Count - 1
                r = dtRepairCodes.Rows(xCount)
                If Trim(r("Repair_LDesc")) = Trim(cboRepairCodes.Text) Then
                    '//populate data to form
                    Me.txtShortDesc.Text = r("Repair_SDesc")
                    Me.txtLongDesc.Text = r("Repair_LDesc")
                    Me.txtID.Text = r("Repair_ID")
        ...
        Private Sub btnAddRecord_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddRecord.Click
            ...
            If blnInsert = True Then
                'strSQL = "INSERT INTO lrepaircodes (Repair_SDesc, Repair_LDesc, Manuf_ID, Prod_ID) VALUES ('" & txtShortDesc.Text & "', '" & txtLongDesc.Text & "', " & ManufID & ", " & ProdID & ")"
            ...
            Else
                If Len(Trim(txtID.Text)) > 0 Then
                    'strSQL = "UPDATE lrepaircodes set repair_SDesc = '" & txtShortDesc.Text & "', repair_LDesc = '" & txtLongDesc.Text & "', manuf_ID = " & ManufID & ", prod_ID = " & ProdID & " WHERE repair_ID = " & txtID.Text
        ...
        Private Sub btnDeleteRecord_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteRecord.Click
            ...
            If Len(Trim(txtID.Text)) > 0 Then
                If IsNumeric(Trim(txtID.Text)) = True Then
                    ...
                    Response = MsgBox("You are about to delete this Repair Code. Continue?", MsgBoxStyle.YesNo, "Confirm Delete")
                    Select Case Response
                        Case vbYes
                            Dim ctlProcedure As New PSS.Data.Production.Joins()
                            'strSQL = "DELETE FROM lrepaircodes WHERE Repair_ID = " & Trim(txtID.Text)
        ...
        Private Sub displayGrid_RowColChange(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.RowColChangeEventArgs) Handles displayGrid.RowColChange
            ...
            cboRepairCodes.Text = Me.displayGrid.Columns(0).Text
            getRecordForEditing()
