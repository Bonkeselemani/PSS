...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            'cmbModel
            '
            Me.cmbModel.Location = New System.Drawing.Point(-4, 63)
            ...
            'cmbLoc
            '
            Me.cmbLoc.Location = New System.Drawing.Point(-4, 23)
            ...
            Me.lblNoQCPass.Location = New System.Drawing.Point(492, 215)
            ...
            Me.lstNoQCPass.Location = New System.Drawing.Point(492, 231)
            ...
            Me.lblAddress.Location = New System.Drawing.Point(276, 39)
            ...
            Me.lblWrongModel.Location = New System.Drawing.Point(188, 215)
            ...
            Me.lblWrongFreq.Location = New System.Drawing.Point(340, 215)
            ...
            Me.grpboxUnship.Location = New System.Drawing.Point(548, 15)
            ...
            Me.lstWrongModel.Location = New System.Drawing.Point(188, 231)
            ...
            Me.lstWrongFreq.Location = New System.Drawing.Point(340, 231)
            ...
            Me.lblFreqLabel.Location = New System.Drawing.Point(332, 151)
            ...
            Me.lblFreqNum.Location = New System.Drawing.Point(332, 167)
            ...
            Me.btnShipSpecial.Location = New System.Drawing.Point(156, 95)
            ...
            Me.btnPO.Location = New System.Drawing.Point(76, 95)
            Me.btnPO.Name = "btnPO"
            ...
            Me.btnReprint.Location = New System.Drawing.Point(700, 511)
            ...
            Me.btnEndUser.Location = New System.Drawing.Point(-4, 95)
            ...
            Me.btnPrint.Location = New System.Drawing.Point(-4, 503)
            ...
            Me.TDBGrid1.Location = New System.Drawing.Point(212, 463)
            ...
            "er;}Style1{}Normal{Font:Verdana, 8.25pt, style=Bold;}HighlightRow{ForeColor:High" & _
            "lightText;BackColor:Highlight;}Style12{}OddRow{}RecordSelector{AlignImage:Center" & _
            ";}Style13{}Heading{Wrap:True;BackColor:Control;Border:Raised,,1, 1, 1, 1;ForeCol" & _
            "or:ControlText;AlignVert:Center;}Style8{}Style10{AlignHorz:Near;}Style11{}Style1" & _
            "4{}Style15{}Style9{}</Data></Styles><Splits><C1.Win.C1TrueDBGrid.MergeView Name=" & _
            ...
            Me.lstDevices.Location = New System.Drawing.Point(-4, 207)
            ...
            Me.lblPager.Location = New System.Drawing.Point(-4, 167)
            ...
            Me.txtPager.Location = New System.Drawing.Point(-4, 183)
            ...
            Me.lblCount.Location = New System.Drawing.Point(188, 151)
            ...
            Me.lblCompany.Location = New System.Drawing.Point(276, 15)
            ...
            'lblDate
            '
            Me.lblDate.Location = New System.Drawing.Point(608, 159)
            ...
            'Label2
            '
            Me.Label2.Location = New System.Drawing.Point(536, 159)
            ...
            Me.Name = "frmShippingFix"
            Me.Text = "frmShippingFix"
...
Loop_Msg1:
                    ...
                    maxBill = objGeneric.GetMaxBillRule(Me.G_iFindDeviceID)
                    If Me.lstDevices.Items.Count = 0 Then
                        'Set RUR/NER for first serial entry
                        If maxBill = 1 Or maxBill = 2 Then
                            G_RUR_NER = True
                        Else
                            G_RUR_NER = False
                        End If
                    Else
                        ...
                        If (maxBill = 1 Or maxBill = 2) And G_RUR_NER = False Then
                            MessageBox.Show("Can't add RUR/NER device to Repair list.", "Type Mismatch !", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                        ElseIf (maxBill <> 1 Or maxBill <> 2) And G_RUR_NER = True Then
                            MessageBox.Show("Can't add Repair device to RUR/NER list.", "Type Mismatch !", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                        End If
                    End If
        ...
        '*********************************************************
        Private Sub SetListBoxControl(ByRef ctrl_lstBox As Windows.Forms.ListBox, _
                                      ByRef ctrl_lbl As Windows.Forms.Label)
        ...
        '*********************************************************
        Private Sub AddItemToListBoxControl(ByRef ctrl_lstBox As Windows.Forms.ListBox, _
