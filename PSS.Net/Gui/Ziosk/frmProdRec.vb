...
#Region " Windows Form Designer generated code "
		...
		<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProdRec))
...
#End Region
			...
			Try
				...
				Else
					...
					If iDeviceID > 0 Then
						...
						'Bill Pass service
						'***************************
						If Me.cboCustomers.SelectedValue = 2543 Then						 'Peiker Acustic, Inc.
							Me.AutoBillPassAutomotiveElectronicsService(iDeviceID)
						End If
						'***************************
		...
		'********************************************************************************
		Private Sub AutoBillPassAutomotiveElectronicsService(ByVal iDeviceID As Integer)
			Const iPassAutomotiveElectronicsBillcode As Integer = 2435
			Dim objDevice As Rules.Device

			Try
				If Generic.IsBillcodeMapped(Me.cboModels.SelectedValue, iPassAutomotiveElectronicsBillcode) = 0 Then
					MessageBox.Show("Pass billcode is not mapped. Please contact Material department.", "Information", MessageBoxButtons.OK)
				Else
					objDevice = New Rules.Device(iDeviceID)
					If Generic.IsBillcodeExisted(iDeviceID, iPassAutomotiveElectronicsBillcode) = False Then
						objDevice.AddPart(iPassAutomotiveElectronicsBillcode)
						objDevice.Update()
					End If
				End If
			Catch ex As Exception
