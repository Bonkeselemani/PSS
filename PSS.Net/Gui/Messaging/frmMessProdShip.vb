...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal strScreenName As String, ByVal iMenuCustID As Integer)
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdReprintPalletLabel.Location = New System.Drawing.Point(459, 168)
        ...
        Me.btnPrintManifestRpt.Location = New System.Drawing.Point(459, 208)
...
#End Region
        ...
        Try
            ...
            Select Case Me._iMenuCustID
                ...
                Case Me._objSkyTel.CriticalAlert_CUSTOMER_ID
                    ...
                    'If Me.iMachineCCGroup = Me._objSkyTel.CriticalAlert_GROUPID Then
                    isComputerNameMapped = True
                    'End If
                Case Else
                    tmpStr = ""
    ...
    Private Sub LoadPallets()
        ...
        Try
            ...
            Me._objBulkShip = New BulkShipping()
            dtPallets = Me._objBulkShip.GetPalletsReadyToBeShipped(iHoldStatus, iMachineCCGroup, _iMenuCustID)
        ...
        Try
            ...
            Select Case iCustID
                ...
                Case PSS.Data.Buisness.SkyTel.CookPager_CUSTOMER_ID
                    strFilePath = SkyTel.CookPager_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.ContactWireless_CUSTOMER_ID
                    strFilePath = SkyTel.ContactWireless_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.AMS_CUSTOMER_ID
                    strFilePath = SkyTel.AMS_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.A1WirelessComm_CUSTOMER_ID
                    strFilePath = SkyTel.A1WirelessComm_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.CriticalAlert_CUSTOMER_ID
                    strFilePath = SkyTel.CriticalAlert_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.Anna_CUSTOMER_ID
                    strFilePath = SkyTel.Anna_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.Lahey_CUSTOMER_ID
                    strFilePath = SkyTel.Lahey_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.Masco_CUSTOMER_ID
                    strFilePath = SkyTel.Masco_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.Franciscan_CUSTOMER_ID
                    strFilePath = SkyTel.Franciscan_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.Maine_CUSTOMER_ID
                    strFilePath = SkyTel.Maine_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.SMHC_CUSTOMER_ID
                    strFilePath = SkyTel.SMHC_MANIFEST_DIR
                Case PSS.Data.Buisness.SkyTel.ATS_CUSTOMER_ID
                    strFilePath = SkyTel.ATS_MANIFEST_DIR
                Case Else
            ...
            '************************************************
            '  If iCustID <> SkyTel.AMS_CUSTOMER_ID Then
            ...
            If iExcelNum > 0 Then
                ...
                '    Case SkyTel.SKYTEL_CUSTOMER_ID, SkyTel.MorrisCom_CUSTOMER_ID, SkyTel.Propage_CUSTOMER_ID, SkyTel.Aquis_CUSTOMER_ID, SkyTel.CookPager_CUSTOMER_ID
                ...
                For Each R1 In _objBulkShip.dtExcelSNs.Rows
                    '*******************************************************
                    '(A) Model Validation (For all customers except for Other meessage customers)
                    '*******************************************************
                    Select Case Me._iMenuCustID
                        Case SkyTel.Anna_CUSTOMER_ID, SkyTel.Lahey_CUSTOMER_ID, _
                           SkyTel.Masco_CUSTOMER_ID, SkyTel.Franciscan_CUSTOMER_ID, SkyTel.Maine_CUSTOMER_ID, _
                           SkyTel.SMHC_CUSTOMER_ID
                            bOtherMessCustomer = True
                    End Select
                    If Not bOtherMessCustomer AndAlso R1("Model_ID") <> iModel_ID Then
                        'Select Case iCustID
                        '    Case SkyTel.SKYTEL_CUSTOMER_ID, SkyTel.MorrisCom_CUSTOMER_ID, SkyTel.Propage_CUSTOMER_ID, SkyTel.Aquis_CUSTOMER_ID, SkyTel.CookPager_CUSTOMER_ID   'ATCLE , HTC
                    ...
                    '*******************************************************
                    'Select Case iCustID
                    'Case SkyTel.SKYTEL_CUSTOMER_ID, SkyTel.MorrisCom_CUSTOMER_ID, SkyTel.Propage_CUSTOMER_ID, SkyTel.Aquis_CUSTOMER_ID, SkyTel.CookPager_CUSTOMER_ID        'HTC
                    '*******************************************************
                    ...
                    End If
                    '*******************************************************
                    'Wrong Frequency (No need to check when other message customers
                    '*******************************************************
                    If Not bOtherMessCustomer AndAlso R1("SKU_Number").ToString.Trim.Length > 0 Then
    ...
    Private Sub cmdShip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShip.Click
        ...
        Try
            ...
            i = _objBulkShip.BulkShip(Me.chkManifestExcelRpt.Checked, iHoldStatus, CInt(Me.lblCnt.Text), , 0, iWipOwnerID)
        ...
        Try
            ...
            Select Case Me._iMenuCustID
                ...
                Case SkyTel.CookPager_CUSTOMER_ID
                    filePath = SkyTel.CookPager_MANIFEST_DIR
                Case SkyTel.ContactWireless_CUSTOMER_ID
                    filePath = SkyTel.ContactWireless_MANIFEST_DIR
                Case SkyTel.AMS_CUSTOMER_ID
                    filePath = SkyTel.AMS_MANIFEST_DIR
                Case SkyTel.A1WirelessComm_CUSTOMER_ID
                    filePath = SkyTel.A1WirelessComm_MANIFEST_DIR
                Case SkyTel.CriticalAlert_CUSTOMER_ID
                    filePath = SkyTel.CriticalAlert_MANIFEST_DIR
                Case SkyTel.Anna_CUSTOMER_ID
                    filePath = SkyTel.Anna_MANIFEST_DIR
                Case SkyTel.Lahey_CUSTOMER_ID
                    filePath = SkyTel.Lahey_MANIFEST_DIR
                Case SkyTel.Masco_CUSTOMER_ID
                    filePath = SkyTel.Masco_MANIFEST_DIR
                Case SkyTel.Franciscan_CUSTOMER_ID
                    filePath = SkyTel.Franciscan_MANIFEST_DIR
                Case SkyTel.Maine_CUSTOMER_ID
                    filePath = SkyTel.Maine_MANIFEST_DIR
                Case SkyTel.SMHC_CUSTOMER_ID
                    filePath = SkyTel.SMHC_MANIFEST_DIR
                Case SkyTel.ATS_CUSTOMER_ID
                    filePath = SkyTel.ATS_MANIFEST_DIR
            End Select
