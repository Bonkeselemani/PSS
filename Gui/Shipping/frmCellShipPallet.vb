...
Public Class frmCellShipPallet
    ...
    Private iCust_ID As Integer = 2019
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmCellShipPallet))
        ...
        Me.lbl.TabIndex = 7
        Me.lbl.Text = "BUILD ATCLE SHIP PALLETS"
        ...
        """ VerticalScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>102</Height><Caption" & _
        ...
        "yle parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 210, 102</ClientRect><Border" & _
        ...
        "DefaultRecSelWidth><ClientArea>0, 0, 210, 102</ClientArea><PrintPageHeaderStyle " & _
        "parent="""" me=""Style16"" /><PrintPageFooterStyle parent="""" me=""Style17"" /></Blob>"
        '
        'panelShipType
        '
        ...
        Me.PanelPalletList.Size = New System.Drawing.Size(272, 202)
        ...
        Me.cmdDeletePallett.Location = New System.Drawing.Point(28, 160)
        Me.cmdDeletePallett.Name = "cmdDeletePallett"
        Me.cmdDeletePallett.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.cmdDeletePallett.Size = New System.Drawing.Size(213, 32)
        Me.cmdDeletePallett.TabIndex = 106
...
#End Region
    ...
    Private Sub frmCellShipPallet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            MessageBox.Show("frmCellShipPallet.frmCellShipPallet_Load: " & Environment.NewLine & ex.Message.ToString, "Form Load", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
        End Try
    ...
    Private Sub RefreshPalletGrid(ByVal strGroupChar As String)
        ...
        Try
            ...
            dt1 = objMisc.GetOpenPalletsForModel(strGroupChar, strShortModelName, iModel_ID, iCust_ID)
    ...
    Private Sub GetPalletInfo()
        ...
        Try
            ...
            dt1 = objMisc.GetPalletInfo(strpalletString, Me.iCust_ID)
    ...
    Private Sub cmdCreatePallet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCreatePallet.Click
        ...
        Try
            ...
            End If
            '************************
            iPallet_ID = objMisc.CreatePallet(strPalletName, strShipType, strPalletNameInitials, iModel_ID, iCust_ID, strSkuLength)
            Me.cmdCreatePallet.Visible = False
            Me.panelPallet.Visible = True
            Me.lblPalletName.Text = strPalletName
            'RefreshPalletGrid(strGroupChar, strShortModelName)
    ...
    Private Sub cmdClosePallet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClosePallet.Click
        ...
        Try
            ...
            End If
            '************************
            i = objMisc.ClosePallet(iCust_ID, iPallet_ID, strPalletName, Me.lstDevices.Items.Count, Me.grdPallets.Columns("Pallet_ShipType").Value, 3, )
            If i = 0 Then
    ...
    Private Sub ProcessSN()
        ...
        Try
            ...
            strShipTypeChars = Microsoft.VisualBasic.Left(strShipType, 3)
            i = objMisc.CheckDevice_REF_RUR_RTM(strSN, strShipTypeChars, iCust_ID)
            '***************************************************
            'Step 2: Check if the Device has pallet assigned to it
    ...
    Private Sub cmdDeletePallett_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDeletePallett.Click
        ...
        Try
            ...
            If MessageBox.Show("Are you sure you want to delete this Pallet?", "Confirm Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                ...
                RefreshPalletGrid(Microsoft.VisualBasic.Right(Trim(strGroup), 1))
