...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TabControl1, Me.picYes, Me.picNo, Me.btnCopy2ClipboardSavedLog, Me.btnCopy2Clipboard, Me.lblSavedLog, Me.LstboxSavedLog, Me.lblTitle, Me.cboClaimNo, Me.cboCarrier, Me.btnSaveData, Me.lblShipmentLabel, Me.txtShipmentLabel, Me.lblCarrier, Me.lblInTrackNo, Me.txtInTrackNo, Me.lblOutTrackNo, Me.lblClaimNo, Me.txtOutTrackNo})
...
#End Region
        ...
        Private Sub btnSaveData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveData.Click
            ...
            Try
                ...
                'PSSIStatusStr = objTMI.EnumDescription(objTMI.WIP_Status.EmptyBoxShipped) 'give up to use decription
                PSSIStatus_ID = 2  'objTMI.WIP_Status.EmptyBoxShipped 'use ID
                ...
                If iWO_ID = 0 Then
                    ...
                    '    returnTrackStr, PSSIStatus_ID, iSC_ID, GiUserID)
                    'objRecShip = New PSS.Data.Buisness.TMIRecShip()
                    'shippingCost = (1 + objRecShip._PSSI_ShippingMargin) * PSSI2CustomerShippingCost
