...
Namespace Gui
    Public Class TMISharedFunc
        ...
        '*************************************************************************************************************
        Public Shared Function BillExceptionRepairs(ByVal iDeviceID As Integer, ByVal decMarkUp As Decimal, ByVal dtBilledBillCode As DataTable) As Integer
            Dim i As Integer = 0
            ...
            Try
                ...
                ElseIf dtBilledBillCode.Select("Billcode_Desc = 'Exception Repairs'").Length > 0 Then
                    objTMIShip.UpdateExcptRepPartCharge(iDeviceID, decMarkUp)
