...
Public Class Rec__DeviceChange_031606
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rec_ DeviceChange_031606.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRec__DeviceChange_031606
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rec__DeviceChange_031606 = New Rec__DeviceChange_031606
        rpt.Site = Me.Site
        Return rpt
    End Function
