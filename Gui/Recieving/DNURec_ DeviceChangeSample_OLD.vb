...
Public Class DNURec__DeviceChangeSample_OLD
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "DNURec_ DeviceChangeSample_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDNURec__DeviceChangeSample_OLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DNURec__DeviceChangeSample_OLD = New DNURec__DeviceChangeSample_OLD
        rpt.Site = Me.Site
        Return rpt
    End Function
