...
Namespace Gui.Receiving
    ...
    Public Class frmATCLE_CellDeviceInfo
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.lblMotorola.Location = New System.Drawing.Point(88, 232)
            Me.lblMotorola.Name = "lblMotorola"
            Me.lblMotorola.Size = New System.Drawing.Size(112, 32)
            Me.lblMotorola.TabIndex = 99
            Me.lblMotorola.Text = "ATCLE"
            '
            'lblRC
            '
            Me.lblRC.Location = New System.Drawing.Point(320, 296)
            Me.lblRC.Name = "lblRC"
            Me.lblRC.Size = New System.Drawing.Size(32, 16)
            Me.lblRC.TabIndex = 75
            '
            'frmATCLE_CellDeviceInfo
            '
            ...
            Me.Name = "frmATCLE_CellDeviceInfo"
...
#End Region
        ...
        Private Sub frmCellDeviceInfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If tmpRS("Cust_SpecialCodes") > 0 Then
                ...
                cboReturnCode.DisplayMember = tmpDT.Columns("DCode_SDesc").ToString
            ...
            PopulateDateCode()
            PopulateComplaints()
            If ManufName = "Motorola" Then PopulateAPC()

            Dim xCount As Integer = 0
            If ManufName = "Motorola" Then

                '//NEW CODE January 14, 2004
                If Len(Trim(frmATCLE_Receiving.coDeviceSN)) < 1 Or Len(Trim(ModelID)) < 1 Then
...
APCcode:
                ...
                If txtDateCodeType = "CSN" Then
                    If Len(Trim(frmATCLE_Receiving.coDeviceSN)) > 10 Then
                        txtDateCode = Mid$(Trim(frmATCLE_Receiving.coDeviceSN), 9, 3)
                        'Make hex code conversion here
                        Dim valHex As String = Mid$(Trim(frmATCLE_Receiving.coDeviceSN), 1, 8)
                        Dim vals1 As String = Mid$(Trim(frmATCLE_Receiving.coDeviceSN), 1, 2)
                        Dim vals2 As String = Mid$(Trim(frmATCLE_Receiving.coDeviceSN), 3, 6)
                ...
                ElseIf txtDateCodeType = "GSM" Then
                    If Len(Trim(frmATCLE_Receiving.coDeviceSN)) > 5 Then
                        txtDateCode = Mid$(Trim(frmATCLE_Receiving.coDeviceSN), 5, 2) & "J"
                    End If
                End If
...
DateCode:
            ...
            'frmATCLE_Receiving.vcCSN = txtCSN
        ...
        Private Sub txtPOP_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPOP.Leave
            ...
            If ManufFlag = "M" Then
                ...
                If txtDateCodeType = "GSM" Then
                    ...
                    txtIncomingIMEI.Text = frmATCLE_Receiving.coDeviceSN
                Else
            ...
            ElseIf ManufFlag = "N" Then
                ...
                Me.lblAirtimeCarrierCode.Visible = False
        ...
        Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
            ...
            frmATCLE_Receiving.cellValCustomer = txtCustomerName.Text
            frmATCLE_Receiving.cellValDateCode = cboDateCode.Text
            frmATCLE_Receiving.cellValPOP = txtPOP.Text
            frmATCLE_Receiving.cellValProdCode = txtProductCode.Text
            frmATCLE_Receiving.cellValMSN = txtMSN.Text
            frmATCLE_Receiving.cellValModel = txtModel.Text

            'Unload the form and return to parent.
            'frmATCLE_Receiving.txtCell.Focus()
            frmATCLE_Receiving.waitStateVAL = 1
            Me.Close()
        ...
        Private Sub frmCellDeviceInfo_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
            ...
            If frmATCLE_Receiving.waitStateVAL = 0 Then
                frmATCLE_Receiving.waitStateVAL = 2
            End If
        ...
        Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
            ...
            For xcount = 0 To UBound(arrCarrier)
                If Trim(arrCarrier(xcount, 1)) = Trim(cboAirCarrCode.Text) Then
                    frmATCLE_Receiving.vcAirCarrCode = arrCarrier(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrTransaction)
                If Trim(arrTransaction(xcount, 1)) = Trim(cboTransCode.Text) Then
                    frmATCLE_Receiving.vcTransactionCode = arrTransaction(xcount, 0)
                    Exit For
                End If
            Next
            ...
            For xcount = 0 To UBound(arrAPC)
                If Trim(arrAPC(xcount, 0)) = Trim(cboProd_APCCode.Text) Then
                    frmATCLE_Receiving.vcAPCcode = arrAPC(xcount, 3)
                    Exit For
                End If
            Next
            ...
            frmATCLE_Receiving.vcDateCode = cboDateCode.Text
            frmATCLE_Receiving.vcCourierTrackIN = txtCourierTrackIN.Text
            'frmATCLE_Receiving.vcAPCcode = txtProd_APCCode.Text
            frmATCLE_Receiving.vcTranceiverCode = txtTransCode.Text
            frmATCLE_Receiving.vcIncomingIMEI = txtIncomingIMEI.Text
            frmATCLE_Receiving.vcWrtyClaimNum = txtWarrantyClaimNum.Text

            'If Len(Trim(cboAirCarrCode.Text)) > 0 Then frmATCLE_Receiving.vcAirCarrCode = cboAirCarrCode.Text
            If Len(Trim(txtCarrModelCode.Text)) > 0 Then frmATCLE_Receiving.vcCarrModelCode = txtCarrModelCode.Text
            If Len(Trim(txtMIN.Text)) > 0 Then frmATCLE_Receiving.vcMIN = txtMIN.Text
            'If Len(Trim(cboDateCode.Text)) > 0 Then frmATCLE_Receiving.vcDateCode = cboDateCode.Text
            If vMWrty = 1 Then
                frmATCLE_Receiving.vcDateCodeVM = "1"
            Else
                frmATCLE_Receiving.vcDateCodeVM = "0"
            End If
            If Len(Trim(txtCustomerName.Text)) > 0 Then frmATCLE_Receiving.vcCustomerName = txtCustomerName.Text
            If Len(Trim(txtModel.Text)) > 0 Then frmATCLE_Receiving.vcModel = txtModel.Text
            If Len(Trim(txtPOP.Text)) > 0 Then frmATCLE_Receiving.vcPOP = txtPOP.Text
            If Len(Trim(txtMSN.Text)) > 0 Then frmATCLE_Receiving.vcMSN = txtMSN.Text
            If Len(Trim(txtProductCode.Text)) > 0 Then frmATCLE_Receiving.vcProductCode = txtProductCode.Text
            If Len(Trim(lblCustomerReasonNameString.Text)) > 0 Then frmATCLE_Receiving.vcComplaint = lblCustomerReasonNameString.Text
            'Craig Haney
            If Len(Trim(cboReturnCode.SelectedValue)) > 0 Then frmATCLE_Receiving.vcReturnCode = cboReturnCode.SelectedValue
            'Craig Haney
            ...
            '//NEW
            If txtDateCodeType = "GSM" Then
                frmATCLE_Receiving.cellValMSN = frmATCLE_Receiving.coDeviceSN
                frmATCLE_Receiving.vcMSN = frmATCLE_Receiving.coDeviceSN
            ElseIf txtDateCodeType = "CSN" Then
                frmATCLE_Receiving.vcCSN = frmATCLE_Receiving.coDeviceSN
            End If
            '//NEW
        ...
        Private Sub PopulateAPC()
            ...
            dtAPC = tblJoins.GenericSelect("SELECT lcodesdetail.* from (lcodesmaster INNER JOIN lcodesdetail ON lcodesmaster.mcode_id = lcodesdetail.mcode_id) Where lcodesmaster.mcode_desc='APC' and lcodesdetail.manuf_id=1 and lcodesdetail.prod_id=2 order by Dcode_SDesc")
            Dim r As DataRow
        ...
        Private Sub cboReturnCode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboReturnCode.SelectedIndexChanged

            Try
                lblRC.Text = cboReturnCode.SelectedValue
            Catch ex As Exception
            End Try
