...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbCustomer.Location = New System.Drawing.Point(120, 16)
        ...
        Me.txtParentWO.Location = New System.Drawing.Point(120, 64)
        ...
        Me.cmbLoc.Location = New System.Drawing.Point(120, 40)
        ...
        Me.lblChildWO.Location = New System.Drawing.Point(8, 185)
        ...
        Me.txtChildWO.Location = New System.Drawing.Point(120, 184)
        ...
        Me.lstChildWOs.Location = New System.Drawing.Point(120, 88)
        Me.lstChildWOs.Name = "lstChildWOs"
        Me.lstChildWOs.Size = New System.Drawing.Size(176, 95)
        ...
        Me.Panel2.Controls.AddRange(New System.Windows.Forms.Control() {Me.chkSpecialProj, Me.lstChildWOs, Me.Label1, Me.txtChildWO, Me.cmbCustomer, Me.txtParentWO, Me.Label9, Me.lblChildWO, Me.Label3, Me.Label5, Me.cmbLoc})
        ...
        Me.chkSpecialProj.Location = New System.Drawing.Point(6, 208)
...
#End Region
    ...
    Private Sub txtParentWO_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtParentWO.Leave
        Try
            If Me.strParentWorkOrder <> Trim(Me.txtParentWO.Text) Then
                Me.ProcessParentWO()
            End If
        Catch ex As Exception
            MessageBox.Show(ex.ToString, "Get Work Order", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
    ...
    Private Sub cmdWOSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdWOSave.Click
        ...
        Try
            '************************************
            If Trim(Me.txtChildWO.Text) = "" And Me.iChildWOFlg = 1 Then
            ...
            If Me.cmbLoc.SelectedValue = 0 Then
                ...
                Exit Sub
            End If
            If Trim(Me.txtWOMemo.Text) = "" Then
                Me.txtWOMemo.Focus()
