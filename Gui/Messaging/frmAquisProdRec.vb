...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.btnCloseWO.Location = New System.Drawing.Point(312, 24)
            ...
            Me.btnRefreshRecData.Location = New System.Drawing.Point(496, 24)
            ...
            Try
                ...
                Else
                    ...
                    If strSNs.Trim.Length > 0 Then
                        MessageBox.Show("The following Serial number(s) existed in WIP:" & Environment.NewLine & strHasDeviceIDSNsList & "Please contact IT.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
                        Return False
                    End If
                    '**************************************
