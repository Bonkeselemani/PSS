...
Public Class frmAMDBRManifest
    ...
    Private _iCust_ID As Integer = 0 '14
    Private _iLoc_ID As Integer = 19
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'tpNER
        '
        Me.tpNER.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label5, Me.btnNER_ReprintLotLabel, Me.btnNERDelAll, Me.btnNERCreatLot, Me.rtxtNER_SN_cnt, Me.txtNER_SN, Me.Label4, Me.lstNER_SNs, Me.btnNERDelOne})
        ...
        Me.btnNERDelAll.Location = New System.Drawing.Point(208, 208)
        ...
        Me.rtxtNER_SN_cnt.Location = New System.Drawing.Point(208, 56)
        ...
        Me.lstNER_SNs.Size = New System.Drawing.Size(176, 342)
        ...
        Me.btnNERDelOne.Location = New System.Drawing.Point(208, 170)
...
#End Region
    ...
    Private Sub frmAMDBRManifest_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If _iCust_ID = PSS.Data.Buisness.SkyTel.AMS_CUSTOMER_ID Then
...
#Region "DBR Manifest TabPage"
    ...
    Private Sub btnCreateDBRLot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateDBRLot.Click
        ...
        Try
            ...
            '************************************
            strDBRPallett_name = Me._objDBRManifest.PalletizeAM_DBRPallet(Me._iLoc_ID, Me._iCust_ID, strDevice_IDsIN, Me._strWork_Dt, Me._dtDBRUnits.Rows.Count)
        ...
        Try
            If e.KeyCode = Keys.Enter Then
                If Me.txtSN.Text.Trim.Length > 0 Then
                    ...
                    '*****************************
                    strSNStatus = Me._objDBRManifest.CheckSN(strSN, iDevice_ID, iModelID, "DBR")
        ...
        Try
            ...
            Select Case Me._iCust_ID
                ...
                Case PSS.Data.Buisness.SkyTel.MorrisCom_CUSTOMER_ID
                    ...
                    Me._iLoc_ID = PSS.Data.Buisness.SkyTel.MorrisCom_LOC_ID
                Case PSS.Data.Buisness.SkyTel.Propage_CUSTOMER_ID
                    strRptTitle = "Propage "
                    strRptDir = "P:\Dept\Messaging\OtherManifest_Propage\"
                    Me._iLoc_ID = PSS.Data.Buisness.SkyTel.Propage_LOC_ID
                Case Else
            ...
            'Create and assigned Pallet to devices
            '************************************
            strToRepPallett_Name = Me._objDBRManifest.PalletizeAM_OutToRepPallet(Me._iLoc_ID, Me._iCust_ID, Me.lstRepSN, Me._strWork_Dt, Me.cmbSubContractor.SelectedValue, iPallett_ID)
...
#Region "NER Manifest TabPage"
    ...
    Private Sub btnNERCreatLot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNERCreatLot.Click
        ...
        Try
            ...
            'Create and assigned Pallet to devices
            '************************************
            strNERPallett_name = Me._objDBRManifest.PalletizeAM_NERPallet(Me._iLoc_ID, Me._iCust_ID, strDevice_IDsIN, Me._strWork_Dt, Me._dtNERUnits.Rows.Count, PSS.Core.ApplicationUser.IDShift)
    ...
    Private Sub txtNER_SN_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txtNER_SN.KeyDown
        Const iNER_BillcodeID As Integer = 89
        Dim strSN, strSNStatus As String
        ...
        Try
            If e.KeyCode = Keys.Enter Then
                If Me.txtNER_SN.Text.Trim.Length > 0 Then
                    ...
                    ' will be available(pass by reference)
                    '*****************************
                    strSNStatus = Me._objDBRManifest.CheckSN(strSN, iDevice_ID, iModelID, "NER")
                    ...
                    Else
                        ...
                        If dtBillingInfo.Rows.Count = 0 Then
                            ...
                            If Me._objDBRManifest.IsBillableBillcode(iNER_BillcodeID, iModelID) = False Then
                            ...
                            objDevice.AddPart(iNER_BillcodeID)
                            objDevice.Update()
                            dtBillingInfo = Me._objDBRManifest.GetDeviceBillingInfo(iDevice_ID)
                        End If
                        ...
                        ElseIf dtBillingInfo.Rows.Count > 1 Then
                            ...
                            Me.txtNER_SN.SelectAll()
                        ElseIf dtBillingInfo.Rows.Count = 1 And dtBillingInfo.Rows(0)("Billcode_ID") <> iNER_BillcodeID Then
...
#End Region
    ...
    Private Sub TabControl1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TabControl1.Click
        If Not _iCust_ID = PSS.Data.Buisness.SkyTel.AMS_CUSTOMER_ID Then
