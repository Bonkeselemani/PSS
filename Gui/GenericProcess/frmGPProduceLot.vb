...
#End Region
                    ...
                    Else
                        ...
                        Else
                            ...
                            Else
                                ...
                                i = Me._objGP.CreateManifest(R1("Pallett_ID"), _strManifestFilePath, 0)
                                If i = 0 Then
        ...
        Private Sub btnSelectLot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelectLot.Click
            ...
            Try
                ...
                ElseIf Me.cboCustomers.SelectedValue <> 2468 AndAlso Not File.Exists(strFilePath) Then
                    MessageBox.Show("Excel manifest was not found in '" & strFilePath & "'.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Else
                    If Me.cboCustomers.SelectedValue = 2468 Then _booHasASNFile = False
                    ...
                    Me._objBulkShip.strWorkDt = PSS.Core.ApplicationUser.Workdate
