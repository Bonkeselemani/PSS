...
Namespace Gui
    Public Class BillCodeEditWin
        ...
        Private _billCode As Integer = Nothing
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.btnUpdate.Location = New System.Drawing.Point(16, 296)
            ...
            Me.btnCancel.Location = New System.Drawing.Point(152, 296)
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.cboDeviceType, Me.lblDevice, Me.cboRepCode, Me.cboFailCode, Me.cboBillType, Me.cboBillRule, Me.btnCancel, Me.btnUpdate, Me.lblRepCode, Me.lblFailCode, Me.lblBillType, Me.lblBillRule, Me.txtDesc, Me.lblDesc})
...
#End Region
        ...
        Private Sub LoadBillCode()
            Dim dt As DataRow = BillCode.GetBillCode(_billCode)
            Me.txtDesc.Text = Convert.ToString(dt(1))
            Me.cboDeviceType.Text = Convert.ToString(dt("prod_desc"))
            Me.cboBillRule.Text = Convert.ToString(dt(2))
            Me.cboBillType.Text = Convert.ToString(dt(3))
            Me.cboFailCode.Text = Convert.ToString(dt(4))
            Me.cboRepCode.Text = Convert.ToString(dt(5))
        End Sub

        '********************************************************************************************
        Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
            Dim iExistedQty As Integer = 0
            Try
                ...
                Else
                    If _billCode = Nothing Then
                        ...
                        End If
                        '****************************************************
                        BillCode.InsertBillCode(Me.txtDesc.Text, Me.cboDeviceType.GetID, Me.cboBillRule.GetID, Me.cboBillType.GetID, Me.cboFailCode.GetID, Me.cboRepCode.GetID)
                    Else
                        BillCode.UpdateBillCode(Me.txtDesc.Text, Me.cboDeviceType.GetID, Me.cboBillRule.GetID, Me.cboBillType.GetID, Me.cboFailCode.GetID, Me.cboRepCode.GetID, _billCode)
                    End If
