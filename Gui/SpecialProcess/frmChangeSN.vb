...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.RadioNone, Me.RadioMSN, Me.RadioIMEI, Me.RadioESN, Me.RadioDecimal})
        Me.GroupBox1.Location = New System.Drawing.Point(8, 48)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(144, 152)
        ...
        Me.RadioNone.Location = New System.Drawing.Point(21, 119)
...
#End Region
        ...
        If e.KeyValue = 13 Then
            ...
            Try
                ...
                If dt1.Rows.Count = 0 Then
                    Throw New Exception("Device not found or already assigned to a pallet.")
                End If
    ...
    Private Sub RadioNonCellSN_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub cmdChangeSN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdChangeSN.Click
        ...
        Try
            ...
            If MessageConfirmation(strSNType) = DialogResult.Yes Then
                '***************************************************
                'Check if current SN is on a pallet
                '***************************************************
                If Me.objMISC.CheckSNPalletized(Me.iCust_ID, Trim(Me.txtNewSN.Text)) = True Then
                    MessageBox.Show("'Current SN' is already assigned to a pallet. Can not change it now. If you want to change it you must remove it from the pallet.", "Current SN has Pallet", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtNewSN.Focus()
                    Exit Sub
                End If
                '***************************************************
                ...
                If booNewSNExistedInWIP = True Then
                    MessageBox.Show("'New SN' already exists in WIP.", "New SN exists", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Me.txtNewSN.Focus()
                    Exit Sub
                End If
