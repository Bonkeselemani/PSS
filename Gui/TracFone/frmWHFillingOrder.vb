...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(Optional ByVal strScreenName As String = "")
            MyBase.New()
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            "ading{Wrap:True;Font:Microsoft Sans Serif, 8.25pt, style=Bold;AlignVert:Center;B" & _
            ...
            'GroupBox1
            '
            Me.GroupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnRefreshList, Me.btnCopySelectedRows, Me.btnCopyAll, Me.btnPrintAvailableBoxRpt, Me.lblPODate, Me.Label4, Me.lblQty, Me.Label2, Me.lblModel, Me.Label8, Me.cboOpenOrders, Me.Label5})
            ...
            Me.btnCopySelectedRows.Location = New System.Drawing.Point(352, 137)
            ...
            Me.btnCopyAll.Location = New System.Drawing.Point(264, 136)
            ...
            Me.btnPrintAvailableBoxRpt.Location = New System.Drawing.Point(464, 80)
            Me.btnPrintAvailableBoxRpt.Name = "btnPrintAvailableBoxRpt"
            Me.btnPrintAvailableBoxRpt.Size = New System.Drawing.Size(51, 27)
            ...
            Me.btnFillOrder.Location = New System.Drawing.Point(168, 504)
            Me.btnFillOrder.Name = "btnFillOrder"
            Me.btnFillOrder.Size = New System.Drawing.Size(224, 27)
            ...
            Me.btnRefreshList.Location = New System.Drawing.Point(136, 136)
...
#End Region
                ...
                With Me.dbgAvailableBoxes
                    ...
                    For i = 0 To dt.Columns.Count - 1
                        ...
                        ElseIf dt.Columns(i).Caption = "Box Type" Then
                            .Splits(0).DisplayColumns(i).Width = 85
                            .Splits(0).DisplayColumns(i).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Far
            ...
            Try
                ...
                If Me.cboOpenOrderTobeFilled.SelectedValue > 0 Then
                    If Me._objWH.GetOrderFilledBoxCnt(Me.cboOpenOrderTobeFilled.SelectedValue) > 0 Then
                        MessageBox.Show("This order has some box assigned to to it. Please contact IT immediately.", "Verify Partial Order", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Else
                        If Not IsNothing(Me.cboOpenOrderTobeFilled.SelectedValue) Then
        ...
        ''********************************************************************
        'Private Sub btnPrintAvailableBoxRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintAvailableBoxRpt.Click
        '    Dim strOrderNo, strItemNo, strItemDesc As String
        '    Dim iOrderQty, iModelID As Integer

        '    Try
        '        strOrderNo = "" : strItemNo = "" : strItemDesc = "" : iOrderQty = 0 : iModelID = 0

        '        strOrderNo = Me.cboOpenOrders.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("WO_CustWO")
        '        strItemNo = Me.cboOpenOrders.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("VN_ItemNo")
        '        strItemDesc = Me.cboOpenOrders.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("LineItemDetail")
        '        iOrderQty = CInt(Me.cboOpenOrders.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("OrderQty"))
        '        iModelID = Me.cboOpenOrders.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("Model_ID")
        '        Me._objWH.PrintBoxReadyToBeFilled(strOrderNo, strItemNo, strItemDesc, iOrderQty, iModelID)
        '        Me.cboOpenOrders.Focus()
        '    Catch ex As Exception
        '        MessageBox.Show(ex.ToString, "btnPrintAvailableBoxRpt_Click", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '    End Try
        'End Sub
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    Else
                        ...
                        ElseIf dt.Rows(0)("Pallet_ShipType") > 0 AndAlso (dt.Rows(0)("Model_Desc") & "X").ToString.ToLower <> Me.cboOpenOrderTobeFilled.DataSource.Table.Select("WO_ID = " & Me.cboOpenOrders.SelectedValue)(0)("VN_ItemNo").ToString.ToLower Then
                            MessageBox.Show("Model of Box and Order does not match.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                            Me.txtBoxName.SelectAll()
                        ElseIf dt.Rows(0)("Pallet_ShipType") = 0 AndAlso Me.HasBatteryCoverAssigned(dt.Rows(0)("Pallett_ID")) = False Then
                            Me.txtBoxName.SelectAll()
                        Else
                            Me.btnFillOrder.Enabled = True
                            Me.btnRemoveAllBoxes.Enabled = True
            ...
            Try
                ...
                Else
                    ...
                    ElseIf dt.Select("pkslip_ID is not null AND pkslip_ID > 0").Length > 0 Then
                        ...
                        Me.txtBoxName.Focus()
                    ElseIf dt.Select("Cust_ID <> 2258").Length > 0 Then
