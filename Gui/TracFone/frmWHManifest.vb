...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.lstOrders.Location = New System.Drawing.Point(160, 152)
            Me.lstOrders.Name = "lstOrders"
            Me.lstOrders.Size = New System.Drawing.Size(192, 324)
            ...
            Me.dbgWaitingPackingSlip.Images.Add(CType(resources.GetObject("resource.Images1"), System.Drawing.Bitmap))
            Me.dbgWaitingPackingSlip.Location = New System.Drawing.Point(384, 6)
            ...
            Me.dbgWaitingPackingSlip.Size = New System.Drawing.Size(520, 538)
            ...
            " DefRecSelWidth=""16"" VerticalScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>5" & _
            ...
            """ me=""Style6"" /><Style parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 516, 534<" & _
            ...
            "ultRecSelWidth>16</DefaultRecSelWidth><ClientArea>0, 0, 516, 534</ClientArea><Pr" & _
...
#End Region
        ...
        Private Sub PopulateWaitingPackingOrder()
            ...
            Try
                ...
                dt = Me._objWH.GetTFOrderReadyForPackingSlip()
        ...
        Private Function ProcessTFOrder()
            ...
            Try
                ...
                ElseIf Me._dtOrders.Select("[Order #] = '" & Me.txtOrderNo.Text.Trim & "'").Length > 0 Then
                    ...
                    Me.txtOrderNo.Focus()
                Else
                    dt = Me._objWH.GetOrderToBeManifestByOrderNo(Me.txtOrderNo.Text.Trim)
                    ...
                    Else
                        ...
                        If Not IsDBNull(dt.Compute("sum(Pallett_QTY)", "")) Then R1("Qty") = dt.Compute("sum(Pallett_QTY)", "") Else R1("Qty") = 0
                        Me._dtOrders.Rows.Add(R1)
                        Me._dtOrders.AcceptChanges()
                        Me.lstOrders.Refresh()

                        Me.lblBoxQty.Text = CInt(Me.lblBoxQty.Text) + dt.Rows.Count
                        Me.lblTotalQty.Text = CInt(Me.lblTotalQty.Text) + R1("Qty")
                        Me.txtOrderNo.Text = ""
                        Me.btnRemoveOneItem.Enabled = True
                        Me.btnRemoveAllItems.Enabled = True
                        Me.btnCreatePackingSlip.Enabled = True
        ...
        Private Sub btnCreatePackingSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreatePackingSlip.Click
            ...
            Try
                ...
                Else
                    ...
                    dt = Me._objWH.GetOrdersToBeManifestbyWOIDs(strWOIDs)
                    If dt.Rows.Count = 0 Then
                    ...
                    Else
                        ...
                        Me._objWH.CreateManifest(Me._dtOrders, strWOIDs, PSS.Core.[Global].ApplicationUser.IDuser, Me.cboCarrier.SelectedValue, Me.txtTracingNo.Text.Trim.ToUpper)
            ...
            Try
                ...
                Else
                    ...
                    ElseIf Not IsDBNull(R1("pkslip_id")) AndAlso CInt(R1("pkslip_id")) > 0 Then
                        Me._objWH.PrintBillsOfLadingReport(R1("pkslip_id"))
                    Else
            ...
            Try
                ...
                Else
                    ...
                    If R1("wo_closed") = 0 Then
                        MessageBox.Show("WO is still open.", "Information", MessageBoxButtons.OK)
                    ElseIf Not IsDBNull(R1("pkslip_id")) AndAlso CInt(R1("pkslip_id")) > 0 Then
                        Me._objWH.PrintShipmentLabelReport(R1("pkslip_id"))
                    Else
                        MessageBox.Show("Pkslip is not available.", "Information", MessageBoxButtons.OK)
                    End If
                End If
