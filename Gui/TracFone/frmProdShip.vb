...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            "yle=""DottedCellBorder"" RecordSelectorWidth=""16"" DefRecSelWidth=""16"" VerticalScro" & _
...
#End Region
        ...
        Private Sub ProcessPallet()
            Dim iExcelNum, iPSSNum, i, iWrtyStatus, iManufID As Integer
            Dim R1, drWipWO As DataRow
            ...
            Try
                iExcelNum = 0 : iPSSNum = 0 : i = 0 : iWrtyStatus = 0 : iManufID = 0
                ...
                If iExcelNum > 0 Then
                    ...
                    For Each R1 In _objBulkShip.dtExcelSNs.Rows
                        ...
                        'Bill Services
                        '********************************
                        objTFBilling.BillServices(R1, Me.iShipType, Me._objBulkShip.iCust_ID)
                        '********************************
                    Next R1

                    'move receipt date to 30days range and repair date in between receiving and shipping date. LG and Samsung ONLY
                    If Me.iShipType = 0 AndAlso (iManufID = 16 OrElse iManufID = 21) Then objTFBilling.FixLGSSReceiptDate(Me._objBulkShip.iPallet_ID)
