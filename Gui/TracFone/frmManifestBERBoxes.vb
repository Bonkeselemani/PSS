        ...
        Private Sub PopulateReadyToBeManifestBERBoxes()
            ...
            Try
                ...
                With Me.dgBCBoxes
                    ...
                    .Columns("Box Qty").FooterText = dt.Compute("Sum([Box Qty])", "")
                    .Columns("Station Qty").FooterText = dt.Compute("Sum([Station Qty])", "")
                End With
        ...
        Private Sub btnCreateManifest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateManifest.Click
            ...
            Try
                ...
                Else
                    ...
                    Else
                        Me.Enabled = False : Cursor.Current = Cursors.WaitCursor
                        Me._objWH.CreateBERManifest(strPalletIDs, PSS.Core.ApplicationUser.IDuser)
                        _dtBoxes.Clear()
                        _dtBoxes.AcceptChanges()
                        Me.lstBoxes.Refresh()
                        Me.lblCount.Text = Me._dtBoxes.Rows.Count
