...
Namespace Production
    ...
    Public Class lbillcodes
        ...
        '    Dim strSql As String = "SELECT * FROM lbillcodes"
        ...
        Public Shared Function GetMaxBillCode() As DataRow
            Dim strSql As String = "SELECT MAX(BillCode_ID) as BC_ID FROM lbillcodes"
