...
Namespace Production
	...
	Public Class llaborlvl
        ...
        '	Dim strSql As String = "SELECT * FROM llaborlvl"
        ...
        Public Shared Function LaborLvlList() As DataTable
            Dim strSql As String = "Select * from llaborlvl ORDER BY llaborlvl.LaborLvl_Desc"
