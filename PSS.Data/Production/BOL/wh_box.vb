...
#Region "METHODS"
		...
		Protected Function GetDeleteStatement() As String
			Dim _sql As String
			_sql = "DELETE FROM warehouse.wh_box "
			_sql += "WHERE whb_id = " & _whb_id.ToString() & " LIMIT 1;"
			Return _sql
		End Function
		Public Sub Delete()
		...
		Protected Function Insert() As Integer
			...
			Try
				...
				strSQL = "INSERT INTO warehouse.wh_box (" & _
				  ...
				  ") " & _
				  "VALUES ( " & _
				   ConvertBackToNullString(_cpl_id, False) & " , " & _
				   ConvertBackToNullString(_disp_id, False) & " , " & _
				   ConvertBackToNullString(_box_na, True) & " , " & _
				   ConvertBackToNullString(_model_id, False) & " , " & _
				   IIf(_closed, 1, 0) & " , " & _
				   ConvertToMySQLDateOrNullString(_ship_date) & " , " & _
				   ConvertBackToNullString(_quantity, False) & " , " & _
				   ConvertBackToNullString(_cust_id, 0) & " , " & _
...
#Region "PROPERTIES"
		Public ReadOnly Property whb_id() As Integer
			...
			End Get
		End Property
		Public ReadOnly Property cpl_id() As Integer
			Get
				Return _cpl_id
			End Get
		End Property
		Public ReadOnly Property disp_id() As Integer
			Get
				Return _disp_id
			End Get
		End Property
		Public ReadOnly Property disp_na() As String
			Get
				Return _disp_na
			End Get
		End Property
		...
		Public ReadOnly Property bin_id() As Integer
			...
			End Get
		End Property
		Public ReadOnly Property bin_na() As String
			Get
				Return _bin_na
			End Get
		End Property
...
#Region "METHODS"
		...
		Private Sub PopulateObject(ByVal _dr As DataRow)
			...
			_bin_na = ConvertToSomething(_dr("bin_na"), "")
			_bin_id = ConvertToSomething(_dr("bin_id"), 0)
			_crt_ts = ConvertToSomething(_dr("crt_ts").ToString(), "")
		...
		Protected Function GetSelectStatement(ByVal box_na As String) As String
			...
			_sb.Append("wb.cpl_id, ")
			_sb.Append("wb.disp_id, ")
...
#End Region
	End Class
	Public Class wh_box_by_sn_readonly
#Region "DECLARATIONS"
...
#End Region
	End Class
	Public Class wh_box_by_device_id_readonly
#Region "DECLARATIONS"
...
#Region "METHODS"
		...
		Protected Function GetSelectStatement(ByVal device_id As Integer) As String
			...
			_sb.Append("LEFT JOIN warehouse.wh_bins bins ON wb.bin_id = bins.bin_id ")
			_sb.Append("LEFT JOIN security.tusers u ON wb.crt_user_id = u.user_id ")
			_sb.Append("WHERE itm.device_id = " & device_id & " ")
			Return _sb.ToString()
		End Function
...
#End Region
	End Class
	Public Class wh_box_whwip_with_reploc_collection
#Region "DECLARATIONS"
...
#Region "METHODS"
		...
		Protected Function GetSelectStatement() As String
			...
			_sb.Append("b.bin_na, ")
			_sb.Append("CASE ")
			_sb.Append("WHEN cpl.loc_na = 'WH-FLOOR' and wb.disp_id = 2 THEN 'SOF' ")
			_sb.Append("WHEN cpl.loc_na = 'WH-FLOOR' and wb.disp_id = 3 THEN 'FUN' ")
			_sb.Append("WHEN cpl.loc_na = 'WH-FLOOR' and wb.disp_id = 4 THEN 'COS' ")
			_sb.Append("WHEN cpl.loc_na = 'WH-FLOOR' and wb.disp_id = 5 THEN 'NTF' ")
			_sb.Append("ELSE cpl.loc_na END AS loc_na ")
			_sb.Append("FROM warehouse.wh_box wb ")
...
#End Region
	End Class
	Public Class wh_box_whwip_no_reploc_collection
#Region "DECLARATIONS"
...
#Region "PROPERTIES"
		...
		Public ReadOnly Property NextBoxNr() As String
			Get
				...
				_incr = Data.BaseClasses.StringFunctions.PadZeros(4, (Right(_LastBoxNr, 4) + 1))
...
#Region "METHODS"
		...
		Protected Function GetSelectStatement(ByVal BoxPrefix As String) As String
			...
			_sb.Append("boxid ")
			_sb.Append("FROM edi.titem ")
			_sb.Append("WHERE boxid like '" & BoxPrefix & "%' ")
			_sb.Append("UNION SELECT ")
			_sb.Append("box_na as boxid ")
			_sb.Append("FROM warehouse.wh_box ")
			_sb.Append("WHERE box_na like '" & BoxPrefix & "%' ")
			_sb.Append("ORDER BY boxid DESC; ")
			Return _sb.ToString()
		End Function
#End Region
	End Class
