...
Public Class CDMASim

#Region "DECLARATIONS"

		Dim _sn As String = ""
		Dim _snLen As Integer = 20
		Dim _prefixLen As Integer = 14
		Dim _incrPos As Integer = 14
		Dim _incrLen As Integer = 5
		Dim _chksumPos As Integer = 19
...
#Region "PROPERTIES"
		...
		Public ReadOnly Property SerialNumber_Calculated() As String
			Get
				Return Prefix & Incremental & Checksum_Calculated
			End Get
		End Property
		...
		Public ReadOnly Property Checksum_Calculated() As String
			Get
				...
				Dim i As Integer = 0
				Dim idWithoutCheckdigit As String = _sn.Substring(0, _sn.Length - 1)
		...
		'Public ReadOnly Property Checksum_CalculatedOLD() As String
		'	Get
		'		Return ""
		'	End Get
		'End Property
