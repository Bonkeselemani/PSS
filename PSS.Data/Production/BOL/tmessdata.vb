...
#Region "PROPERTIES"
		...
		Public Property sn_change_userid() As Integer
			...
			End Set
		End Property
		Public Property sn_change_date() As String
			Get
		...
		Public Property capcode_change_userid() As Integer
			...
			End Set
		End Property
		Public Property capcode_change_date() As String
			Get
		...
		Public Property baud_id_change_userid() As Integer
			...
			End Set
		End Property
		Public Property baud_id_change_date() As String
			Get
		...
		Public Property freq_id_change_userid() As Integer
			...
			End Set
		End Property
		Public Property freq_id_change_date() As String
			Get
		...
		Public Property label_userid() As Integer
			...
			End Set
		End Property
		Public Property label_workdate() As String
			Get
		...
		Public Property EvalUserID() As Integer
			...
			End Set
		End Property
		Public Property EvalDateTime() As String
			Get
			...
			End Set
		End Property
		Public Property EvalFlag() As Short
			Get
				Return _evalflag
			End Get
		...
		Public Property Final_Billing_UserID() As Integer
			...
			End Set
		End Property
		Public Property QR_PSSWtyUpdateDT() As String
			Get
		...
		Public Property wipowner_id() As Short
			...
			End Set
		End Property
		Public Property wipowner_EntryDt() As String
			Get
		...
		Public Property qcresult_id() As Byte
			...
			End Set
		End Property
		Public Property qcwork_date() As String
			Get
				Return _qcwork_date
			End Get
			Set(ByVal Value As String)
		...
		Public Property aqlreject() As Byte
			...
			End Set
		End Property
		Public Property aqlreject_date() As String
			Get
		...
		Public Property UpdCust_UserID() As Integer
			...
			End Set
		End Property
		Public Property UpdCust_DT() As String
			Get
				Return _updcust_dt
			End Get
			Set(ByVal Value As String)
...
#Region "METHODS"
		...
		Private Sub PopulateObject(ByVal _dr As DataRow)
			...
			_evalflag = ConvertToSomething(_dr("evalflag"), 0)
		...
		'		_sb.Append("EvalFlag = " & EvalFlag.ToString() & ", ")
		...
		Protected Function Update() As Integer
			...
			Try
				...
				objDataProc = New DBQuery.DataProc(ConfigFile.GetConnectionInfo)
				strToday = PSS.Data.Buisness.Generic.GetMySqlDateTime("%Y-%m-%d")
				strSQL = "UPDATE production.tmessdata SET " & _
				   "md_id = " & ConvertBackToNullString(_md_id, False) & ", " & _
				   "sn_changed = " & ConvertToSomething(_sn_changed, 0) & ", " & _
				   "sn_change_userid = " & ConvertBackToNullString(_sn_change_userid, False) & ", " & _
				   "sn_change_date = " & ConvertToMySQLDateOrNullString(_sn_change_date) & ", " & _
				   "capcode = " & ConvertBackToNullString(_capcode, True) & ", " & _
				   "capcode_old = " & ConvertBackToNullString(_capcode_old, True) & ", " & _
				   "capcode_change_userid = " & ConvertBackToNullString(_capcode_change_userid, False) & ", " & _
				   "capcode_change_date = " & ConvertToMySQLDateOrNullString(_capcode_change_date) & ", " & _
				   "baud_id = " & ConvertBackToNullString(_baud_id, False) & ", " & _
				   "baud_id_old = " & ConvertBackToNullString(_baud_id_old, False) & ", " & _
				   "baud_id_change_userid = " & ConvertBackToNullString(_baud_id_change_userid, False) & ", " & _
				   "baud_id_change_date = " & ConvertToMySQLDateOrNullString(_baud_id_change_date) & ", " & _
				   "freq_id = " & ConvertBackToNullString(_freq_id, False) & ", " & _
				   "freq_id_old = " & ConvertBackToNullString(_freq_id_old, False) & ", " & _
				   "freq_id_change_userid = " & ConvertBackToNullString(_freq_id_change_userid, False) & ", " & _
				   "freq_id_change_date = " & ConvertToMySQLDateOrNullString(_freq_id_change_date) & ", " & _
				   "label_userid = " & ConvertBackToNullString(_label_userid, False) & ", " & _
				   "label_workdate = " & ConvertToMySQLDateOrNullString(_label_workdate) & ", " & _
				   "sku = " & ConvertBackToNullString(_sku, True) & ", " & _
				   "camewithfileflag = " & ConvertToSomething(_camewithfileflag, 0) & ", " & _
				   "wo_id = " & ConvertToSomething(_wo_id, 0) & ", " & _
				   "device_id = " & ConvertBackToNullString(_device_id, False) & ", " & _
				   "evalbillcode_id = " & ConvertToSomething(_evalbillcode_id, 0) & ", " & _
				   "evalcharges = " & ConvertToSomething(_evalcharges, 0.0) & ", " & _
				   "evaluserid = " & ConvertToSomething(_evaluserid, 0) & ", " & _
				   "evaldatetime = " & ConvertToMySQLDateOrNullString(_evaldatetime) & ", " & _
				   "evalflag = " & ConvertToSomething(_evalflag, 0) & ", " & _
				   "final_billing_userid = " & ConvertBackToNullString(_final_billing_userid, False) & ", " & _
				   "qr_psswtyupdatedt = " & ConvertToMySQLDateOrNullString(_qr_psswtyupdatedt) & ", " & _
				   "qr_psswtyupdateusrid = " & ConvertBackToNullString(_qr_psswtyupdateusrid, False) & ", " & _
				   "wipowner_id = " & ConvertToSomething(_wipowner_id, 0) & ", " & _
				   "wipowner_entrydt = " & ConvertToMySQLDateOrNullString(_wipowner_entrydt) & ", " & _
				   "wipowner_id_old = " & ConvertBackToNullString(_wipowner_id_old, False) & ", " & _
				   "wipownersubloc_id = " & ConvertToSomething(_wipownersubloc_id, 0) & ", " & _
				   "qcresult_id = " & ConvertBackToNullString(_qcresult_id, False) & ", " & _
				   "qcwork_date = " & ConvertToMySQLDateOrNullString(_qcwork_date) & ", " & _
				   "aqlreject = " & ConvertBackToNullString(_aqlreject, False) & ", " & _
				   "aqlreject_date = " & ConvertToMySQLDateOrNullString(_aqlreject_date) & ", " & _
				   "inventoryflag = " & ConvertToSomething(_inventoryflag, 0) & ", " & _
				   "rec_cust_id = " & ConvertToSomething(_rec_cust_id, 0) & ", " & _
				   "fcp_id = " & ConvertToSomething(_fcp_id, 0) & ", " & _
				   "updcust_userid = " & ConvertToSomething(_updcust_userid, 0) & ", " & _
				   "updcust_dt = " & ConvertToMySQLDateOrNullString(_updcust_dt) & ", " & _
				   "prevcustid = " & ConvertToSomething(_prevcustid, 0) & ", " & _
				   "afspqty_id = " & ConvertToSomething(_afspqty_id, 0) & " " & _
				 "WHERE MD_ID = " & MD_ID.ToString() & "; "
