...
#Region "METHODS"
		...
		Private Sub PopulateObject(ByVal _dr As DataRow)
			...
			_wipowner_id = DirectCast(_dr("wipowner_id"), Integer)
			_wipowner_desc = _dr("wipowner_desc").ToString()
			_ams_wipflow = DirectCast(_dr("ams_wipflow"), Integer)
			_wipset = _dr("wipset").ToString()
			_inactive = DirectCast(_dr("inactive"), Integer)
		End Sub
		...
		Protected Function Insert() As Integer
			...
			Try
				...
				strSQL = "INSERT INTO production.lwipowner_set2 (" & _
				   "wipowner_id, " & _
				   "wipowner_desc, " & _
				   "ams_wipflow, " & _
				   "wipset, " & _
...
#End Region
	...
	Public Class lwipowner_set2Collection
#Region "DECLARATIONS"
...
#Region "PROPERTIES"
		...
		Public ReadOnly Property lwipowner_set2DataTable() As DataTable
			Get
				Return _dt
			End Get
		End Property
