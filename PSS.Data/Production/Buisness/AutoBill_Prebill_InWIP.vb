...
Namespace Buisness
    ...
    Public Class AutoBill_Prebill_InWIP
        ...
        Public Function Create563ReveueReportLevel2And3(ByVal iCust_ID As Integer, _
            ...
            Try
                ...
                ElseIf iNoSlvg_OR_Level2And3_Flg = 3 Then 'In Wip Have Prebill Lot
                    strFilePath = "c:\RevenueReport563_PreBillInWIP.xls"
                    strRptTitle = "563 Revenue Report (Pre-Bill Device In WIP)"
                    strDateRange = "Report Date: " & Format(Now, "MM/dd/yyyy")
                End If
                ...
                If iNoSlvg_OR_Level2And3_Flg = 3 Then
                    '***********************************************
                    'Get Consumed Labor
                    '***********************************************
                    dtConsumedLabor_Model = Me.GetLaborAmt_Prebill(iCust_ID, iModel_ID, 0, strDevIDs)
                    '***********************************************
                    'Get Consumed Parts Invoice Amt
                    '***********************************************
                    dtConsumedInvoiceAmt_Model = Me.GetPartsPlusServiceInvoiceAmt_Prebill(iCust_ID, iModel_ID, 0, strDevIDs)
                    '***********************************************
                    'Get Auto Billed Labor
                    '***********************************************
                    dtAutoBilledLabor_Model = Me.GetLaborAmt_Prebill(iCust_ID, iModel_ID, 1, strDevIDs)
                    '***********************************************
                    'Get Auto-billed Parts Invoice Amt
                    '***********************************************
                    dtAutoBilledInvoiceAmt_Model = Me.GetPartsPlusServiceInvoiceAmt_Prebill(iCust_ID, iModel_ID, 1, strDevIDs)
                Else
                    '***********************************************
                    'Get Consumed Labor
                    '***********************************************
        ...
        Private Function GetAllDeviceIDsWithLaborLvlsGreaterThanOne(ByVal strFromDt As String, _
            ...
            Try
                ...
                ElseIf iNoSlvg_OR_Level2And3_Flg = 2 Then
                    ...
                    strSql &= "from tdevice " & Environment.NewLine
                    strSql &= "inner join tlocation on tdevice.Loc_ID = tlocation.Loc_ID " & Environment.NewLine
                    strSql &= "inner join tdevicebill_563_prebill_temp on tdevice.Device_ID = tdevicebill_563_prebill_temp.Device_ID " & Environment.NewLine
                    strSql &= "where  " & Environment.NewLine
                    strSql &= "Device_ShipWorkDate >= '" & strFromDt & "' and " & Environment.NewLine
                    strSql &= "Device_ShipWorkDate <= '" & strToDt & "' and " & Environment.NewLine
                    strSql &= "tlocation.cust_ID = " & iCust_ID & " and " & Environment.NewLine
                    If iModel_ID > 0 Then
                        strSql &= "tdevice.Model_ID = " & iModel_ID & " and " & Environment.NewLine
                    End If
                    strSql &= "tdevicebill_563_prebill_temp.DBill_Condition  not in (1, 2, 3) " & Environment.NewLine
                    strSql &= "order by device_id;"
                ElseIf iNoSlvg_OR_Level2And3_Flg = 0 Then
                    ...
                    strSql &= "order by device_id;"
                ElseIf iNoSlvg_OR_Level2And3_Flg = 3 Then
                    strSql = "Select distinct tdevice.device_id " & Environment.NewLine
                    strSql &= "from tdevice " & Environment.NewLine
                    strSql &= "inner join tlocation on tdevice.Loc_ID = tlocation.Loc_ID " & Environment.NewLine
                    strSql &= "inner join cstincomingdata on tdevice.Device_ID = cstincomingdata.Device_ID " & Environment.NewLine
                    ...
                    End If
                    strSql &= "AND Device_LaborLevel_AutoBilled_temp is not null " & Environment.NewLine
        ...
        Public Function GetLaborAmt(ByVal strFromDt As String, _
            ...
            Try
                ...
                Else
                    strSql &= "sum(Device_LaborCharge_AutoBilled_temp) as 'Auto-billed Labor' " & Environment.NewLine
                End If
        ...
        '***************************************************************************
        Public Function GetLaborAmt_Prebill(ByVal iCust_ID As Integer, _
                                            ByVal iModel_ID As Integer, _
                                            ByVal iAutoBill As Integer, _
                                            Optional ByVal strDevIDs As String = "") _
                                            As DataTable
        ...
        '***************************************************************************
        Public Function GetPartsPlusServiceInvoiceAmt_Prebill(ByVal iCust_ID As Integer, _
                                                    ByVal iModel_ID As Integer, _
                                                    ByVal iAutoBill As Integer, _
                                                    Optional ByVal strDevIDs As String = "") _
                                                    As DataTable
            ...
            Try
                ...
                Else
                    ...
                    If boovar = False Then
                        'COMMENT B/C WE DON'T WANT TO TRANSFER ANY SALVAGE DEVICES
                        '''//************************************
                        '''move all parts and services for the device
                        '''//************************************
                    ...
                    Else
                        ...
                        If boovar = False Then      'if the device is not auto billed
                            ...
                            '  from tdevicebill to tdevicebill_563_prebill_temp
                            '//********************************************
                                ...
                                Else    'Device not from Brightpoint
                                    ...
                                    Else
                                        ...
                                        Else
                                            ...
                                            End If      'decConsumedTotal > decBERCap
        ...
        Private Function GetTargetAmount(ByVal iCust_ID As Integer, _
                                         ByVal iModel_ID As Integer, _
                                         ByVal strEnterprise As String, _
                                         ByRef decBERCap As Decimal) As Decimal
            Dim strsql As String = ""
            Dim dt1 As DataTable
            Dim decTarget As Decimal = 0
            ...
            Try
                ...
                For Each R1 In dt1.Rows
                    ...
                    If Not IsNothing(dt2) Then
                        ...
                        dt2 = Nothing
                    End If
                    strsql = "select count(*) as cnt from tdevicebill_563_prebill_temp " & Environment.NewLine
                    ...
                    If dt2.Rows(0)("cnt") = 0 Then
                        ...
                        '********************************************
                        strsql = "insert into tdevicebill_563_prebill_temp (DBill_Condition, " & Environment.NewLine
        ...
        '***************************************************************************
        'Get all services from tdevicebill that missing in tdevicebill_563_prebill_temp and
        ' and start bill them. This will give tdevicebill and tdevicebill_563_prebill_temp have the same 
        ' service billcodes.
        '***************************************************************************
        Private Function AutoBillConsumedServices(ByVal strServerDateTime As String, _
            ...
            Try
                ...
                For Each R1 In dt1.Rows
                    ...
                    '**********************************************
                    'Billcode does not exist then add to tdevicebill_563_prebill_temp
                    '**********************************************
                    If dt2.Rows(0)("cnt") = 0 Then
        ...
        Public Function GetDevicesShippedByLocationByWorkDt(ByVal iLoc_ID As Integer, _
            ...
            Try
                ...
                strsql = "SELECT DISTINCT tdevice.*, tmodeltarget.AutoBill, " & Environment.NewLine
                strsql &= "csin_EnterpriseCode as Enterprise " & Environment.NewLine
                strsql &= "FROM tdevice " & Environment.NewLine
                strsql &= "INNER JOIN cstincomingdata on tdevice.device_id = cstincomingdata.device_id " & Environment.NewLine
                strsql &= "inner join tlocation on tdevice.loc_id = tlocation.loc_ID " & Environment.NewLine
                strsql &= "INNER JOIN tmodeltarget ON tdevice.Model_ID = tmodeltarget.MT_Model_ID AND tlocation.Cust_ID = tmodeltarget.CM_Cust_ID AND cstincomingdata.csin_EnterpriseCode = tmodeltarget.MT_Enterprise " & Environment.NewLine
                ...
                strsql &= "AND tdevice.Device_LaborLevel_AutoBilled_temp is null;"
        ...
        Public Function GetModelsShippedByLocationByWorkDt(ByVal iLoc_ID As Integer, _
            ...
            Try
                '//Get all Brightpoint Shipped Devices today.
                strsql = "Select distinct tmodel.Model_ID, " & Environment.NewLine
                ...
                strsql &= "inner join tlocation on tdevice.loc_id = tlocation.loc_ID " & Environment.NewLine
                strsql &= "INNER JOIN tmodeltarget ON tdevice.model_ID = tmodeltarget.MT_Model_ID AND tlocation.Cust_ID = tmodeltarget.CM_Cust_ID AND cstincomingdata.csin_EnterpriseCode = tmodeltarget.MT_Enterprise " & Environment.NewLine
                strsql &= "where loc_id = " & iLoc_ID & " and " & Environment.NewLine
        ...
        Public Function CheckIfDeviceAutoBilledAlready(ByVal iDevice_ID As Integer) As Boolean
            ...
            Try
                'Check if the device is already auto-billed
                strsql = "Select * from tdevicebill_563_prebill_temp where device_id = " & iDevice_ID & ";"
                objMisc._SQL = strsql
                dt2 = objMisc.GetDataTable
        ...
        Public Function AutoBill_Brightpoint(ByVal strServerDateTime As String, _
            ...
            Try
                ...
                If Not IsDBNull(dt1.Rows(0)("Device_LaborLevel_AutoBilled_temp")) Then
                    iCurLaborLevel = dt1.Rows(0)("Device_LaborLevel_AutoBilled_temp")
                Else
                    iCurLaborLevel = 0
                End If

                If Not IsDBNull(dt1.Rows(0)("Device_LaborCharge_AutoBilled_temp")) Then
                    decCurrentLaborCharge = dt1.Rows(0)("Device_LaborCharge_AutoBilled_temp")
                Else
                ...
                'Insert in to tdevicebill_563_prebill_temp
        ...
        Public Function GetCurrent563LaborLevelForDevice(ByVal iDevice_id As Integer) As DataTable
            ...
            Try
                ...
                'strSql &= "from tdevicebill_563_prebill_temp " & Environment.NewLine
                'strSql &= "inner join tpsmap on tdevicebill_563_prebill_temp.BillCode_ID = tpsmap.BillCode_ID " & Environment.NewLine
                'strSql &= "where tdevicebill_563_prebill_temp.device_id = " & iDevice_id & " "
                'strSql &= " and tpsmap.model_id = " & iModel_id & ";"

                strSql = "Select Device_LaborLevel_AutoBilled_temp, Device_LaborCharge_AutoBilled_temp from tdevice where device_id = " & iDevice_id & ";"
        ...
        Public Function UpdateLaborInfo_Autobill(ByVal iDevice_ID As Integer, _
            ...
            Try
                ...
                If strDateTime <> "" Then
                    strSql &= "SET Device_DateBill_AutoBilled_temp = '" & strDateTime & "', " & Environment.NewLine
                Else
                    strSql &= "SET Device_DateBill_AutoBilled_temp = Device_DateBill, " & Environment.NewLine
                End If

                If iCurLaborLevel > 0 Then
                    strSql &= "Device_LaborLevel_AutoBilled_temp = " & iCurLaborLevel & ", " & Environment.NewLine
                Else
                    strSql &= "Device_LaborLevel_AutoBilled_temp = Device_LaborLevel, " & Environment.NewLine
                End If

                If DecCurLaborChg > 0 Then
                    strSql &= "Device_LaborCharge_AutoBilled_temp = " & DecCurLaborChg & " " & Environment.NewLine
                Else
                    strSql &= "Device_LaborCharge_AutoBilled_temp =  Device_LaborCharge " & Environment.NewLine
                End If
        ...
        Public Function AutoBill(ByVal decAvgcost As Decimal, _
            ...
            Try
                ...
                If dt1.Rows(0)("cnt") = 0 Then
                    ...
                    strSql = "insert into tdevicebill_563_prebill_temp ( " & Environment.NewLine
                    strSql &= "DBill_AvgCost, " & Environment.NewLine
                    strSql &= "DBill_StdCost, " & Environment.NewLine
                    strSql &= "DBill_InvoiceAmt, " & Environment.NewLine
                    strSql &= "Device_ID, " & Environment.NewLine
        ...
        '***************************************************************************
        Public Function GetPreBillDevices_Lvl2And3(ByVal iLoc_ID As Integer) As DataTable
            Dim strSql As String = ""
            Dim dt1 As DataTable

            Try
                strSql = "SELECT tdevice.* , csin_EnterpriseCode as Enterprise, cstincomingdata.cs_DevFrBP as DevFrBP " & Environment.NewLine
                strSql &= ", AutoBill " & Environment.NewLine
                strSql &= "FROM tdevice " & Environment.NewLine
                ...
                strSql &= "WHERE tdevice.loc_id = " & iLoc_ID & Environment.NewLine
                strSql &= "AND HasPreBillLot = 1 " & Environment.NewLine
                'strSql &= "AND CellOpt_RefurbCompleteDt is not null " & Environment.NewLine
                strSql &= "AND Device_LaborLevel_AutoBilled_temp is null " & Environment.NewLine
                strSql &= "AND Device_LaborLevel > 0 " & Environment.NewLine
                strSql &= "AND Device_DateShip is null " & Environment.NewLine
                'strSql &= "AND tdevice.Device_ID in (10668898, 10668899, 10668900);"
