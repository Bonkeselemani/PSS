...
Namespace Buisness.WingTech
    Public Class WingTech_Receiving
...
#End Region
        ...
        Public Function getEndUserReceivingData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, _
                                                ByVal iOrderType_ID As Integer, ByVal strSN As String, ByVal iIsSN1OrRMANo2 As Integer) As DataTable
            Dim strSql As String = ""
        ...
        Public Function ReceiveDataIntoSystem(ByVal iLoc_ID As Integer, ByVal iWO_ID As Integer, ByVal iModel_ID As Integer, ByVal strSN As String, _
            ...
            Dim strReceivedWorkStation = PSS.Data.Buisness.WingTech.WingTech.WingTech_Received_WorkStation
            ...
            Try
                ...
                If iDevice_ID > 0 Then
                    ...
                    strSql = "UPDATE production.tWorkOrder SET WO_Closed =1, WO_RAQnty =1, Group_ID = " & PSS.Data.Buisness.WingTech.WingTech.WingTech_Group_ID & " WHERE WO_ID = " & iWO_ID & ";"
                    i += Me._objDataProc.ExecuteNonQuery(strSql)
        ...
        Public Function PrintReceivedBoxLabel(ByVal iASN_OrderType_ID As Integer, ByVal strBoxName As String, ByVal iQty As Integer, ByVal strSku As String, _
            ...
            Dim strReportName As String = "WingTech Warehouse Box Label.rpt" 'default
            Dim strSql As String
            Dim dtLabel As DataTable
            'Dim FontEncoder As New IDAutomation.NetAssembly.FontEncoder()

            Try
                If iASN_OrderType_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeBulk_ID Then
                    strReportName = "WingTech Warehouse Box Label.rpt"
                ElseIf iASN_OrderType_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeSeedStock_ID Then
                    strReportName = "WingTech SeedStock Warehouse Box Label.rpt"
                ElseIf iASN_OrderType_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_OrderTypeEndUser_ID Then
                    strReportName = "WingTech Warehouse EndUser Box Label.rpt"
                End If
