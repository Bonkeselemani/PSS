...
Namespace Buisness.WingTech
    Public Class WingTech_REF2Seed
        ...
        Private _strSeedType As String = "'" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_Cricket & "'," & _
                                               "'" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_ATT & "'"
...
#End Region
        ...
        Public Function GetREF2SeedstockData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal iModel_ID As Integer) As DataTable
            ...
            Try
                If iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    ...
                    strSql &= " ,if(A.Loc_ID=" & iLoc_ID & ",B.ShipTo_Name,if((A.Loc_ID=" & iLoc_ID & " OR A.Loc_ID=" & iLoc_ID & "),B.Account,'')) as 'Type',F.Device_SN AS 'Swapped_SN',A.Loc_ID,B.Cust_ID,B.EW_ID,A.Device_ID,B.Swapped_Device_ID,A.Model_ID,B.wb_ID,B.BulkOrderType_ID" & Environment.NewLine
                    ...
                    strSql &= " INNER JOIN production.tdevice F ON F.Device_ID=B.Device_ID" & Environment.NewLine
                    ...
                    strSql &= " WHERE B.Cust_ID=" & iCust_ID & " AND A.Loc_ID = " & iLoc_ID & " AND A.Device_DateShip IS NULL AND C.model_ID= " & iModel_ID & "  AND B.BulkOrderType_ID =1 AND A.Pallett_ID IS NULL;" & Environment.NewLine
                    ' What is the use of  Swapped_Device_ID. Altered this join 
        ...
        Public Function ProcessREF2Seedstock(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal iWO_ID As Integer, _
            ...
            Try
                ...
                Select Case iLoc_ID
                    ...
                    Case PSS.Data.Buisness.WingTech.WingTech.WingTech_Loc_ID
                        iPallet_ID = 387438
                        strPallet_Name = "2629SDS20210301N001"
                    Case Else
        ...
        Public Function GetWorkOrderID(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer) As Integer
            Dim strSql As String = ""
            Dim strWO_Name As String = "WingTech_C" & iCust_ID.ToString & "REF2Seed"
            Dim strDateTime As String = Format(Now, "yyyy-MM-dd HH:mm:ss")

            Try
                If iCust_ID = PSS.Data.Buisness.WingTech.WingTech.WingTech_CUSTOMER_ID Then
                    strWO_Name = "WingTech_C" & iCust_ID.ToString & "REF2Seed"
                ElseIf iCust_ID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CUSTOMER_ID Then
