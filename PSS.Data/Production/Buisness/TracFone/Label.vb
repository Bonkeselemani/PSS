...
#End Region
        ...
        '******************************************************************
        Public Function GetTracDeviceInfoForLabel(ByVal strIMEI As String, _
        ...
        '******************************************************************
        Public Function GetTracDeviceMadeInCountryIDForLabel(ByVal iModelID As Integer) As Integer
        ...
        '******************************************************************
        Public Function PrintLabel(ByVal bIsIntermecPrinter As Boolean, _
            ...
            Try
                ...
                strsql &= ",'' AS Model_No_BarCode, '' AS IMEI_BarCode, '' AS FCCID_BarCode, " & Environment.NewLine
                strsql &= " '' AS SNMSN_BarCode, '' as ESN_BarCode, '' AS Country_Manuf_BarCode, '' AS Prod_Code_BarCode, '' AS SugNumber_BarCode, " & Environment.NewLine
                strsql &= " '' AS IMEIBar_BarCode, '' AS SNMSNBar_BarCode, '' AS P_NoBar_BarCode, " & Environment.NewLine
                strsql &= " '' AS P_No_BarCode, '' AS TFModel_No_BarCode, '' AS SW_No_BarCode, " & Environment.NewLine
                strsql &= " '' As BtAddr_BarCode, '' as Date_BarCode, '' As HW_REV_BarCode, '' As N_No_BarCode " & Environment.NewLine
                strsql &= ", '' as 'ManufProdSN_BarCode' " & Environment.NewLine
                strsql &= ", '' as 'SEQ_BarCode', '' as 'IMEI_HEX_BarCode', '' as 'SSID_BarCode',  '' as 'lblLoc_BarCode' " & Environment.NewLine
                strsql &= ", '' as 'MEIDHEX_BarCode', '' as 'MEIDDEC_BarCode', '' as 'IMEI_Alt_BarCode', '' as 'lblBluetoothID_BarCode','' as 'lblWebUIPassword_BarCode'" & Environment.NewLine
                ...
                With objRpt
                    If bIsIntermecPrinter Then strRptPath = strRptPath & "Intermec\"
                    .Load(strRptPath & strRptName)
                    dt = _objDataProc.GetDataTable(strsql)
                    For Each R1 In dt.Rows 'add 128 barcode
                        R1.BeginEdit()
                        R1("Model_No_BarCode") = Decode128BarCode(strModel)
                        R1("IMEI_BarCode") = Decode128BarCode(strIMEI)
                        R1("FCCID_BarCode") = Decode128BarCode(strFCC)
                        R1("SNMSN_BarCode") = Decode128BarCode(strSNMSN)
                        R1("ESN_BarCode") = Decode128BarCode(strESN)
                        R1("Country_Manuf_BarCode") = Decode128BarCode(strMadein)
                        R1("Prod_Code_BarCode") = Decode128BarCode(strProdCode)
                        R1("SugNumber_BarCode") = Decode128BarCode(strSjug)
                        R1("IMEIBar_BarCode") = Decode128BarCode(strIMEI)
                        R1("SNMSNBar_BarCode") = Decode128BarCode(strSNMSN)
                        R1("P_NoBar_BarCode") = Decode128BarCode(strPno)
                        R1("P_No_BarCode") = Decode128BarCode(strPno)
                        R1("TFModel_No_BarCode") = Decode128BarCode(strTFModel)
                        R1("SW_No_BarCode") = Decode128BarCode(strSW)
                        R1("BtAddr_BarCode") = Decode128BarCode(strbtAddr)
                        R1("Date_BarCode") = Decode128BarCode(strDate)
                        R1("HW_REV_BarCode") = Decode128BarCode(strHW)
                        R1("N_No_BarCode") = Decode128BarCode(strN)
                        R1("ManufProdSN_BarCode") = Decode128BarCode(strManufProdSN)
                        R1("SEQ_BarCode") = Decode128BarCode(strSeq)
                        R1("IMEI_HEX_BarCode") = Decode128BarCode(strIMEI_HEX)
                        R1("SSID_BarCode") = Decode128BarCode(strSSID)
                        R1("lblLoc_BarCode") = Decode128BarCode(strLabelLoc)
                        R1("MEIDHEX_BarCode") = Decode128BarCode(strMEIDHEX)
                        R1("MEIDDEC_BarCode") = Decode128BarCode(strMEIDDEC)
                        R1("IMEI_Alt_BarCode") = Decode128BarCode(strIMEI_Alt)
                        R1("lblBluetoothID_BarCode") = Decode128BarCode(strBluetooth)
                        R1("lblWebUIPassword_BarCode") = Decode128BarCode(strWebUIPassword)
                        R1.AcceptChanges()
                    Next
        ...
        '******************************************************************
        Public Function UpdateWiKoLabelTCellOpt(ByVal iDeviceID As Integer, _
