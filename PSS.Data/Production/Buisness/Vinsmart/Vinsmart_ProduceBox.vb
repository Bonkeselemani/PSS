...
Namespace Buisness.Vinsmart
    ...
    Public Class Vinsmart_ProduceBox

        Private _objDataProc As DBQuery.DataProc
        Private _objVinsmart As New Vinsmart()
...
#Region "Constructor/Destructor"
        ...
        Public Sub New()
            Try
                iCustID = _objVinsmart.Vinsmart_CUSTOMER_ID
...
#End Region
        ...
        Public Function getPallettSN(ByVal Pallett_name As String) As DataTable
            Dim strsql As String = String.Empty
            Dim dt As DataTable
            Try
                strsql = "Select device_id,Device_SN as SN from tdevice A" & Environment.NewLine
                strsql &= "  INNER JOIN tpallett B ON A.pallett_id=B.pallett_id" & Environment.NewLine
                strsql &= " where Pallett_Name='" & Pallett_name & "' and B.cust_id=" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID & "  and device_dateship is null; " & Environment.NewLine
                dt = Me._objDataProc.GetDataTable(strsql)
                Return dt
            Catch ex As Exception
                Throw ex
        ...
        Public Function checkAqlObaTest(ByVal deviceId As String) As DataTable
            ...
            Try
                ...
                strSql = "SELECT QCResult_Id FROM  production.tqc WHERE QCType_ID=4 and device_id in (" & deviceId & ") and QCResult_Id=1 and pallett_id IS NOT NULL;"
                dt = Me._objDataProc.GetDataTable(strSql)
