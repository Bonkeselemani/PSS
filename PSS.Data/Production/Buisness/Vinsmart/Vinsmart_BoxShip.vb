...
#End Region
        ...
        Public Function GetAccount(ByVal strImei As String, ByVal iCust_Id As Integer) As Integer
            ...
            Try
                ...
                strSql &= " where SerialNo = '" & strImei & "' AND cust_id= " & iCust_Id & " AND A.device_id=B.Device_id and Device_DateShip is null and account in ('ATT','Cricket','VinsmartTriage1','VinsmartTriage2')" & Environment.NewLine
                dt = Me._objDataProc.GetDataTable(strSql)
        ...
        Public Function GetVinsmartLocationsbyID(ByVal iCust_ID As Integer, ByVal strIMEI As String) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function CreateBoxID(ByVal iModelID As Integer, _
            ...
            Try
                ...
                Else
                    ...
                    Dim strPalletPostFix As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_Box_Postfix
                    Dim strDatePallet As String = Generic.GetMySqlDateTime("%d%m%Y")
                    strPalletnameprefix = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_Box_Prefix & strPalletPrefix & strDatePallet & "V"
                    Dim iPalletNameLen As Integer = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_BoxName_Len
                ...
                End If
                If iLoc_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then
                    strTempLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
                Else
                    strTempLoc_id = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCTDI_LOC_ID
                End If
        ...
        Public Function GetVinsmartOpenPallets(ByVal iCust_ID As Integer, ByVal iLoc_ID As String) As DataTable
            ...
            Try
                strSql = "SELECT Pallett_ID, tpallett.Model_ID, tpallett.Loc_ID, Pallet_ShipType, if(Pallett_QTY is null,0,Pallett_QTY) as Pallett_QTY,Pallett_Name as 'Box Name',IF (tpallett.Loc_ID=4492,tlocation.Loc_Name,'ATT ') as Location, Model_Desc as Model,Pallett_MaxQty as MaxQty,Account" & Environment.NewLine
        ...
        Public Function GetDeviceSIMcard(ByVal iDevice_ID As Integer) As DataTable
            ...
            Try
                ...
                strSql &= " WHERE B.Cust_ID=" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID & " AND B.LOC_ID=4492 and Device_ID =" & iDevice_ID & " ;" & Environment.NewLine
                Return Me._objDataProc.GetDataTable(strSql)
            Catch ex As Exception
                Throw ex
            End Try
        ...
        Public Function PrintBoxLabel(ByVal iPalletID As Integer) As Integer
            Dim strReportName As String = "Vinsmart_Pallet_Cricket_Label_20.rpt" ' "Vinsmart_Pallet_Label_" '"Vinsmart_Pallet_Label_20.rpt"
            Dim strReportName1 As String = "Vinsmart_Pallet_Cricket_Label_50.rpt"
            Dim strSql As String
            ...
            Try
                ...
                'strReportName = "Vinsmart_Pallet_Label BonkeTest2020.rpt"
        ...
        Public Function Print_AttCTDI_BoxLabel(ByVal iPalletID As Integer) As Integer
            Dim strReportName As String = "Vinsmart_Pallet_AttCTDI_Label_20.rpt"
            Dim strReportName1 As String = "Vinsmart_Pallet_AttCTDI_Label_50_2.rpt"
            Dim strSql As String
