...
Namespace Buisness.Vinsmart
    Public Class Vinsmart_Receiving
...
#End Region
        ...
        Public Function getVinsmartSeedStockRecvTableDef() As DataTable
            Dim strSql As String = ""
            Try
        ...
        Public Function ReceiveDataIntoSystem(ByVal iLoc_ID As Integer, ByVal iWO_ID As Integer, ByVal iModel_ID As Integer, ByVal strSN As String, _
                                              ...
                                              ByRef iDevice_ID As Integer, ByVal iWb_ID As Integer, ByVal iWrty As Integer, ByVal bIsSeedStock As Boolean, Optional ByVal strInPallet As String = "VinsmartSP000") As Boolean
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim bRet As Boolean = False
            Dim strReceivedWorkStation = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Received_WorkStation
            Dim i As Integer = 0
            ...
            Try
                ...
                If i > 0 AndAlso iDevice_ID > 0 Then
                    ...
                    strSql = "UPDATE production.tWorkOrder SET WO_Closed =1, WO_RAQnty =1, Group_ID = " & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Group_ID & " WHERE WO_ID = " & iWO_ID & ";"
                    i += Me._objDataProc.ExecuteNonQuery(strSql)
                    ...
                    If bIsSeedStock Then 'need to update loc_ID
                        ...
                        i += Me._objDataProc.ExecuteNonQuery(strSql)
                    ElseIf iLoc_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Special_LOC_ID Then
        ...
        Public Function GetVinsmartModels(ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            ...
            Try
                ...
                strSql &= " WHERE B.Cust_ID=2630 ORDER BY A.Model_Desc;" & Environment.NewLine
        ...
        Public Function GetVinsmartCriketDOA(ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            ...
            Try
                ...
                strSql = "SELECT 1 AS 'DOA_ID','" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Cricket_OEMCustomer_DOA & "' AS 'AccountDOA', '" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Cricket_OEMCustomer_DOA_AccountCode & "' AS 'AccountDOA_Code'" & Environment.NewLine
                strSql &= " UNION ALL SELECT 2 AS 'DOA_ID','" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Cricket_OEMCustomer_EMS & "' AS 'AccountDOA', '" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Cricket_OEMCustomer_EMS_AccountCode & "' AS 'AccountDOA_Code';" & Environment.NewLine
        ...
        Public Function SaveVinsmartSeedStockData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strSN As String, _
            ...
            Dim strWO_Name As String = "Vinsmart_C" & iCust_ID.ToString & "L" & iLoc_ID.ToString
            Dim strClaimNo As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SeedStock & strDateTime.Replace("-", "").Replace(":", "").Replace("/", "").Replace(" ", "")
            Dim strReceivedWorkStation = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_Received_WorkStation
            ...
            Try
                ...
                strSQL &= " AND NOT C.Workstation= '" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_BuildProduce_WorkStation & "' AND A.SerialNo ='" & strSN & "'" & Environment.NewLine
                dt = Me._objDataProc.GetDataTable(strSQL)
                ...
                Else
                    ...
                    If iLoc_ID = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID Then
                        ...
                        strSQL &= "','" & strSN & "','" & strDateTime & "','" & strModel & "','" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SeedStock & "');"
                    Else
        ...
        Public Function PrintReceivedBoxLabel(ByVal strBoxName As String, ByVal iQty As Integer, ByVal strSku As String, ByVal strSku_Desc As String, _
            ...
            Dim strReportName As String = "Vinsmart Warehouse Receiving Box Label.rpt" 'for all Vinsmart: Cricket, ATT CTDI, ATT Fedex
            Dim strSql As String
        ...
        Public Function PrintReceivedSeedstockBoxLabel(ByVal strBoxName As String, ByVal iQty As Integer, ByVal strSku As String, ByVal strSku_Desc As String, _
            ...
            Dim strReportName As String = "Vinsmart Warehouse Seedstock Receiving Box Label.rpt" 'for all Vinsmart SeedStock: Cricket, ATT CTDI, ATT Fedex
            Dim strSql As String
            Dim dtLabel As DataTable
            'Dim FontEncoder As New IDAutomation.NetAssembly.FontEncoder()
        ...
        Public Function GetVinsmartReceivedData(ByVal iCust_ID As Integer, ByVal strInput As String, ByVal iBox1SN2PO3 As Integer) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim iLoc_IDs As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
            Try
        ...
        Public Function GetVinsmartReceivedSeedstockData(ByVal iCust_ID As Integer, ByVal strInput As String, ByVal iBox1SN2PO3 As Integer) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim iLoc_IDs As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttCricket_LOC_ID
            Dim strSeedSourceTypes As String = "'" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SeedStockSourceType_ATT & "','" & PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_SeedStockSourceType_Cricket & "'"
        ...
        Public Sub FindUpdateAttFexExSkuPos()
            ...
            Dim objVinsmart As New PSS.Data.Buisness.Vinsmart.Vinsmart()
            Dim iCust_ID As Integer = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_CUSTOMER_ID
            '  Dim iLoc_ID As Integer = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_AttFedEx_LOC_ID
            Dim strItemDescAccount As String = PSS.Data.Buisness.Vinsmart.Vinsmart.Vinsmart_FexEx_PosCode
            ...
            Try
                ...
                dtModel = objVinsmart.getVinsmartModels(Vinsmart.Vinsmart_CUSTOMER_ID, False)

                strSql = "SELECT EW_ID,Item_Sku,Item_Desc,Account,SerialNo,cust_ID,Loc_ID,Device_ID FROM production.extendedwarranty WHERE Device_ID=0 AND Cust_ID=" & iCust_ID & "  AND Account='" & strItemDescAccount.Trim & "';"
