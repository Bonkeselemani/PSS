...
#End Region
        ...
        Public Function GetPoNumberByDeviceId(ByVal iDevice_id As Integer, ByVal iOrderType As Integer) As DataTable
            ...
            End Try
        End Function
        Public Function GetCoolpadShipBoxTypes(ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function GetCoolpadModels(ByVal iCust_ID As Integer, ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function CreateBoxID(ByVal iModelID As Integer, _
            ...
            Dim dt As DataTable
            Try
                If iLoc_ID = PSS.Data.Buisness.CP.CoolPad.CoolPad_CP1_Loc_ID _
                    Or iLoc_ID = PSS.Data.Buisness.CP.CoolPad.CoolPad_Special_LOC_ID Then
                    '******************************
                    ...
                    ElseIf strPalletPrefix = "RUR" Then
                        strPalletPrefix = "U"
                    End If
                    strPalletPrefix = "24C" & strPalletPrefix & strDate '& "N"
        ...
        Public Function GetCoolpadOpenPallets(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer) As DataTable
            Dim strSql As String

            Try
                strSql = "SELECT Pallett_ID, tpallett.Model_ID, tpallett.Loc_ID, Pallet_ShipType, " & vbCrLf
                strSql &= "IF(Pallett_QTY is null,0,Pallett_QTY) as Pallett_QTY,Pallett_Name as 'Box Name', " & vbCrLf
                strSql &= "tlocation.Loc_Name as Location, Model_Desc as Model, " & Environment.NewLine
                strSql &= "CASE tpallett.Pallet_ShipType " & vbCrLf
                strSql &= " WHEN 0 then 'REF' " & vbCrLf
                strSql &= " WHEN 1 then 'BER' " & vbCrLf
                strSql &= " WHEN 2 then 'RUR' " & vbCrLf
                strSql &= " END AS BoxType " & vbCrLf
        ...
        Public Function GetCoopadPallettData(ByVal strPallettName As String, ByVal iCust_ID As Integer) As DataTable
            ...
            End Try
        End Function
        Public Function ReopenCoolpadBoxByResetting(ByVal iPalletID As Integer, ByVal strStation As String) As Integer
            Dim strSql As String = ""
            Try
        ...
        Public Function GetDeviceFlashTestFile(ByVal strDevice_SN As String) As DataTable
            Dim strSql As String = ""
            Try
        ...
        Public Function RemoveSNfromPallet(ByVal iPallett_ID As Integer, ByVal iDevice_ID As Integer) As Integer
            ...
            End Try
        End Function
        Public Function CloseCoolpadPallet(ByVal iCust_ID As Integer, _
        ...
        Public Function PrintBoxLabel(ByVal iPalletID As Integer) As Integer
            Dim strReportName As String = "coolpad_master.rpt"
            Dim strReportNameComplete As String = "coolpadINW.rpt"
            Dim strSql As String
