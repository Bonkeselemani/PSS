        ...
        Public Function getDeviceData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strSN As String, ByVal iBulkORderType_ID As Integer, _
            ...
            Try
                ...
                If iCust_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_CUSTOMER_ID Then
                    If iBulkORderType_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_OrderTypeBulk_ID Then 'None seedstock
                        strSql &= " WHERE A.Cust_ID=" & iCust_ID & " AND A.Account NOT IN (" & strWiKoFilterOutSeedStock & ")" & Environment.NewLine
                    ElseIf iBulkORderType_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_OrderTypeSeedStock_ID Then 'Seedstock
                        ...
                        ElseIf (iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttCTDI_LOC_ID OrElse iLoc_ID = PSS.Data.Buisness.WIKO.WIKO.WIKO_AttFedEx_LOC_ID) _
                        ...
                        End If
                    Else
                        Throw New Exception("Failed to determine WIKO device info.")
                    End If
                Else
                    strSql &= " WHERE A.Cust_ID=" & iCust_ID & " and A.Loc_ID=" & iLoc_ID & " AND A.BulkORderType_ID=" & iBulkORderType_ID & Environment.NewLine
                End If
