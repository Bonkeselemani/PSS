...
Namespace Buisness.wingTechATT
    Public Class WingTechATT_Label
...
#End Region
        ...
        '******************************************************************
        Public Function GetWingTechATTDeviceInfoForLabel(ByVal strIMEI As String, _
                                                  ByVal iCustID As Integer) As DataTable
        ...
        '******************************************************************
        Public Function UpdateWingTechATTLabelTCellOpt(ByVal iDeviceID As Integer, _
