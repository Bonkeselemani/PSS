...
Namespace Buisness.WingTechATT
    Public Class WingTechATT_Receiving
...
#End Region
        ...
        Public Function getWingTechATTRecvTableDef() As DataTable
        ...
        Public Function getWingTechATTSeedStockRecvTableDef() As DataTable
            Dim strSql As String = ""
            Try
        ...
        Public Function getReceivingData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strSN As String) As DataTable
            ...
            Try
                ...
                strSql &= " , IF(DATE IS NULL,'', IF(DATE_FORMAT(DATE,'%Y-%m-%d') ='0000-00-00','',DATE_FORMAT(DATE,'%Y-%m-%d'))) AS 'RA_Date',Account AS 'OEM_Account'" & Environment.NewLine
                ...
                strSql &= " ,B.WO_CustWO AS 'Work_Order',IF(B.WO_Closed>0,'CLOSED','RECEIVING') AS 'WorkStation',ShipTo_Name AS 'DOA_Account', Account AS 'DOA_Account_Code',  SourceFile,A.WO_ID,A.Cust_ID,A.Loc_ID,B.WO_Closed" & Environment.NewLine
        ...
        Public Function getSeedStockReceivingData(ByVal iCust_ID As Integer, ByVal _iLoc_ID_Seed As Integer, ByVal strSN As String, ByVal strSeedSourceType As String) As DataTable
            Dim strSql As String = ""
            ...
            Try
                ...
                strSql &= "  ,B.WO_CustWO AS 'Work_Order',IF(B.WO_Closed>0,'CLOSED','RECEIVING') AS 'WorkStation', Account AS 'DOA_Account_Code',  SourceFile,A.WO_ID,A.Cust_ID,A.Loc_ID,B.WO_Closed" & Environment.NewLine
                strSql &= "  FROM production.extendedwarranty A" & Environment.NewLine
                strSql &= "  INNER JOIN production.tWorkOrder B ON A.WO_ID=B.WO_ID" & Environment.NewLine
                strSql &= "  INNER JOIN production.tCustomer C ON A.Cust_ID=C.Cust_ID" & Environment.NewLine
                strSql &= "  WHERE A.Cust_ID= " & iCust_ID & " AND A.Loc_ID= " & _iLoc_ID_Seed & " AND A.BulkOrderType_ID=0 AND A.Device_ID=0 AND B.WO_Closed=0 AND ACCOUNT='" & strSeedSourceType & "' AND SerialNo = '" & strSN & "';"
        ...
        Public Function ReceiveDataIntoSystem(ByVal iLoc_ID As Integer, ByVal iWO_ID As Integer, ByVal iModel_ID As Integer, ByVal strSN As String, _
                                              ...
                                              ByRef iDevice_ID As Integer, ByVal iWb_ID As Integer, ByVal iWrty As Integer, ByVal bIsSeedStock As Boolean, Optional ByVal strInPallet As String = "WIngTechATTSP000") As Boolean
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim bRet As Boolean = False
            Dim strReceivedWorkStation = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Received_WorkStation
            Dim i As Integer = 0
            ...
            Try
                ...
                If i > 0 AndAlso iDevice_ID > 0 Then
                    ...
                    strSql = "UPDATE production.tWorkOrder SET WO_Closed =1, WO_RAQnty =1, Group_ID = " & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Group_ID & " WHERE WO_ID = " & iWO_ID & ";"
                    i += Me._objDataProc.ExecuteNonQuery(strSql)
                    ...
                    If bIsSeedStock Then 'need to update loc_ID
                        ...
                        i += Me._objDataProc.ExecuteNonQuery(strSql)
                    ElseIf iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
        ...
        Public Function getTayID(ByVal iUser_ID As Integer, ByVal strUser As String, ByVal iWO_ID As Integer, ByVal strMemo As String) As Integer
            ...
            End Try
        End Function
        Public Function GetWingTechATTModels(ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            ...
            Try
                ...
                strSql &= " WHERE B.Cust_ID=2631 ORDER BY A.Model_Desc;" & Environment.NewLine
        ...
        Public Function GetWingTechATTCriketDOA(ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            ...
            Try
                ...
                strSql = "SELECT 1 AS 'DOA_ID','" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_DOA & "' AS 'AccountDOA', '" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_DOA_AccountCode & "' AS 'AccountDOA_Code'" & Environment.NewLine
                strSql &= " UNION ALL SELECT 2 AS 'DOA_ID','" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_EMS & "' AS 'AccountDOA', '" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Cricket_OEMCustomer_EMS_AccountCode & "' AS 'AccountDOA_Code';" & Environment.NewLine
        ...
        Public Function SaveWingTechATTSeedStockData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal strSN As String, _
            ...
            Dim strWO_Name As String = "WingTechATT_C" & iCust_ID.ToString & "L" & iLoc_ID.ToString
            Dim strClaimNo As String = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStock & strDateTime.Replace("-", "").Replace(":", "").Replace("/", "").Replace(" ", "")
            Dim strReceivedWorkStation = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Received_WorkStation
            ...
            Try
                ...
                strSQL &= " AND NOT C.Workstation= '" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_BuildProduce_WorkStation & "' AND A.SerialNo ='" & strSN & "'" & Environment.NewLine
                dt = Me._objDataProc.GetDataTable(strSQL)
                ...
                Else
                    ...
                    If iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID Then
                        ...
                        strSQL &= "','" & strSN & "','" & strDateTime & "','" & strModel & "','" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStock & "');"
                    Else
        ...
        Public Function PrintReceivedBoxLabel(ByVal strBoxName As String, ByVal iQty As Integer, ByVal strSku As String, ByVal strSku_Desc As String, _
            ...
            Dim strReportName As String = "WingTechATT Warehouse Receiving Box Label.rpt" 'for all WingTechATT: Cricket, ATT CTDI, ATT Fedex
            Dim strSql As String
        ...
        Public Function PrintReceivedSeedstockBoxLabel(ByVal strBoxName As String, ByVal iQty As Integer, ByVal strSku As String, ByVal strSku_Desc As String, _
            ...
            Dim strReportName As String = "WingTechATT Warehouse Seedstock Receiving Box Label.rpt" 'for all WingTechATT SeedStock: Cricket, ATT CTDI, ATT Fedex
            Dim strSql As String
            Dim dtLabel As DataTable
            'Dim FontEncoder As New IDAutomation.NetAssembly.FontEncoder()
        ...
        Public Function GetWingTechATTReceivedData(ByVal iCust_ID As Integer, ByVal strInput As String, ByVal iBox1SN2PO3 As Integer) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim iLoc_IDs As String = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID & "," & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID & _
                                     "," & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID
        ...
        Public Function GetWingTechATTReceivedSeedstockData(ByVal iCust_ID As Integer, ByVal strInput As String, ByVal iBox1SN2PO3 As Integer) As DataTable
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim iLoc_IDs As String = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID & "," & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID & _
                                     "," & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID
            Dim strSeedSourceTypes As String = "'" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_ATT & "','" & PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SeedStockSourceType_Cricket & "'"
            ...
            Try
                ...
                strSql &= " Where B.Cust_ID= " & iCust_ID & " And F.Loc_ID IN (" & iLoc_IDs & ") " & Environment.NewLine
                strSql &= " AND B.BulkOrderType_ID=0 AND B.ACCOUNT IN (" & strSeedSourceTypes & ")" & Environment.NewLine
        ...
        Public Sub FindUpdateAttFexExSkuPos()
            ...
            Dim iLoc_ID As Integer = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID
            Dim strItemDescAccount As String = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_FexEx_PosCode
            ...
            Try
                ...
                dtModel = objWingTechATT.getWingTechATTModels(WingTechATT.WingTechATT_CUSTOMER_ID, False)

                strSql = "SELECT EW_ID,Item_Sku,Item_Desc,Account,SerialNo,cust_ID,Loc_ID,Device_ID FROM production.extendedwarranty WHERE Device_ID=0 AND Cust_ID=" & iCust_ID & " AND Loc_ID=" & iLoc_ID & " AND Account='" & strItemDescAccount.Trim & "';"
