...
Namespace Buisness.WingTechATT
    ...
    Public Class WingTechATT_REF2Seed
...
#End Region
        ...
        Public Function GetREF2SeedstockData(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal iModel_ID As Integer) As DataTable
            ...
            Dim iCricket_Loc_ID As Integer = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCricket_LOC_ID
            Dim iAttCTDI_Loc_ID As Integer = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttCTDI_LOC_ID
            Dim iAttFedEx_Loc_ID As Integer = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_AttFedEx_LOC_ID
        ...
        Public Function GetWorkOrderID(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer) As Integer
            Dim strSql As String = ""
            Dim strWO_Name As String = "WingTechATT_C" & iCust_ID.ToString & "REF2Seed"
            Dim strDateTime As String = Format(Now, "yyyy-MM-dd HH:mm:ss")

            Try
                If iCust_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_CUSTOMER_ID Then
                    strWO_Name = "WingTechATT_C" & iCust_ID.ToString & "REF2Seed"
