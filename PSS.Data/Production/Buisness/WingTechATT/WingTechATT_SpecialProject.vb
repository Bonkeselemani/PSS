...
Namespace Buisness.WingTechATT
    Public Class WingTechATT_SpecialProject
...
#End Region
        ...
        Public Function CreateBoxID(ByVal iModelID As Integer, _
            ...
            Dim dt As DataTable
            Try
                If iLoc_ID = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_Special_LOC_ID Then
                    '******************************
        ...
        Public Function GetWingTechATTOpenPallets(ByVal iCust_ID As Integer, ByVal iLoc_ID As String) As DataTable
            ...
            Try
                ...
                strSql &= " Account as Project " & Environment.NewLine
        ...
        Public Function GetDeviceSIMcard(ByVal iDevice_ID As Integer, ByVal strAccount As String) As DataTable
            ...
            Try
                ...
                strSql &= " WHERE  A.Cust_ID=2631 AND A.Loc_ID=4496 AND A.Account = '" & strAccount & "' and B.device_id=" & iDevice_ID & " ;" & Environment.NewLine
                Return Me._objDataProc.GetDataTable(strSql)
            Catch ex As Exception
                Throw ex
            End Try
        ...
        Public Function getWingTechATTPalletDataForSPTeller(ByVal iPalletID As Integer) As DataTable
            Dim strSql As String = ""
            Try
        ...
        Public Function getWingTechATTSP_PalletQty(ByVal strPallett_IDs As String, ByRef iDevQtyPerBox As Integer) As Integer
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function getWingTechATTSP_DeviceQty(ByVal strPallett_IDs As String) As Integer
            Dim strSql As String = ""
            Dim dt As DataTable
            Dim iQty As Integer = 0
        ...
        Public Function getWingTechATT_SpTellerManifest_MostRecent_pkSlipID() As Integer
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function getWingTechATT_SpTellerManifestMasterPalletData(ByVal ipkSlip_ID As Integer) As DataTable
            Dim strSql As String = ""
        ...
        Public Function PrintManifestMasterPalletLabel(ByVal strMasterPalletName As String, ByVal strPO As String, ByVal strLoadNo As String, _
            ...
            Dim strReportName As String = "WingTechATT_Pallet_SP_Master_Pallet_Label.rpt" 'for all WingTechATT Special Project Teller Data Manifest Master Pallet label
            Dim strSql As String
        ...
        'Old one
        'Public Function getWingTechATT_SpTellerManifestMasterPalletDetailedData(ByVal strMPalletNames As String, ByVal iCartonWeight As Integer) As DataTable
        '    Dim strSql As String = ""
        ...
        Public Function getWingTechATT_SpTellerManifestMasterPalletAccount(ByVal strMPalletNames As String) As String
            Dim strSql As String = ""
            Dim dt As DataTable
        ...
        Public Function getWingTechATT_SpTellerManifestMasterPalletDetailedData(ByVal strMPalletNames As String, ByVal iCartonWeight As Integer, ByVal strAccount As String) As DataTable
            Dim strSql As String = ""
            ...
            Try
                ...
                If strAccount.Trim.ToUpper = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SpecialProj_Type2.Trim.ToUpper Then
                    strSql = "SELECT A.Mpallet_Name AS 'PALLET_NO',B.pallett_name AS 'CARTON_NO','" & iCartonWeight.ToString & " lbs' AS ' CARTON_WEIGHT', C.Device_SN AS 'IMEI_MAIN'" & Environment.NewLine
                    strSql &= " FROM production.tpackingslippallet A" & Environment.NewLine
                    strSql &= " INNER JOIN production.tpallett B ON A.pkslip_id=B.pkslip_id" & Environment.NewLine
                    strSql &= " INNER JOIN production.tdevice C ON B.pallett_id=C.pallett_id" & Environment.NewLine
                ...
                ElseIf strAccount.Trim.ToUpper = PSS.Data.Buisness.WingTechATT.WingTechATT.WingTechATT_SpecialProj_Type3.Trim.ToUpper Then
        ...
        Public Function GetWingTechATTProjectTypes(ByVal iCust_ID As Integer, ByVal iLoc_ID As Integer, ByVal booAddSelectRow As Boolean) As DataTable
            Dim strSql As String = ""
            Dim dt As New DataTable()

            Try
                'strSql = "SELECT '6K202Project' as PrjType_Desc, '6K202Project' as PrjType_Name UNION ALL SELECT 'Teller' as PrjType_Desc, 'Teller' as PrjType_Name UNION ALL  SELECT 'SP1' as PrjType_Desc, 'SP1' as PrjType_Name " & Environment.NewLine
        ...
        Public Function GetDevicesAndSimCardsInBox(ByVal iPalletID As Integer) As DataTable
            ...
            End Try
        End Function
        Public Function GetWingTechATTAccounts(ByVal iCustID As Integer, ByVal iLocID As Integer) As DataTable
            'Get the accounts (projects) used for WingTechATT
            Dim strSql As String = ""
            Dim dt As New DataTable()
