...
Namespace Buisness.WingTechATT
    Public Class WingTechATT_ProduceBox
        Private _objDataProc As DBQuery.DataProc
        Private _objWingTechATT As New WingTechATT()
...
#Region "Constructor/Destructor"
        ...
        Public Sub New()
            Try
                iCustID = _objWingTechATT.WingTechATT_CUSTOMER_ID
...
#End Region
        ...
        Public Function getDeviceSn(ByVal pId As String, ByVal mId As String) As DataTable
            ...
            Dim dt As DataTable
            Try
                strsql = "Select device_id,Device_SN as SN from tdevice where Pallett_ID=" & pId & " and Model_Id  IN (" & mId & ") and device_dateship is null;" & Environment.NewLine
                dt = Me._objDataProc.GetDataTable(strsql)
                Return dt
            Catch ex As Exception
                Throw ex
